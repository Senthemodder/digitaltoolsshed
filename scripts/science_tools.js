...
export function renderScienceToolHtml(tool) {
  ...
  return `
    ...
    <div class="article-container" style="max-width: 900px;">
      ...
      <!-- 5 Fatal Theoretical Limits & Physical Boundary Traps -->
      <div class="sci-box" style="background: var(--surface);">
        <h3 style="font-family: var(--serif); font-size: 1.25rem; margin: 0 0 0.75rem; color: var(--fg);">⚠️ 5 Fatal Theoretical & Physical Boundary Traps</h3>
        ...
        <div style="display: grid; gap: 1rem;">
          <div class="trap-card" style="border-left: 4px solid #ef4444; background: var(--surface-alt); border: 1px solid var(--border); border-left: 4px solid #ef4444; border-radius: 6px; padding: 1rem 1.25rem;">
            <strong style="color: var(--fg); font-size: 0.95rem; display: block; margin-bottom: 0.25rem;">1. Quantum Spacetime Breakdown at Planck Boundaries</strong>
          ...
          <div class="trap-card" style="border-left: 4px solid #f59e0b; background: var(--surface-alt); border: 1px solid var(--border); border-left: 4px solid #f59e0b; border-radius: 6px; padding: 1rem 1.25rem;">
            <strong style="color: var(--fg); font-size: 0.95rem; display: block; margin-bottom: 0.25rem;">2. Lorentz Invariance & Apparent Superluminality Mirage</strong>
            <p style="margin: 0.35rem 0 0; font-size: 0.88rem; color: var(--text-muted); line-height: 1.5;">
          ...
          <div class="trap-card" style="border-left: 4px solid #10b981; background: var(--surface-alt); border: 1px solid var(--border); border-left: 4px solid #10b981; border-radius: 6px; padding: 1rem 1.25rem;">
            <strong style="color: var(--fg); font-size: 0.95rem; display: block; margin-bottom: 0.25rem;">3. Idealized Static Schwarzschild vs. Rotating Kerr Spin Metric</strong>
            <p style="margin: 0.35rem 0 0; font-size: 0.88rem; color: var(--text-muted); line-height: 1.5;">
          ...
          <div class="trap-card" style="border-left: 4px solid #3b82f6; background: var(--surface-alt); border: 1px solid var(--border); border-left: 4px solid #3b82f6; border-radius: 6px; padding: 1rem 1.25rem;">
            <strong style="color: var(--fg); font-size: 0.95rem; display: block; margin-bottom: 0.25rem;">4. Vacuum Polarization & Bekenstein Information Bound</strong>
            <p style="margin: 0.35rem 0 0; font-size: 0.88rem; color: var(--text-muted); line-height: 1.5;">
          ...
          <div class="trap-card" style="border-left: 4px solid #8b5cf6; background: var(--surface-alt); border: 1px solid var(--border); border-left: 4px solid #8b5cf6; border-radius: 6px; padding: 1rem 1.25rem;">
            <strong style="color: var(--fg); font-size: 0.95rem; display: block; margin-bottom: 0.25rem;">5. Coordinate Time vs. Observer Proper Time Disconnect</strong>
            <p style="margin: 0.35rem 0 0; font-size: 0.88rem; color: var(--text-muted); line-height: 1.5;">
...
export function buildScienceTools({ DIST, DOMAIN, renderPage, writeFileSync, join, ensureDir }) {
  ...
  for (const tool of ALL_SCIENCE_TOOLS) {
    tool.faq = [
      ...(tool.faq || []),
      {
        q: `What physical constants and equations govern this ${tool.shortTitle}?`,
        a: `This calculation engine binds exact physical invariants: the speed of light in vacuum c (2.99792 × 10⁸ m/s), reduced Planck constant ħ (1.05457 × 10⁻³⁴ J·s), Newtonian gravitational constant G (6.67430 × 10⁻¹¹ m³/(kg·s²)), and Boltzmann constant k_B (1.38065 × 10⁻²³ J/K) according to CODATA recommendations.`
      },
      {
        q: `Is this calculation performed client-side or on an external computing cluster?`,
        a: `All equations execute 100% locally in your client web browser memory using IEEE 754 64-bit double-precision floating-point mathematics. Zero inputs, research parameters, or coordinate solutions are transmitted to external servers.`
      },
      {
        q: `How do relativistic and quantum limits affect the precision of these results?`,
        a: `Calculations retain maximum numerical precision up to machine epsilon (~2.22 × 10⁻¹⁶). For extreme domains approaching the Planck scale (ℓ_P, t_P) or event horizon boundaries, the outputs reflect standard semiclassical approximations within modern theoretical physics.`
      }
    ];
