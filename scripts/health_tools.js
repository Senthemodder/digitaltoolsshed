  ...
  const tools = [
{
  ...
  "title": "Pregnancy Due Date & Gestational Age Calculator (Naegele's Rule, Conception & Trimesters)",
  "metaDesc": "Calculate estimated due date (EDD), gestational age in weeks and days, conception date, and trimester milestones using Naegele's rule, ultrasound dating, or IVF transfer.",
  "category": "Health & Fitness",
  "faq": [
    {
      "q": "How is an estimated due date (EDD) calculated using Naegele's rule?",
      "a": "Naegele's rule calculates the estimated due date by adding 280 days (40 weeks) to the first day of your Last Menstrual Period (LMP). Mathematically, this equals: First Day of LMP + 1 Year - 3 Months + 7 Days. For cycles different from the standard 28-day cycle, the due date is adjusted by adding (Cycle Length - 28) days."
    },
    {
      "q": "What percentage of babies are actually born on their exact due date?",
      "a": "Only approximately 4% of babies are born on their exact estimated due date. Normal full-term human gestation is a multi-week biological window: roughly 70% of deliveries occur within 10 days of the EDD, and approximately 90% occur between 37 weeks and 42 weeks."
    },
    {
      "q": "Why can ultrasound dating change the due date determined by LMP?",
      "a": "Under American College of Obstetricians and Gynecologists (ACOG) clinical guidelines, a first-trimester ultrasound measuring Crown-Rump Length (CRL) is the most accurate dating method (precision of ±3 to 5 days). If ultrasound dating disagrees with LMP dating by more than 7 days in the first trimester, the ultrasound measurement officially replaces the LMP due date."
    },
    {
      "q": "What are the exact gestational week boundaries for each trimester?",
      "a": "Obstetric trimesters are divided into: First Trimester: Conception through Week 13 + 6 days (critical organogenesis); Second Trimester: Week 14 + 0 days through Week 27 + 6 days (rapid fetal growth and anatomical development); Third Trimester: Week 28 + 0 days through birth (pulmonary surfactant maturation and fat deposition). Full term is reached at 37 weeks."
    },
    {
      "q": "How is pregnancy dated for IVF embryo transfers?",
      "a": "For In Vitro Fertilization (IVF), the due date is calculated with exact precision from the embryo transfer date: For a Day 3 embryo transfer, the due date is Transfer Date + 263 days. For a Day 5 blastocyst transfer, the due date is Transfer Date + 261 days."
    }
  ],
  "body": "\n    <div class=\"article-container\" style=\"max-width: 1020px;\">\n      <nav style=\"font-family: var(--mono); font-size: 0.8rem; margin-bottom: 1.5rem; color: var(--text-muted);\">\n        <a href=\"/\">Home</a> &gt; <a href=\"/health/\">Health &amp; Fitness</a> &gt; Pregnancy Calculator\n      </nav>\n\n      <header style=\"margin-bottom: 2rem;\">\n        <div style=\"display: flex; gap: 0.5rem; align-items: center; margin-bottom: 0.5rem; flex-wrap: wrap;\">\n          <span class=\"badge badge-purple\">Clinical Obstetrics Engine</span>\n          <span class=\"badge badge-green\">ACOG Guideline Compliant</span>\n          <span class=\"badge badge-blue\">Zero Server Uploads</span>\n        </div>\n        <h1 style=\"font-family: var(--serif); font-size: 2.3rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          Pregnancy Due Date &amp; Gestational Age Calculator\n        </h1>\n        <p style=\"color: var(--text-muted); font-size: 1.05rem; line-height: 1.6;\">\n          Determine your estimated due date (EDD), current gestational age in weeks and days, conception window, trimester milestones, and statistical delivery probability using Naegele's rule, ultrasound CRL, or IVF transfer dating.\n        </p>\n      </header>\n\n      <!-- CALCULATION BOX -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); padding: 1.75rem; border-radius: 8px; margin-bottom: 2rem;\">\n        <div style=\"display: flex; gap: 0.5rem; margin-bottom: 1.5rem; flex-wrap: wrap;\">\n          <button type=\"button\" id=\"preg-tab-lmp\" onclick=\"setPregMode('lmp')\" style=\"padding: 0.55rem 1.1rem; border-radius: 6px; font-weight: 600; font-size: 0.85rem; cursor: pointer; background: #6366f1; color: #fff; border: 1px solid #6366f1;\">\n            📅 Last Period (LMP)\n          </button>\n          <button type=\"button\" id=\"preg-tab-conception\" onclick=\"setPregMode('conception')\" style=\"padding: 0.55rem 1.1rem; border-radius: 6px; font-weight: 600; font-size: 0.85rem; cursor: pointer; background: var(--surface-alt); color: var(--fg); border: 1px solid var(--border);\">\n            ✨ Conception Date\n          </button>\n          <button type=\"button\" id=\"preg-tab-ultrasound\" onclick=\"setPregMode('ultrasound')\" style=\"padding: 0.55rem 1.1rem; border-radius: 6px; font-weight: 600; font-size: 0.85rem; cursor: pointer; background: var(--surface-alt); color: var(--fg); border: 1px solid var(--border);\">\n            🩺 Ultrasound Scan\n          </button>\n          <button type=\"button\" id=\"preg-tab-ivf\" onclick=\"setPregMode('ivf')\" style=\"padding: 0.55rem 1.1rem; border-radius: 6px; font-weight: 600; font-size: 0.85rem; cursor: pointer; background: var(--surface-alt); color: var(--fg); border: 1px solid var(--border);\">\n            🧬 IVF Transfer\n          </button>\n        </div>\n\n        <!-- INPUTS GRID -->\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem; margin-bottom: 1.5rem;\">\n          <div id=\"preg-input-date-grp\">\n            <label id=\"preg-date-lbl\" style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">\n              First Day of Last Menstrual Period:\n            </label>\n            <input type=\"date\" id=\"preg-date-input\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1rem;\" onchange=\"calcPregnancy()\" />\n          </div>\n\n          <div id=\"preg-cycle-grp\">\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">\n              Average Menstrual Cycle Length:\n            </label>\n            <select id=\"preg-cycle-len\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.95rem;\" onchange=\"calcPregnancy()\">\n              <option value=\"21\">21 Days (Short)</option>\n              <option value=\"24\">24 Days</option>\n              <option value=\"26\">26 Days</option>\n              <option value=\"28\" selected>28 Days (Standard Regular)</option>\n              <option value=\"30\">30 Days</option>\n              <option value=\"32\">32 Days</option>\n              <option value=\"35\">35 Days (Long)</option>\n            </select>\n          </div>\n\n          <div id=\"preg-us-weeks-grp\" style=\"display: none;\">\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">\n              Gestational Age at Scan:\n            </label>\n            <div style=\"display: flex; gap: 0.5rem;\">\n              <input type=\"number\" id=\"preg-us-weeks\" value=\"8\" min=\"4\" max=\"40\" style=\"width: 50%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono);\" placeholder=\"Weeks\" oninput=\"calcPregnancy()\" />\n              <input type=\"number\" id=\"preg-us-days\" value=\"3\" min=\"0\" max=\"6\" style=\"width: 50%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono);\" placeholder=\"Days\" oninput=\"calcPregnancy()\" />\n            </div>\n          </div>\n\n          <div id=\"preg-ivf-type-grp\" style=\"display: none;\">\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">\n              IVF Embryo Age at Transfer:\n            </label>\n            <select id=\"preg-ivf-type\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.95rem;\" onchange=\"calcPregnancy()\">\n              <option value=\"5\" selected>Day 5 Blastocyst (Most Common)</option>\n              <option value=\"3\">Day 3 Embryo</option>\n              <option value=\"6\">Day 6 Blastocyst</option>\n            </select>\n          </div>\n        </div>\n\n        <!-- MAIN RESULT KPI CARDS -->\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;\">\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #6366f1;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">\n              Estimated Due Date (EDD)\n            </div>\n            <div id=\"preg-edd-date\" style=\"font-family: var(--mono); font-size: 1.7rem; font-weight: bold; color: #6366f1; margin-bottom: 0.2rem;\">\n              --\n            </div>\n            <div id=\"preg-edd-sub\" style=\"font-size: 0.85rem; color: var(--text-muted);\">\n              40 Weeks 0 Days\n            </div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #10b981;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">\n              Current Gestational Age\n            </div>\n            <div id=\"preg-gest-age\" style=\"font-family: var(--mono); font-size: 1.7rem; font-weight: bold; color: #10b981; margin-bottom: 0.2rem;\">\n              --\n            </div>\n            <div id=\"preg-gest-pct\" style=\"font-size: 0.85rem; color: var(--text-muted);\">\n              --\n            </div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #3b82f6;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">\n              Current Trimester\n            </div>\n            <div id=\"preg-trim-curr\" style=\"font-family: var(--mono); font-size: 1.7rem; font-weight: bold; color: #3b82f6; margin-bottom: 0.2rem;\">\n              --\n            </div>\n            <div id=\"preg-trim-sub\" style=\"font-size: 0.85rem; color: var(--text-muted);\">\n              --\n            </div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #f59e0b;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">\n              Fetal Size Benchmark\n            </div>\n            <div id=\"preg-fruit-size\" style=\"font-family: var(--mono); font-size: 1.4rem; font-weight: bold; color: #f59e0b; margin-bottom: 0.2rem;\">\n              --\n            </div>\n            <div id=\"preg-fruit-dim\" style=\"font-size: 0.85rem; color: var(--text-muted);\">\n              --\n            </div>\n          </div>\n        </div>\n      </div>\n\n      <!-- INTERACTIVE 40-WEEK PROGRESS & PROBABILITY BELL CURVE -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.35rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          📈 40-Week Gestational Timeline &amp; Delivery Probability Distribution\n        </h2>\n        <p style=\"font-size: 0.85rem; color: var(--text-muted); margin-bottom: 1.25rem;\">\n          Trimester milestones color-coded by clinical development phase. Gaussian curve represents statistical likelihood of spontaneous labor by gestational week.\n        </p>\n\n        <div style=\"overflow-x: auto;\">\n          <svg id=\"preg-timeline-svg\" viewBox=\"0 0 840 250\" style=\"width: 100%; height: auto; min-width: 600px; font-family: var(--mono);\"></svg>\n        </div>\n      </div>\n\n      <!-- TRIMESTER MILESTONES TABLE -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h3 style=\"font-family: var(--serif); font-size: 1.25rem; margin-top: 0; margin-bottom: 1rem; color: var(--fg);\">\n          🗓️ Clinical Trimester &amp; Milestone Schedule\n        </h3>\n        <div style=\"overflow-x: auto;\">\n          <table style=\"width: 100%; border-collapse: collapse; font-size: 0.9rem; text-align: left;\">\n            <thead>\n              <tr style=\"border-bottom: 2px solid var(--border); color: var(--text-muted);\">\n                <th style=\"padding: 0.6rem 0.75rem;\">Milestone Stage</th>\n                <th style=\"padding: 0.6rem 0.75rem;\">Gestational Age</th>\n                <th style=\"padding: 0.6rem 0.75rem;\">Projected Calendar Date</th>\n                <th style=\"padding: 0.6rem 0.75rem;\">Key Biological Development</th>\n              </tr>\n            </thead>\n            <tbody id=\"preg-milestones-body\">\n              <!-- Populated by JS -->\n            </tbody>\n          </table>\n        </div>\n      </div>\n\n      <!-- STEP-BY-STEP DERIVATION BOX -->\n      <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h3 style=\"font-family: var(--mono); font-size: 0.9rem; text-transform: uppercase; color: var(--text-muted); margin: 0 0 0.75rem 0;\">\n          📐 Step-by-Step Obstetric &amp; Naegele's Rule Derivation\n        </h3>\n        <div id=\"preg-derivation-box\" style=\"font-family: var(--mono); font-size: 0.85rem; line-height: 1.7; color: var(--fg);\">\n          Calculating gestational timeline...\n        </div>\n      </div>\n\n      <!-- ONE-CLICK COPY BUTTON -->\n      <div style=\"margin-bottom: 2.5rem;\">\n        <button type=\"button\" id=\"preg-copy-btn\" onclick=\"copyPregnancyReport(this)\" class=\"btn btn-copy\" style=\"display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; font-size: 0.9rem; font-weight: 600; background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; cursor: pointer; color: var(--fg); transition: all 0.15s ease;\">\n          <span>📋</span> Copy Full Pregnancy Timeline &amp; Milestone Report\n        </button>\n      </div>\n\n      <!-- 5 FATAL TRAPS -->\n      <div style=\"margin: 2.5rem 0;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.45rem; margin-bottom: 0.75rem; color: var(--fg);\">\n          ⚠️ 5 Fatal Traps &amp; Clinical Misunderstandings in Pregnancy Dating\n        </h2>\n        <div style=\"display: grid; grid-template-columns: 1fr; gap: 1rem;\">\n          <div class=\"trap-card\" style=\"border-left: 4px solid #ef4444;\">\n            <strong style=\"color: #ef4444;\">1. The 28-Day Cycle Naegele's Flaw</strong>\n            Naegele's rule universally assumes a classic 28-day cycle with ovulation occurring precisely on cycle day 14. For women with 35-day cycles, ovulation occurs around day 21 (two weeks before the next period). Failing to adjust for this 7-day offset results in an erroneously early due date, leading to false diagnoses of \"overdue\" pregnancy and premature labor induction.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #f59e0b;\">\n            <strong style=\"color: #f59e0b;\">2. First-Trimester Ultrasound vs LMP Discrepancy Conflict</strong>\n            Crown-Rump Length (CRL) measured via ultrasound between weeks 8 and 13 carries a margin of error of only ±3 to 5 days. Under American College of Obstetricians and Gynecologists (ACOG) guidelines, if early ultrasound dating differs from LMP dating by more than 7 days, the ultrasound date MUST supersede the LMP date. Insisting on LMP when ultrasound says otherwise risks misdating the entire pregnancy.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #10b981;\">\n            <strong style=\"color: #10b981;\">3. The \"Due Date is an Expiration Deadline\" Psychological Trap</strong>\n            Only 4% of infants arrive on their exact calculated due date. Human gestation normally ranges between 37 weeks, 0 days and 41 weeks, 6 days. Viewing 40 weeks as an immutable \"expiration date\" produces intense parental anxiety and leads to elective interventions before the cervix is physiologically ripe (low Bishop score).\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #3b82f6;\">\n            <strong style=\"color: #3b82f6;\">4. Overlooking Late-Term Placental Senescence After 41.5 Weeks</strong>\n            While labor often begins spontaneously between 40 and 41 weeks, continuing past 41 weeks and 3 days requires biophysical profile (BPP) ultrasound and non-stress testing (NST). The placenta is a temporary organ that undergoes calcification and vascular senescence after 41 weeks, increasing the risk of oligohydramnios (low amniotic fluid) and meconium aspiration.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #8b5cf6;\">\n            <strong style=\"color: #8b5cf6;\">5. False Reassurance from Home Fetal Doppler Devices</strong>\n            Consumer at-home fetal dopplers frequently pick up the maternal abdominal aorta or uterine artery (100–120 bpm) and mistake it for the fetal heartbeat (110–160 bpm). Relying on a consumer doppler instead of tracking standardized fetal kick counts (10 distinct movements within a 2-hour quiet window starting at week 28) can dangerously delay medical evaluation for decreased fetal movement.\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <script>\n      var curPregMode = 'lmp';\n\n      function setPregMode(mode) {\n        curPregMode = mode;\n        var btnLmp = document.getElementById('preg-tab-lmp');\n        var btnConc = document.getElementById('preg-tab-conception');\n        var btnUs = document.getElementById('preg-tab-ultrasound');\n        var btnIvf = document.getElementById('preg-tab-ivf');\n\n        var grpCycle = document.getElementById('preg-cycle-grp');\n        var grpUs = document.getElementById('preg-us-weeks-grp');\n        var grpIvf = document.getElementById('preg-ivf-type-grp');\n        var lblDate = document.getElementById('preg-date-lbl');\n\n        [btnLmp, btnConc, btnUs, btnIvf].forEach(function(b) {\n          b.style.background = 'var(--surface-alt)';\n          b.style.color = 'var(--fg)';\n          b.style.borderColor = 'var(--border)';\n        });\n\n        if (mode === 'lmp') {\n          btnLmp.style.background = '#6366f1';\n          btnLmp.style.color = '#fff';\n          btnLmp.style.borderColor = '#6366f1';\n          lblDate.textContent = 'First Day of Last Menstrual Period (LMP):';\n          grpCycle.style.display = 'block';\n          grpUs.style.display = 'none';\n          grpIvf.style.display = 'none';\n        } else if (mode === 'conception') {\n          btnConc.style.background = '#6366f1';\n          btnConc.style.color = '#fff';\n          btnConc.style.borderColor = '#6366f1';\n          lblDate.textContent = 'Exact Conception / Ovulation Date:';\n          grpCycle.style.display = 'none';\n          grpUs.style.display = 'none';\n          grpIvf.style.display = 'none';\n        } else if (mode === 'ultrasound') {\n          btnUs.style.background = '#6366f1';\n          btnUs.style.color = '#fff';\n          btnUs.style.borderColor = '#6366f1';\n          lblDate.textContent = 'Date of Ultrasound Scan:';\n          grpCycle.style.display = 'none';\n          grpUs.style.display = 'block';\n          grpIvf.style.display = 'none';\n        } else if (mode === 'ivf') {\n          btnIvf.style.background = '#6366f1';\n          btnIvf.style.color = '#fff';\n          btnIvf.style.borderColor = '#6366f1';\n          lblDate.textContent = 'Date of Embryo Transfer:';\n          grpCycle.style.display = 'none';\n          grpUs.style.display = 'none';\n          grpIvf.style.display = 'block';\n        }\n\n        calcPregnancy();\n      }\n\n      function formatDate(d) {\n        var opts = { weekday: 'short', year: 'numeric', month: 'short', day: 'numeric' };\n        return d.toLocaleDateString('en-US', opts);\n      }\n\n      function addDays(date, days) {\n        var result = new Date(date);\n        result.setDate(result.getDate() + days);\n        return result;\n      }\n\n      function calcPregnancy() {\n        var dateInput = document.getElementById('preg-date-input').value;\n        if (!dateInput) {\n          // Default to 12 weeks ago\n          var defDate = new Date();\n          defDate.setDate(defDate.getDate() - 84);\n          var monthStr = ('0' + (defDate.getMonth() + 1)).slice(-2);\n          var dayStr = ('0' + defDate.getDate()).slice(-2);\n          dateInput = defDate.getFullYear() + '-' + monthStr + '-' + dayStr;\n          document.getElementById('preg-date-input').value = dateInput;\n        }\n\n        var parts = dateInput.split('-');\n        var baseDate = new Date(parseInt(parts[0], 10), parseInt(parts[1], 10) - 1, parseInt(parts[2], 10));\n        var today = new Date();\n        today.setHours(0, 0, 0, 0);\n\n        var edd = new Date();\n        var lmpEquiv = new Date();\n        var cycleLen = parseInt(document.getElementById('preg-cycle-len').value, 10) || 28;\n\n        if (curPregMode === 'lmp') {\n          var cycleOffset = cycleLen - 28;\n          edd = addDays(baseDate, 280 + cycleOffset);\n          lmpEquiv = baseDate;\n        } else if (curPregMode === 'conception') {\n          edd = addDays(baseDate, 266);\n          lmpEquiv = addDays(baseDate, -14);\n        } else if (curPregMode === 'ultrasound') {\n          var usW = parseInt(document.getElementById('preg-us-weeks').value, 10) || 8;\n          var usD = parseInt(document.getElementById('preg-us-days').value, 10) || 0;\n          var totalUsDays = (usW * 7) + usD;\n          lmpEquiv = addDays(baseDate, -totalUsDays);\n          edd = addDays(lmpEquiv, 280);\n        } else if (curPregMode === 'ivf') {\n          var ivfAge = parseInt(document.getElementById('preg-ivf-type').value, 10) || 5;\n          edd = addDays(baseDate, 266 - ivfAge);\n          lmpEquiv = addDays(baseDate, -(14 + ivfAge));\n        }\n\n        // Current Gestational Age\n        var diffMs = today.getTime() - lmpEquiv.getTime();\n        var totalDays = Math.floor(diffMs / (1000 * 60 * 60 * 24));\n        if (totalDays < 0) totalDays = 0;\n        var gestWeeks = Math.floor(totalDays / 7);\n        var gestDays = totalDays % 7;\n        var pctComplete = Math.min(100, Math.max(0, (totalDays / 280) * 100));\n\n        // Trimester\n        var trimesterStr = '1st Trimester';\n        var trimesterSub = 'Weeks 1 to 13 (Organogenesis)';\n        if (gestWeeks >= 14 && gestWeeks < 28) {\n          trimesterStr = '2nd Trimester';\n          trimesterSub = 'Weeks 14 to 27 (Golden Trimester)';\n        } else if (gestWeeks >= 28) {\n          trimesterStr = '3rd Trimester';\n          trimesterSub = 'Weeks 28 to 40+ (Rapid Growth & Maturation)';\n        }\n\n        // Fruit Size Analogy\n        var fruits = [\n          { w: 4, name: 'Poppy Seed', dim: '< 0.04 in / 0.1 mm' },\n          { w: 5, name: 'Sesame Seed', dim: '0.05 in / 1.3 mm' },\n          { w: 6, name: 'Lentil', dim: '0.2 in / 5 mm' },\n          { w: 7, name: 'Blueberry', dim: '0.5 in / 1.3 cm' },\n          { w: 8, name: 'Raspberry', dim: '0.6 in / 1.6 cm' },\n          { w: 9, name: 'Green Olive', dim: '0.9 in / 2.3 cm' },\n          { w: 10, name: 'Prune / Strawberry', dim: '1.2 in / 3.1 cm' },\n          { w: 11, name: 'Lime', dim: '1.6 in / 4.1 cm' },\n          { w: 12, name: 'Plum', dim: '2.1 in / 5.4 cm' },\n          { w: 13, name: 'Lemon', dim: '2.9 in / 7.4 cm' },\n          { w: 14, name: 'Navel Orange', dim: '3.4 in / 8.7 cm' },\n          { w: 16, name: 'Avocado', dim: '4.6 in / 11.6 cm' },\n          { w: 18, name: 'Bell Pepper', dim: '5.6 in / 14.2 cm' },\n          { w: 20, name: 'Banana', dim: '10.2 in / 25.6 cm' },\n          { w: 24, name: 'Ear of Corn', dim: '11.8 in / 30.0 cm' },\n          { w: 28, name: 'Eggplant', dim: '14.8 in / 37.6 cm' },\n          { w: 32, name: 'Cantaloupe / Squash', dim: '16.7 in / 42.4 cm' },\n          { w: 36, name: 'Honeydew Melon', dim: '18.7 in / 47.4 cm' },\n          { w: 38, name: 'Winter Melon', dim: '19.6 in / 49.8 cm' },\n          { w: 40, name: 'Watermelon / Pumpkin', dim: '20.2 in / 51.2 cm' }\n        ];\n\n        var fruitObj = fruits[0];\n        for (var f = 0; f < fruits.length; f++) {\n          if (gestWeeks >= fruits[f].w) {\n            fruitObj = fruits[f];\n          }\n        }\n\n        // Update KPIs\n        document.getElementById('preg-edd-date').textContent = formatDate(edd);\n        var daysUntilEdd = Math.floor((edd.getTime() - today.getTime()) / (1000 * 60 * 60 * 24));\n        document.getElementById('preg-edd-sub').textContent = (daysUntilEdd >= 0 ? daysUntilEdd + ' Days Remaining' : Math.abs(daysUntilEdd) + ' Days Post-Term');\n\n        document.getElementById('preg-gest-age').textContent = gestWeeks + 'w ' + gestDays + 'd';\n        document.getElementById('preg-gest-pct').textContent = pctComplete.toFixed(1) + '% of 40 Weeks Complete (Day ' + totalDays + ')';\n\n        document.getElementById('preg-trim-curr').textContent = trimesterStr;\n        document.getElementById('preg-trim-sub').textContent = trimesterSub;\n\n        document.getElementById('preg-fruit-size').textContent = fruitObj.name;\n        document.getElementById('preg-fruit-dim').textContent = fruitObj.dim;\n\n        // Populate Milestones Table\n        var t1End = addDays(lmpEquiv, 13 * 7 + 6);\n        var t2End = addDays(lmpEquiv, 27 * 7 + 6);\n        var termStart = addDays(lmpEquiv, 37 * 7);\n        var postTerm = addDays(lmpEquiv, 41 * 7);\n        var conceptionEst = addDays(lmpEquiv, 14);\n\n        var milestones = [\n          { name: 'Estimated Conception Window', age: '2w 0d', date: formatDate(conceptionEst), bio: 'Fertilization & blastocyst formation' },\n          { name: 'Embryonic Heartbeat Detectable', age: '5w 4d to 6w 0d', date: formatDate(addDays(lmpEquiv, 40)), bio: 'Cardiac tube contraction on transvaginal scan' },\n          { name: 'End of 1st Trimester', age: '13w 6d', date: formatDate(t1End), bio: 'All major organ systems formed; miscarriage risk drops sharply' },\n          { name: 'Anatomy Ultrasound Scan (Level II)', age: '18w to 20w', date: formatDate(addDays(lmpEquiv, 19 * 7)), bio: 'Full anatomical organ audit and fetal gender determination' },\n          { name: 'Fetal Viability Threshold', age: '24w 0d', date: formatDate(addDays(lmpEquiv, 24 * 7)), bio: 'Neonatal ICU survival capability (exceeds 50%)' },\n          { name: 'End of 2nd Trimester', age: '27w 6d', date: formatDate(t2End), bio: 'Rapid brain development and sensory perception' },\n          { name: 'Full Term Threshold', age: '37w 0d', date: formatDate(termStart), bio: 'Fetal lungs produce sufficient surfactant for unassisted breathing' },\n          { name: 'Official Due Date (EDD)', age: '40w 0d', date: formatDate(edd), bio: 'Average 280-day gestational completion milestone' },\n          { name: 'Late Term / Induction Surveillance', age: '41w 0d', date: formatDate(postTerm), bio: 'Biophysical profile monitoring for placental sufficiency' }\n        ];\n\n        var tHtml = '';\n        milestones.forEach(function(m) {\n          tHtml += '<tr style=\"border-bottom: 1px solid var(--border);\">' +\n            '<td style=\"padding: 0.6rem 0.75rem; font-weight: 600;\">' + m.name + '</td>' +\n            '<td style=\"padding: 0.6rem 0.75rem; font-family: var(--mono); color: #6366f1;\">' + m.age + '</td>' +\n            '<td style=\"padding: 0.6rem 0.75rem; font-family: var(--mono); color: var(--fg);\">' + m.date + '</td>' +\n            '<td style=\"padding: 0.6rem 0.75rem; font-size: 0.82rem; color: var(--text-muted);\">' + m.bio + '</td>' +\n          '</tr>';\n        });\n        document.getElementById('preg-milestones-body').innerHTML = tHtml;\n\n        // Render Derivation Box\n        var dBox = document.getElementById('preg-derivation-box');\n        dBox.innerHTML = '<strong>1. Baseline Dating Method:</strong> ' + (curPregMode === 'lmp' ? 'Naegele\\'s Rule from LMP (' + formatDate(baseDate) + ')' : (curPregMode === 'conception' ? 'Conception Date + 266 Days' : (curPregMode === 'ultrasound' ? 'Ultrasound Scan Offset' : 'IVF Blastocyst Transfer Formula'))) + '<br>' +\n          '<strong>2. Menstrual Cycle Adjustment:</strong> Base 28-day cycle with ' + cycleLen + '-day duration = <strong>' + (cycleLen >= 28 ? '+' : '') + (cycleLen - 28) + ' days</strong> adjustment.<br>' +\n          '<strong>3. Equivalent LMP Anchor:</strong> ' + formatDate(lmpEquiv) + '<br>' +\n          '<strong>4. Current Day Count:</strong> ' + totalDays + ' elapsed days / 280 total days = <strong>' + gestWeeks + ' Weeks, ' + gestDays + ' Days (' + pctComplete.toFixed(1) + '%)</strong>.<br>' +\n          '<strong>5. Final Estimated Due Date:</strong> ' + formatDate(edd) + ' (Full Term begins at 37 Weeks: ' + formatDate(termStart) + ').';\n\n        // Render Timeline SVG\n        renderPregTimelineSvg(totalDays);\n      }\n\n      function renderPregTimelineSvg(curDays) {\n        var svg = document.getElementById('preg-timeline-svg');\n        if (!svg) return;\n\n        var w = 840, h = 250;\n        var barX = 50, barY = 160, barW = 740, barH = 26;\n\n        var t1W = (98 / 280) * barW;  // 14 weeks = 98 days\n        var t2W = (98 / 280) * barW;  // weeks 14-28 = 98 days\n        var t3W = (84 / 280) * barW;  // weeks 28-40 = 84 days\n\n        var curClampedDays = Math.min(280, Math.max(0, curDays));\n        var curMarkerX = barX + ((curClampedDays / 280) * barW);\n\n        var svgContent = '';\n\n        // Background Bar Trimesters\n        svgContent += '<rect x=\"' + barX + '\" y=\"' + barY + '\" width=\"' + t1W + '\" height=\"' + barH + '\" fill=\"#6366f1\" rx=\"4 0 0 4\" opacity=\"0.85\"><title>1st Trimester (0-14w)</title></rect>';\n        svgContent += '<rect x=\"' + (barX + t1W) + '\" y=\"' + barY + '\" width=\"' + t2W + '\" height=\"' + barH + '\" fill=\"#3b82f6\" opacity=\"0.85\"><title>2nd Trimester (14-28w)</title></rect>';\n        svgContent += '<rect x=\"' + (barX + t1W + t2W) + '\" y=\"' + barY + '\" width=\"' + t3W + '\" height=\"' + barH + '\" fill=\"#10b981\" rx=\"0 4 4 0\" opacity=\"0.85\"><title>3rd Trimester (28-40w)</title></rect>';\n\n        // Trimester Labels\n        svgContent += '<text x=\"' + (barX + t1W/2) + '\" y=\"' + (barY + 17) + '\" fill=\"#fff\" font-size=\"11\" font-weight=\"bold\" text-anchor=\"middle\">1st Trimester</text>';\n        svgContent += '<text x=\"' + (barX + t1W + t2W/2) + '\" y=\"' + (barY + 17) + '\" fill=\"#fff\" font-size=\"11\" font-weight=\"bold\" text-anchor=\"middle\">2nd Trimester</text>';\n        svgContent += '<text x=\"' + (barX + t1W + t2W + t3W/2) + '\" y=\"' + (barY + 17) + '\" fill=\"#fff\" font-size=\"11\" font-weight=\"bold\" text-anchor=\"middle\">3rd Trimester</text>';\n\n        // Week tick marks (0, 10, 20, 30, 37, 40)\n        [0, 10, 20, 30, 37, 40].forEach(function(wk) {\n          var tx = barX + ((wk / 40) * barW);\n          svgContent += '<line x1=\"' + tx + '\" y1=\"' + (barY + barH) + '\" x2=\"' + tx + '\" y2=\"' + (barY + barH + 8) + '\" stroke=\"var(--border)\" stroke-width=\"2\" />';\n          svgContent += '<text x=\"' + tx + '\" y=\"' + (barY + barH + 22) + '\" fill=\"var(--text-muted)\" font-size=\"11\" text-anchor=\"middle\">' + wk + 'w</text>';\n        });\n\n        // Gaussian Probability Bell Curve for Delivery Window (Weeks 34 to 42)\n        // Peak is at 40 weeks (x = barX + barW)\n        var curvePoints = [];\n        for (var wPoint = 32; wPoint <= 42; wPoint += 0.25) {\n          var xP = barX + ((wPoint / 40) * barW);\n          // Normal distribution centered at 39.8 weeks, std dev 1.3 weeks\n          var exponent = -Math.pow(wPoint - 39.8, 2) / (2 * Math.pow(1.4, 2));\n          var yHeight = 110 * Math.exp(exponent);\n          var yP = (barY - 15) - yHeight;\n          curvePoints.push(xP.toFixed(1) + ',' + yP.toFixed(1));\n        }\n\n        var polyPath = 'M ' + (barX + ((32 / 40) * barW)) + ' ' + (barY - 15) + ' ' +\n          'L ' + curvePoints.join(' ') + ' ' +\n          'L ' + (barX + ((42 / 40) * barW)) + ' ' + (barY - 15) + ' Z';\n\n        svgContent += '<path d=\"' + polyPath + '\" fill=\"rgba(99, 102, 241, 0.15)\" stroke=\"#6366f1\" stroke-width=\"2\" />';\n        svgContent += '<text x=\"' + (barX + barW - 15) + '\" y=\"35\" fill=\"#6366f1\" font-size=\"11\" font-weight=\"bold\" text-anchor=\"middle\">Peak Delivery Window (57% born 39-40w)</text>';\n\n        // Current Gestational Marker\n        svgContent += '<line x1=\"' + curMarkerX + '\" y1=\"30\" x2=\"' + curMarkerX + '\" y2=\"' + (barY + barH) + '\" stroke=\"#ef4444\" stroke-width=\"2.5\" stroke-dasharray=\"4,3\" />';\n        svgContent += '<polygon points=\"' + (curMarkerX - 6) + ',25 ' + (curMarkerX + 6) + ',25 ' + curMarkerX + ',35\" fill=\"#ef4444\" />';\n        svgContent += '<text x=\"' + curMarkerX + '\" y=\"18\" fill=\"#ef4444\" font-size=\"12\" font-weight=\"bold\" text-anchor=\"middle\">You are here (' + Math.floor(curDays/7) + 'w ' + (curDays%7) + 'd)</text>';\n\n        svg.innerHTML = svgContent;\n      }\n\n      function copyPregnancyReport(btn) {\n        var edd = document.getElementById('preg-edd-date').textContent;\n        var gest = document.getElementById('preg-gest-age').textContent;\n        var pct = document.getElementById('preg-gest-pct').textContent;\n        var trim = document.getElementById('preg-trim-curr').textContent;\n        var fruit = document.getElementById('preg-fruit-size').textContent;\n        var rem = document.getElementById('preg-edd-sub').textContent;\n\n        var text = '🤰 PREGNANCY DUE DATE & GESTATIONAL MILESTONES\\n' +\n          '====================================================\\n' +\n          '• Estimated Due Date (EDD): ' + edd + ' (' + rem + ')\\n' +\n          '• Current Gestational Age: ' + gest + ' (' + pct + ')\\n' +\n          '• Current Trimester: ' + trim + '\\n' +\n          '• Fetal Size Benchmark: Size of a ' + fruit + '\\n' +\n          '----------------------------------------------------\\n' +\n          'Clinical Notes: 70% of births occur within 10 days of EDD.\\n' +\n          'Full-term begins at 37 weeks 0 days.\\n' +\n          'Calculated via Digital Tools Shed: https://digitaltoolsshed.com/health/pregnancy-calculator';\n\n        navigator.clipboard.writeText(text).then(function() {\n          if (btn) {\n            var orig = btn.innerHTML;\n            btn.innerHTML = '<span>✓</span> Milestone Summary Copied!';\n            btn.style.borderColor = '#10b981';\n            btn.style.color = '#10b981';\n            setTimeout(function() {\n              btn.innerHTML = orig;\n              btn.style.borderColor = 'var(--border)';\n              btn.style.color = 'var(--fg)';\n            }, 2000);\n          }\n        });\n      }\n\n      if (document.readyState === 'loading') {\n        document.addEventListener('DOMContentLoaded', calcPregnancy);\n      } else {\n        calcPregnancy();\n      }\n    </script>\n  "
},
{
  "slug": "target-heart-rate-calculator",
  "title": "Target Heart Rate Calculator & 5 Cardio Training Zones (Karvonen & Tanaka Formulas)",
  "metaDesc": "Calculate maximum heart rate (HRmax), resting heart rate reserve (HRR), and 5 cardiovascular training zones using the Karvonen, Tanaka, and Gellish formulas with live fat-burning analysis.",
  "category": "Health & Fitness",
  "faq": [
    {
      "q": "What is the Karvonen formula and why is it superior to 220 minus age?",
      "a": "The Karvonen formula calculates target heart rate based on Heart Rate Reserve (HRR = HRmax - HRrest), factoring in your individual resting heart rate: Target HR = HRrest + (HRR × %Intensity). The crude '220 - Age' formula ignores cardiovascular fitness; a trained athlete with a resting HR of 45 bpm has a drastically different aerobic capacity than a sedentary individual with a resting HR of 80 bpm at the exact same age."
    },
    {
      "q": "What are the 5 physiological heart rate training zones?",
      "a": "The 5 cardio training zones are: Zone 1 (50%–60% HRR): Active Recovery; Zone 2 (60%–70% HRR): Aerobic Base & Maximum Fat Oxidation (mitochondrial biogenesis); Zone 3 (70%–80% HRR): Aerobic Tempo (glycogen sparing); Zone 4 (80%–90% HRR): Anaerobic / Lactate Threshold (OBLA); Zone 5 (90%–100% HRR): VO2 Max & Neuromuscular Sprint Capacity."
    },
    {
      "q": "Why is Zone 2 training prioritized by endurance athletes?",
      "a": "Zone 2 (60%–70% HRR) stimulates Type I slow-twitch muscle fibers, stimulates mitochondrial enzyme proliferation, increases capillary density around working muscles, and maximizes the body's rate of fatty acid oxidation while keeping blood lactate below 2.0 mmol/L. This builds an immense aerobic engine without accumulating autonomic nervous system fatigue."
    },
    {
      "q": "Which formula is most accurate for calculating maximum heart rate (HRmax)?",
      "a": "The Tanaka formula [HRmax = 208 - (0.7 × Age)] and the Gellish formula [HRmax = 207 - (0.7 × Age)] are scientifically superior to the 1971 Fox formula (220 - Age). Large-scale meta-analyses show that 220 - Age overestimates HRmax in young adults and severely underestimates HRmax in adults over 40 by up to 15 to 20 beats per minute."
    },
    {
      "q": "What is the 'Fat Burning Zone' and does it burn more total fat?",
      "a": "While Zone 2 derives a higher *proportion* of its energy from stored fatty acids (roughly 65% to 75% fat vs 25% carbohydrates), higher intensity workouts in Zone 4 burn significantly more *total calories per minute*. Total fat grams oxidized over 24 hours often equalizes due to post-exercise oxygen consumption (EPOC)."
    }
  ],
  "body": "\n    <div class=\"article-container\" style=\"max-width: 1020px;\">\n      <nav style=\"font-family: var(--mono); font-size: 0.8rem; margin-bottom: 1.5rem; color: var(--text-muted);\">\n        <a href=\"/\">Home</a> &gt; <a href=\"/health/\">Health &amp; Fitness</a> &gt; Target Heart Rate Calculator\n      </nav>\n\n      <header style=\"margin-bottom: 2rem;\">\n        <div style=\"display: flex; gap: 0.5rem; align-items: center; margin-bottom: 0.5rem; flex-wrap: wrap;\">\n          <span class=\"badge badge-purple\">Cardiovascular Physiology</span>\n          <span class=\"badge badge-green\">Karvonen HRR Engine</span>\n          <span class=\"badge badge-blue\">Zero Server Uploads</span>\n        </div>\n        <h1 style=\"font-family: var(--serif); font-size: 2.3rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          Target Heart Rate &amp; 5 Cardio Training Zones Calculator\n        </h1>\n        <p style=\"color: var(--text-muted); font-size: 1.05rem; line-height: 1.6;\">\n          Determine your maximum heart rate (HRmax), Heart Rate Reserve (HRR), and exact 5-zone cardiovascular training boundaries using the clinical Karvonen, Tanaka, and Gellish formulas with substrate oxidation modeling.\n        </p>\n      </header>\n\n      <!-- INPUTS BOX -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); padding: 1.75rem; border-radius: 8px; margin-bottom: 2rem;\">\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.25rem; margin-bottom: 1.5rem;\">\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Your Age (Years):</label>\n            <input type=\"number\" id=\"thr-age\" value=\"32\" min=\"15\" max=\"100\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcHeartRate()\" />\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Resting Heart Rate (BPM):</label>\n            <input type=\"number\" id=\"thr-rest\" value=\"58\" min=\"30\" max=\"120\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcHeartRate()\" />\n            <span style=\"font-size: 0.75rem; color: var(--text-muted); display: block; margin-top: 0.2rem;\">Measured upon waking</span>\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Biological Sex:</label>\n            <select id=\"thr-sex\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.95rem;\" onchange=\"calcHeartRate()\">\n              <option value=\"male\" selected>Male</option>\n              <option value=\"female\">Female</option>\n            </select>\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">HRmax Formula:</label>\n            <select id=\"thr-formula\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.95rem;\" onchange=\"calcHeartRate()\">\n              <option value=\"tanaka\" selected>Tanaka (208 - 0.7 × Age) [Recommended]</option>\n              <option value=\"gellish\">Gellish (207 - 0.7 × Age)</option>\n              <option value=\"fox\">Fox (220 - Age) [Traditional Standard]</option>\n            </select>\n          </div>\n        </div>\n\n        <!-- KPI RESULT CARDS -->\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;\">\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #ef4444;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Maximum Heart Rate (HRmax)</div>\n            <div id=\"thr-hrmax\" style=\"font-family: var(--mono); font-size: 2.1rem; font-weight: bold; color: #ef4444; margin-bottom: 0.2rem;\">186 BPM</div>\n            <div style=\"font-size: 0.85rem; color: var(--text-muted);\">Upper physiological ceiling</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #6366f1;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Heart Rate Reserve (HRR)</div>\n            <div id=\"thr-hrr\" style=\"font-family: var(--mono); font-size: 2.1rem; font-weight: bold; color: #6366f1; margin-bottom: 0.2rem;\">128 BPM</div>\n            <div style=\"font-size: 0.85rem; color: var(--text-muted);\">Dynamic aerobic buffer (HRmax - HRrest)</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #10b981;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Zone 2 Aerobic Base (Fat Burn)</div>\n            <div id=\"thr-zone2\" style=\"font-family: var(--mono); font-size: 2.1rem; font-weight: bold; color: #10b981; margin-bottom: 0.2rem;\">135 - 148 BPM</div>\n            <div style=\"font-size: 0.85rem; color: var(--text-muted);\">60% - 70% Karvonen Intensity</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #f59e0b;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Zone 4 Lactate Threshold (LT)</div>\n            <div id=\"thr-zone4\" style=\"font-family: var(--mono); font-size: 2.1rem; font-weight: bold; color: #f59e0b; margin-bottom: 0.2rem;\">160 - 173 BPM</div>\n            <div style=\"font-size: 0.85rem; color: var(--text-muted);\">80% - 90% Karvonen Intensity</div>\n          </div>\n        </div>\n      </div>\n\n      <!-- INTERACTIVE SVG TACHOMETER & SUBSTRATE OXIDATION GAUGE -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <div style=\"display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem; flex-wrap: wrap;\">\n          <h2 style=\"font-family: var(--serif); font-size: 1.35rem; margin: 0; color: var(--fg);\">\n            📊 Interactive 5-Zone Cardiovascular Tachometer\n          </h2>\n          <div style=\"font-family: var(--mono); font-size: 0.85rem; color: var(--text-muted);\">\n            Slide intensity: <input type=\"range\" id=\"thr-intensity-slider\" min=\"50\" max=\"100\" value=\"65\" style=\"vertical-align: middle;\" oninput=\"syncIntensitySlider(this.value)\" />\n            <span id=\"thr-slider-val\" style=\"font-weight: bold; color: #6366f1;\">65%</span>\n          </div>\n        </div>\n        <p style=\"font-size: 0.85rem; color: var(--text-muted); margin-bottom: 1.25rem;\">\n          Vector gauge illustrating current training zone, exact target BPM, and metabolic fuel substrate breakdown (Fatty Acids vs Glycogen).\n        </p>\n\n        <div style=\"overflow-x: auto;\">\n          <svg id=\"thr-gauge-svg\" viewBox=\"0 0 800 240\" style=\"width: 100%; height: auto; min-width: 600px; font-family: var(--mono);\"></svg>\n        </div>\n      </div>\n\n      <!-- 5-ZONE DETAILED BREAKDOWN TABLE -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h3 style=\"font-family: var(--serif); font-size: 1.25rem; margin-top: 0; margin-bottom: 1rem; color: var(--fg);\">\n          🏃 Comprehensive 5-Zone Physiological Breakdown\n        </h3>\n        <div style=\"overflow-x: auto;\">\n          <table style=\"width: 100%; border-collapse: collapse; font-size: 0.9rem; text-align: left;\">\n            <thead>\n              <tr style=\"border-bottom: 2px solid var(--border); color: var(--text-muted);\">\n                <th style=\"padding: 0.6rem 0.75rem;\">Zone</th>\n                <th style=\"padding: 0.6rem 0.75rem;\">Intensity (% HRR)</th>\n                <th style=\"padding: 0.6rem 0.75rem;\">Target Heart Rate</th>\n                <th style=\"padding: 0.6rem 0.75rem;\">Metabolic Substrate</th>\n                <th style=\"padding: 0.6rem 0.75rem;\">Primary Cardiovascular Adaptation</th>\n              </tr>\n            </thead>\n            <tbody id=\"thr-zones-table-body\">\n              <!-- Populated by JS -->\n            </tbody>\n          </table>\n        </div>\n      </div>\n\n      <!-- STEP-BY-STEP WORKED DERIVATION -->\n      <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h3 style=\"font-family: var(--mono); font-size: 0.9rem; text-transform: uppercase; color: var(--text-muted); margin: 0 0 0.75rem 0;\">\n          📐 Step-by-Step Karvonen &amp; Tanaka Mathematical Derivations\n        </h3>\n        <div id=\"thr-derivation-box\" style=\"font-family: var(--mono); font-size: 0.85rem; line-height: 1.7; color: var(--fg);\">\n          Computing live cardiometric values...\n        </div>\n      </div>\n\n      <!-- COPY BUTTON -->\n      <div style=\"margin-bottom: 2.5rem;\">\n        <button type=\"button\" id=\"thr-copy-btn\" onclick=\"copyHeartRateReport(this)\" class=\"btn btn-copy\" style=\"display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; font-size: 0.9rem; font-weight: 600; background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; cursor: pointer; color: var(--fg); transition: all 0.15s ease;\">\n          <span>📋</span> Copy 5-Zone Target Heart Rate Profile\n        </button>\n      </div>\n\n      <!-- 5 FATAL TRAPS -->\n      <div style=\"margin: 2.5rem 0;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.45rem; margin-bottom: 0.75rem; color: var(--fg);\">\n          ⚠️ 5 Fatal Traps &amp; Common Training Zone Errors\n        </h2>\n        <div style=\"display: grid; grid-template-columns: 1fr; gap: 1rem;\">\n          <div class=\"trap-card\" style=\"border-left: 4px solid #ef4444;\">\n            <strong style=\"color: #ef4444;\">1. The 1971 Fox Formula Error Spread (220 - Age)</strong>\n            The classic \"220 minus age\" equation has an intrinsic standard error of ±11 beats per minute. For a 40-year-old, true laboratory-measured HRmax can comfortably range from 169 to 191 BPM. Blindly setting training zones using 220 - age leads over half of all athletes to either train too hard on recovery days or fail to stimulate VO2 max adaptation on interval days.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #f59e0b;\">\n            <strong style=\"color: #f59e0b;\">2. Cardiovascular Drift During Long Sessions</strong>\n            In exercise bouts lasting over 45 minutes—especially in warm or humid environments—stroke volume progressively declines due to cutaneous vasodilation (blood flow redirected to skin for sweating) and dehydration. To maintain constant cardiac output, the heart must beat 10 to 15 BPM faster even though running pace and metabolic output remain identical.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #10b981;\">\n            <strong style=\"color: #10b981;\">3. Beta-Blocker &amp; Stimulant Heart Rate Distortion</strong>\n            Prescription beta-blockers (e.g. metoprolol, propranolol) competitively inhibit beta-adrenergic receptors, artificially suppressing maximum exercise heart rate by 15 to 30 BPM. Conversely, high-caffeine pre-workouts, ephedrine, and ADHD stimulant medications inflate resting and submaximal heart rates, rendering unadjusted formulas useless.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #3b82f6;\">\n            <strong style=\"color: #3b82f6;\">4. The \"Fat Burning Zone\" Caloric Fallacy</strong>\n            Many gym-goers strictly limit cardio intensity to Zone 2 because it derives 70% of energy from fat compared to only 20% in Zone 4. However, high-intensity exercise in Zone 4 burns more than triple the total calories per hour and generates substantially higher excess post-exercise oxygen consumption (EPOC), burning equivalent or greater net fat over a 24-hour cycle.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #8b5cf6;\">\n            <strong style=\"color: #8b5cf6;\">5. Morning Resting HR Spikes as an Overtraining Biomarker</strong>\n            Ignoring a persistent 7 to 10 BPM elevation in waking resting heart rate is a classic mistake. An elevated morning resting HR indicates parasympathetic withdrawal and sympathetic overdrive caused by chronic muscular microtrauma, systemic overreaching, poor sleep architecture, or an impending viral infection.\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <script>\n      function syncIntensitySlider(val) {\n        document.getElementById('thr-slider-val').textContent = val + '%';\n        calcHeartRate();\n      }\n\n      function calcHeartRate() {\n        var age = parseFloat(document.getElementById('thr-age').value) || 32;\n        var rest = parseFloat(document.getElementById('thr-rest').value) || 58;\n        var formula = document.getElementById('thr-formula').value;\n        var sliderIntensity = (parseFloat(document.getElementById('thr-intensity-slider').value) || 65) / 100;\n\n        // HRmax calculation\n        var hrmax = 220 - age;\n        if (formula === 'tanaka') {\n          hrmax = 208 - (0.7 * age);\n        } else if (formula === 'gellish') {\n          hrmax = 207 - (0.7 * age);\n        }\n        hrmax = Math.round(hrmax);\n\n        // Heart Rate Reserve (Karvonen)\n        var hrr = Math.max(20, hrmax - rest);\n\n        // 5 Zones\n        var zones = [\n          { z: 'Zone 1', name: 'Active Recovery', minPct: 0.50, maxPct: 0.60, fuel: '85% Fat / 15% Carb', adapt: 'Capillary proliferation & metabolic waste flush', color: '#10b981' },\n          { z: 'Zone 2', name: 'Aerobic Base (Fat Burn)', minPct: 0.60, maxPct: 0.70, fuel: '70% Fat / 30% Carb', adapt: 'Mitochondrial biogenesis & lactate clearance', color: '#06b6d4' },\n          { z: 'Zone 3', name: 'Aerobic Tempo', minPct: 0.70, maxPct: 0.80, fuel: '50% Fat / 50% Carb', adapt: 'Cardiac output & glycogen economy', color: '#3b82f6' },\n          { z: 'Zone 4', name: 'Lactate Threshold (LT)', minPct: 0.80, maxPct: 0.90, fuel: '20% Fat / 80% Carb', adapt: 'Lactate buffering capacity & anaerobic tolerance', color: '#f59e0b' },\n          { z: 'Zone 5', name: 'Anaerobic / VO2 Max', minPct: 0.90, maxPct: 1.00, fuel: '5% Fat / 95% Carb', adapt: 'Maximal stroke volume & fast-twitch recruitment', color: '#ef4444' }\n        ];\n\n        zones.forEach(function(item) {\n          item.minBpm = Math.round(rest + (hrr * item.minPct));\n          item.maxBpm = Math.round(rest + (hrr * item.maxPct));\n        });\n\n        // Current Slider Target BPM\n        var currentTargetBpm = Math.round(rest + (hrr * sliderIntensity));\n\n        // Update KPIs\n        document.getElementById('thr-hrmax').textContent = hrmax + ' BPM';\n        document.getElementById('thr-hrr').textContent = hrr + ' BPM';\n        document.getElementById('thr-zone2').textContent = zones[1].minBpm + ' - ' + zones[1].maxBpm + ' BPM';\n        document.getElementById('thr-zone4').textContent = zones[3].minBpm + ' - ' + zones[3].maxBpm + ' BPM';\n\n        // Update Table Body\n        var tHtml = '';\n        zones.forEach(function(item) {\n          tHtml += '<tr style=\"border-bottom: 1px solid var(--border);\">' +\n            '<td style=\"padding: 0.6rem 0.75rem; font-weight: bold; color: ' + item.color + ';\">' + item.z + ' (' + item.name + ')</td>' +\n            '<td style=\"padding: 0.6rem 0.75rem; font-family: var(--mono);\">' + Math.round(item.minPct * 100) + '% - ' + Math.round(item.maxPct * 100) + '%</td>' +\n            '<td style=\"padding: 0.6rem 0.75rem; font-family: var(--mono); font-weight: bold;\">' + item.minBpm + ' - ' + item.maxBpm + ' BPM</td>' +\n            '<td style=\"padding: 0.6rem 0.75rem; font-size: 0.85rem; color: var(--text-muted);\">' + item.fuel + '</td>' +\n            '<td style=\"padding: 0.6rem 0.75rem; font-size: 0.85rem;\">' + item.adapt + '</td>' +\n          '</tr>';\n        });\n        document.getElementById('thr-zones-table-body').innerHTML = tHtml;\n\n        // Derivation Box\n        var dBox = document.getElementById('thr-derivation-box');\n        dBox.innerHTML = '<strong>1. Formula Selected:</strong> ' + (formula === 'tanaka' ? 'Tanaka Formula: 208 - (0.7 × ' + age + ') = <strong>' + hrmax + ' BPM</strong>' : (formula === 'gellish' ? 'Gellish Formula: 207 - (0.7 × ' + age + ') = <strong>' + hrmax + ' BPM</strong>' : 'Fox Formula: 220 - ' + age + ' = <strong>' + hrmax + ' BPM</strong>')) + '<br>' +\n          '<strong>2. Heart Rate Reserve (HRR):</strong> HRmax (' + hrmax + ') - HRrest (' + rest + ') = <strong>' + hrr + ' BPM</strong>.<br>' +\n          '<strong>3. Karvonen Zone 2 Lower Bound (60%):</strong> ' + rest + ' + (' + hrr + ' × 0.60) = <strong>' + zones[1].minBpm + ' BPM</strong>.<br>' +\n          '<strong>4. Karvonen Zone 2 Upper Bound (70%):</strong> ' + rest + ' + (' + hrr + ' × 0.70) = <strong>' + zones[1].maxBpm + ' BPM</strong>.<br>' +\n          '<strong>5. Active Slider Intensity (' + Math.round(sliderIntensity * 100) + '%):</strong> ' + rest + ' + (' + hrr + ' × ' + sliderIntensity.toFixed(2) + ') = <strong>' + currentTargetBpm + ' BPM</strong>.';\n\n        // Render Gauge SVG\n        renderTachometerSvg(zones, currentTargetBpm, rest, hrmax, sliderIntensity);\n      }\n\n      function renderTachometerSvg(zones, curBpm, restBpm, maxBpm, intensity) {\n        var svg = document.getElementById('thr-gauge-svg');\n        if (!svg) return;\n\n        var w = 800, h = 240;\n        var barX = 60, barY = 130, barW = 680, barH = 34;\n\n        var svgHtml = '';\n\n        // Draw 5 contiguous zone blocks on the bar\n        var blockW = barW / 5;\n        zones.forEach(function(z, idx) {\n          var bx = barX + (idx * blockW);\n          var rx = idx === 0 ? '6 0 0 6' : (idx === 4 ? '0 6 6 0' : '0');\n          svgHtml += '<rect x=\"' + bx + '\" y=\"' + barY + '\" width=\"' + blockW + '\" height=\"' + barH + '\" fill=\"' + z.color + '\" opacity=\"0.85\" rx=\"' + (idx === 0 ? '6' : (idx === 4 ? '6' : '0')) + '\"><title>' + z.z + ': ' + z.minBpm + '-' + z.maxBpm + ' BPM</title></rect>';\n          svgHtml += '<text x=\"' + (bx + blockW/2) + '\" y=\"' + (barY + 22) + '\" fill=\"#ffffff\" font-size=\"12\" font-weight=\"bold\" text-anchor=\"middle\">' + z.z + '</text>';\n          svgHtml += '<text x=\"' + (bx + blockW/2) + '\" y=\"' + (barY + barH + 18) + '\" fill=\"var(--text-muted)\" font-size=\"11\" text-anchor=\"middle\">' + z.minBpm + '-' + z.maxBpm + '</text>';\n        });\n\n        // Ticks at top\n        svgHtml += '<text x=\"' + barX + '\" y=\"' + (barY - 12) + '\" fill=\"var(--text-muted)\" font-size=\"11\" text-anchor=\"start\">Rest: ' + restBpm + ' BPM</text>';\n        svgHtml += '<text x=\"' + (barX + barW) + '\" y=\"' + (barY - 12) + '\" fill=\"#ef4444\" font-size=\"11\" font-weight=\"bold\" text-anchor=\"end\">Max: ' + maxBpm + ' BPM</text>';\n\n        // Needle Marker based on intensity (50% to 100% maps to 0 to barW)\n        var clampedIntensity = Math.min(1.0, Math.max(0.50, intensity));\n        var needleX = barX + (((clampedIntensity - 0.50) / 0.50) * barW);\n\n        svgHtml += '<line x1=\"' + needleX + '\" y1=\"30\" x2=\"' + needleX + '\" y2=\"' + (barY + barH) + '\" stroke=\"#ffffff\" stroke-width=\"3\" filter=\"drop-shadow(0 2px 4px rgba(0,0,0,0.5))\" />';\n        svgHtml += '<circle cx=\"' + needleX + '\" cy=\"30\" r=\"8\" fill=\"#6366f1\" stroke=\"#ffffff\" stroke-width=\"2\" />';\n        svgHtml += '<text x=\"' + needleX + '\" y=\"16\" fill=\"var(--fg)\" font-size=\"14\" font-weight=\"bold\" text-anchor=\"middle\">' + curBpm + ' BPM (' + Math.round(intensity * 100) + '%)</text>';\n\n        svg.innerHTML = svgHtml;\n      }\n\n      function copyHeartRateReport(btn) {\n        var hrmax = document.getElementById('thr-hrmax').textContent;\n        var hrr = document.getElementById('thr-hrr').textContent;\n        var z2 = document.getElementById('thr-zone2').textContent;\n        var z4 = document.getElementById('thr-zone4').textContent;\n        var age = document.getElementById('thr-age').value;\n        var rest = document.getElementById('thr-rest').value;\n\n        var text = '❤️ 5-ZONE CARDIOVASCULAR HEART RATE PROFILE\\n' +\n          '====================================================\\n' +\n          'Age: ' + age + ' Years | Resting Heart Rate: ' + rest + ' BPM\\n' +\n          '• Maximum Heart Rate (HRmax): ' + hrmax + '\\n' +\n          '• Heart Rate Reserve (HRR): ' + hrr + '\\n' +\n          '----------------------------------------------------\\n' +\n          'CARDIO TRAINING ZONES (Karvonen Method):\\n' +\n          '  - Zone 1 (Recovery 50-60%): Warmup & Capillary Flush\\n' +\n          '  - Zone 2 (Aerobic Base 60-70%): ' + z2 + ' (Max Fat Burn)\\n' +\n          '  - Zone 3 (Tempo 70-80%): Aerobic Endurance\\n' +\n          '  - Zone 4 (Lactate Threshold 80-90%): ' + z4 + '\\n' +\n          '  - Zone 5 (VO2 Max 90-100%): Maximal Interval Sprints\\n' +\n          '====================================================\\n' +\n          'Calculated via Digital Tools Shed: https://digitaltoolsshed.com/health/target-heart-rate-calculator';\n\n        navigator.clipboard.writeText(text).then(function() {\n          if (btn) {\n            var orig = btn.innerHTML;\n            btn.innerHTML = '<span>✓</span> Training Zones Copied!';\n            btn.style.borderColor = '#10b981';\n            btn.style.color = '#10b981';\n            setTimeout(function() {\n              btn.innerHTML = orig;\n              btn.style.borderColor = 'var(--border)';\n              btn.style.color = 'var(--fg)';\n            }, 2000);\n          }\n        });\n      }\n\n      if (document.readyState === 'loading') {\n        document.addEventListener('DOMContentLoaded', calcHeartRate);\n      } else {\n        calcHeartRate();\n      }\n    </script>\n  "
},
{
  "slug": "blood-alcohol-calculator",
  "title": "Blood Alcohol Concentration (BAC) Calculator & Sobriety Timeline (Widmark Formula)",
  "metaDesc": "Calculate your estimated Blood Alcohol Concentration (BAC), time to 0.00% legal sobriety, and impairment level using the scientific Widmark formula with customizable drink types and body weight.",
  "category": "Health & Fitness",
  "faq": [
    {
      "q": "What is the Widmark formula for calculating Blood Alcohol Concentration (BAC)?",
      "a": "The Widmark formula computes BAC as: BAC = [Alcohol in grams / (Body Weight in grams × r)] × 100 - (β × time in hours), where r is the gender-specific distribution volume constant (0.68 for biological males, 0.55 for biological females) and β is the metabolic alcohol elimination rate (averaging 0.015% per hour)."
    },
    {
      "q": "Can drinking coffee, taking cold showers, or exercising lower your BAC faster?",
      "a": "No. Hepatic alcohol dehydrogenase (ADH) metabolizes ethanol at a strictly fixed zero-order biological rate of approximately 0.015 g/dL per hour. Caffeine and cold showers merely stimulate the central nervous system, creating a wide-awake drunk individual with unimproved motor coordination and zero reduction in blood alcohol concentration."
    },
    {
      "q": "Why does alcohol produce a higher BAC in women than in men of the exact same weight?",
      "a": "Women have lower gastric alcohol dehydrogenase activity in the stomach lining, meaning less alcohol is broken down prior to entering the bloodstream. Additionally, women naturally have a lower percentage of total body water (52%–55% vs 61%–68% in men) and higher body fat percentage, which concentrates the water-soluble alcohol molecules in a smaller volume of blood."
    },
    {
      "q": "What is the legal BAC limit for driving in the United States and internationally?",
      "a": "In 49 US states, the statutory per se legal driving limit is 0.08% BAC (in Utah, the limit is 0.05%). In most European countries, Australia, and parts of Canada, the legal driving limit is 0.05% BAC, with zero-tolerance (0.00% or 0.02%) for commercial, novice, and younger drivers."
    },
    {
      "q": "How does food in the stomach affect alcohol absorption?",
      "a": "Consuming a high-protein or high-fat meal prior to drinking keeps the stomach's pyloric sphincter closed, delaying alcohol transit into the small intestine where 80% of absorption occurs. This flattens and delays peak BAC by up to 60 to 90 minutes. However, eating food *after* alcohol has already entered the duodenum provides zero retroactive reduction in blood alcohol."
    }
  ],
  "body": "\n    <div class=\"article-container\" style=\"max-width: 1020px;\">\n      <nav style=\"font-family: var(--mono); font-size: 0.8rem; margin-bottom: 1.5rem; color: var(--text-muted);\">\n        <a href=\"/\">Home</a> &gt; <a href=\"/health/\">Health &amp; Fitness</a> &gt; Blood Alcohol Calculator\n      </nav>\n\n      <header style=\"margin-bottom: 2rem;\">\n        <div style=\"display: flex; gap: 0.5rem; align-items: center; margin-bottom: 0.5rem; flex-wrap: wrap;\">\n          <span class=\"badge badge-purple\">Forensic Toxicology Engine</span>\n          <span class=\"badge badge-green\">Widmark Equation Compliant</span>\n          <span class=\"badge badge-blue\">Zero Server Uploads</span>\n        </div>\n        <h1 style=\"font-family: var(--serif); font-size: 2.3rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          Blood Alcohol Concentration (BAC) Calculator &amp; Sobriety Timeline\n        </h1>\n        <p style=\"color: var(--text-muted); font-size: 1.05rem; line-height: 1.6;\">\n          Estimate your current Blood Alcohol Concentration (BAC), peak intoxication, legal driving status, and exact hours until 0.00% complete sobriety using the validated Widmark pharmacokinetic model.\n        </p>\n      </header>\n\n      <!-- MAIN INPUT BOX -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); padding: 1.75rem; border-radius: 8px; margin-bottom: 2rem;\">\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.25rem; margin-bottom: 1.5rem;\">\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Biological Sex:</label>\n            <select id=\"bac-sex\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.95rem;\" onchange=\"calcBAC()\">\n              <option value=\"male\" selected>Male (Body Water r = 0.68)</option>\n              <option value=\"female\">Female (Body Water r = 0.55)</option>\n            </select>\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Body Weight (lbs):</label>\n            <input type=\"number\" id=\"bac-weight\" value=\"180\" min=\"80\" max=\"400\" step=\"5\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcBAC()\" />\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Drinking Duration (Hours):</label>\n            <input type=\"number\" id=\"bac-hours\" value=\"2.5\" min=\"0.5\" max=\"24\" step=\"0.5\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcBAC()\" />\n            <span style=\"font-size: 0.75rem; color: var(--text-muted); display: block; margin-top: 0.2rem;\">Hours since first sip</span>\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Stomach Food State:</label>\n            <select id=\"bac-stomach\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.95rem;\" onchange=\"calcBAC()\">\n              <option value=\"fasted\">Fasted / Empty Stomach (Fast Peak)</option>\n              <option value=\"light\">Light Snack / Appetizer</option>\n              <option value=\"full\" selected>Full Meal Before Drinking (Delayed Peak)</option>\n            </select>\n          </div>\n        </div>\n\n        <!-- DRINKS BUILDER ROW -->\n        <div style=\"border-top: 1px solid var(--border); padding-top: 1.25rem; margin-bottom: 1.5rem;\">\n          <h3 style=\"font-size: 1rem; margin-top: 0; margin-bottom: 0.75rem; font-family: var(--serif);\">🍺 Beverages Consumed</h3>\n          <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 1rem;\">\n            <div style=\"background: var(--bg); border: 1px solid var(--border); border-radius: 6px; padding: 0.75rem; text-align: center;\">\n              <span style=\"display: block; font-size: 0.8rem; font-weight: bold; margin-bottom: 0.2rem;\">Standard Beer</span>\n              <span style=\"display: block; font-size: 0.72rem; color: var(--text-muted); margin-bottom: 0.4rem;\">12 oz @ 5.0% ABV</span>\n              <input type=\"number\" id=\"bac-drink-beer\" value=\"3\" min=\"0\" max=\"30\" style=\"width: 70px; text-align: center; padding: 0.4rem; font-family: var(--mono); font-size: 1.1rem; border: 1px solid var(--border); border-radius: 4px; background: var(--surface);\" oninput=\"calcBAC()\" />\n            </div>\n\n            <div style=\"background: var(--bg); border: 1px solid var(--border); border-radius: 6px; padding: 0.75rem; text-align: center;\">\n              <span style=\"display: block; font-size: 0.8rem; font-weight: bold; margin-bottom: 0.2rem;\">Craft IPA / Cider</span>\n              <span style=\"display: block; font-size: 0.72rem; color: var(--text-muted); margin-bottom: 0.4rem;\">12 oz @ 7.5% ABV</span>\n              <input type=\"number\" id=\"bac-drink-craft\" value=\"0\" min=\"0\" max=\"30\" style=\"width: 70px; text-align: center; padding: 0.4rem; font-family: var(--mono); font-size: 1.1rem; border: 1px solid var(--border); border-radius: 4px; background: var(--surface);\" oninput=\"calcBAC()\" />\n            </div>\n\n            <div style=\"background: var(--bg); border: 1px solid var(--border); border-radius: 6px; padding: 0.75rem; text-align: center;\">\n              <span style=\"display: block; font-size: 0.8rem; font-weight: bold; margin-bottom: 0.2rem;\">Glass of Wine</span>\n              <span style=\"display: block; font-size: 0.72rem; color: var(--text-muted); margin-bottom: 0.4rem;\">5 oz @ 12.5% ABV</span>\n              <input type=\"number\" id=\"bac-drink-wine\" value=\"0\" min=\"0\" max=\"30\" style=\"width: 70px; text-align: center; padding: 0.4rem; font-family: var(--mono); font-size: 1.1rem; border: 1px solid var(--border); border-radius: 4px; background: var(--surface);\" oninput=\"calcBAC()\" />\n            </div>\n\n            <div style=\"background: var(--bg); border: 1px solid var(--border); border-radius: 6px; padding: 0.75rem; text-align: center;\">\n              <span style=\"display: block; font-size: 0.8rem; font-weight: bold; margin-bottom: 0.2rem;\">Liquor Shot / Cocktail</span>\n              <span style=\"display: block; font-size: 0.72rem; color: var(--text-muted); margin-bottom: 0.4rem;\">1.5 oz @ 40.0% ABV</span>\n              <input type=\"number\" id=\"bac-drink-shot\" value=\"1\" min=\"0\" max=\"30\" style=\"width: 70px; text-align: center; padding: 0.4rem; font-family: var(--mono); font-size: 1.1rem; border: 1px solid var(--border); border-radius: 4px; background: var(--surface);\" oninput=\"calcBAC()\" />\n            </div>\n          </div>\n        </div>\n\n        <!-- KPI RESULT CARDS -->\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;\">\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #f59e0b;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Estimated Current BAC</div>\n            <div id=\"bac-current-val\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #f59e0b; margin-bottom: 0.2rem;\">0.045%</div>\n            <div id=\"bac-current-sub\" style=\"font-size: 0.85rem; color: var(--text-muted);\">0.45 g/L (Permille)</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #ef4444;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Legal Driving Status</div>\n            <div id=\"bac-driving-status\" style=\"font-family: var(--mono); font-size: 1.5rem; font-weight: bold; color: #10b981; margin-bottom: 0.2rem;\">Under 0.08% Limit</div>\n            <div id=\"bac-driving-sub\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Impairment present; do not drive</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #6366f1;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Time to 0.00% Zero BAC</div>\n            <div id=\"bac-sober-hours\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #6366f1; margin-bottom: 0.2rem;\">3.0 Hours</div>\n            <div id=\"bac-sober-clock\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Fully sober at 11:30 PM</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #8b5cf6;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Pure Alcohol Consumed</div>\n            <div id=\"bac-pure-grams\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #8b5cf6; margin-bottom: 0.2rem;\">56.8 g</div>\n            <div id=\"bac-pure-drinks\" style=\"font-size: 0.85rem; color: var(--text-muted);\">4.1 Standard US Drinks</div>\n          </div>\n        </div>\n      </div>\n\n      <!-- INTERACTIVE 24-HOUR ELIMINATION CURVE SVG -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.35rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          📈 24-Hour Pharmacokinetic BAC Elimination Curve\n        </h2>\n        <p style=\"font-size: 0.85rem; color: var(--text-muted); margin-bottom: 1.25rem;\">\n          Shows ethanol gastric absorption, peak concentration, and linear zero-order hepatic oxidation (0.015% per hour) with legal DUI limits.\n        </p>\n\n        <div style=\"overflow-x: auto;\">\n          <svg id=\"bac-curve-svg\" viewBox=\"0 0 800 250\" style=\"width: 100%; height: auto; min-width: 600px; font-family: var(--mono);\"></svg>\n        </div>\n      </div>\n\n      <!-- CLINICAL STAGES OF IMPAIRMENT TABLE -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h3 style=\"font-family: var(--serif); font-size: 1.25rem; margin-top: 0; margin-bottom: 1rem; color: var(--fg);\">\n          🧠 Clinical Stages of Alcohol Impairment (Dubowski Scale)\n        </h3>\n        <div style=\"overflow-x: auto;\">\n          <table style=\"width: 100%; border-collapse: collapse; font-size: 0.9rem; text-align: left;\">\n            <thead>\n              <tr style=\"border-bottom: 2px solid var(--border); color: var(--text-muted);\">\n                <th style=\"padding: 0.6rem 0.75rem;\">BAC Range</th>\n                <th style=\"padding: 0.6rem 0.75rem;\">Clinical Stage</th>\n                <th style=\"padding: 0.6rem 0.75rem;\">Physiological &amp; Neurological Effects</th>\n                <th style=\"padding: 0.6rem 0.75rem;\">Driving Capability</th>\n              </tr>\n            </thead>\n            <tbody>\n              <tr style=\"border-bottom: 1px solid var(--border);\">\n                <td style=\"padding: 0.6rem 0.75rem; font-family: var(--mono); font-weight: bold; color: #10b981;\">0.01% – 0.03%</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-weight: 600;\">Subtle / Normal</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-size: 0.85rem;\">Mild relaxation; slight elevation in heart rate; near-normal behavior.</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-size: 0.85rem;\">Subtle decline in divided attention</td>\n              </tr>\n              <tr style=\"border-bottom: 1px solid var(--border);\">\n                <td style=\"padding: 0.6rem 0.75rem; font-family: var(--mono); font-weight: bold; color: #06b6d4;\">0.03% – 0.06%</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-weight: 600;\">Euphoria</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-size: 0.85rem;\">Sociability, lowered inhibitions, flushed skin, slight decline in fine muscle coordination.</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-size: 0.85rem; color: #f59e0b;\">Impaired vigilance &amp; tracking</td>\n              </tr>\n              <tr style=\"border-bottom: 1px solid var(--border); background: rgba(245, 158, 11, 0.06);\">\n                <td style=\"padding: 0.6rem 0.75rem; font-family: var(--mono); font-weight: bold; color: #f59e0b;\">0.06% – 0.10%</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-weight: 600;\">Excitement</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-size: 0.85rem;\">Slurred speech, emotional instability, delayed reaction times, loss of depth perception.</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-size: 0.85rem; font-weight: bold; color: #ef4444;\">ILLEGAL DUI IN USA (≥0.08%)</td>\n              </tr>\n              <tr style=\"border-bottom: 1px solid var(--border);\">\n                <td style=\"padding: 0.6rem 0.75rem; font-family: var(--mono); font-weight: bold; color: #ef4444;\">0.10% – 0.20%</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-weight: 600;\">Confusion</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-size: 0.85rem;\">Gross motor ataxia, staggering gait, diplopia (double vision), dizziness, anterograde amnesia (blackout).</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-size: 0.85rem; font-weight: bold; color: #ef4444;\">Severe Inability / Critical Danger</td>\n              </tr>\n              <tr style=\"border-bottom: 1px solid var(--border);\">\n                <td style=\"padding: 0.6rem 0.75rem; font-family: var(--mono); font-weight: bold; color: #8b5cf6;\">0.20% – 0.30%</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-weight: 600;\">Stupor</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-size: 0.85rem;\">Loss of consciousness, vomiting with aspiration risk, inability to stand or walk.</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-size: 0.85rem; color: #8b5cf6;\">Medical Emergency Risk</td>\n              </tr>\n              <tr>\n                <td style=\"padding: 0.6rem 0.75rem; font-family: var(--mono); font-weight: bold; color: #ec4899;\">&gt; 0.35%</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-weight: 600;\">Coma / Death</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-size: 0.85rem;\">Respiratory depression, hypothermia, absence of pupillary reflexes, potentially fatal.</td>\n                <td style=\"padding: 0.6rem 0.75rem; font-size: 0.85rem; color: #ec4899;\">Lethal Toxicity Threshold</td>\n              </tr>\n            </tbody>\n          </table>\n        </div>\n      </div>\n\n      <!-- STEP-BY-STEP DERIVATION -->\n      <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h3 style=\"font-family: var(--mono); font-size: 0.9rem; text-transform: uppercase; color: var(--text-muted); margin: 0 0 0.75rem 0;\">\n          📐 Step-by-Step Widmark Pharmacokinetic Derivations\n        </h3>\n        <div id=\"bac-derivation-box\" style=\"font-family: var(--mono); font-size: 0.85rem; line-height: 1.7; color: var(--fg);\">\n          Computing live pharmacokinetic metrics...\n        </div>\n      </div>\n\n      <!-- ONE-CLICK COPY BUTTON -->\n      <div style=\"margin-bottom: 2.5rem;\">\n        <button type=\"button\" id=\"bac-copy-btn\" onclick=\"copyBACReport(this)\" class=\"btn btn-copy\" style=\"display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; font-size: 0.9rem; font-weight: 600; background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; cursor: pointer; color: var(--fg); transition: all 0.15s ease;\">\n          <span>📋</span> Copy Full BAC &amp; Sobriety Report\n        </button>\n      </div>\n\n      <!-- 5 FATAL TRAPS -->\n      <div style=\"margin: 2.5rem 0;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.45rem; margin-bottom: 0.75rem; color: var(--fg);\">\n          ⚠️ 5 Fatal Traps &amp; Costly Legal Pitfalls with Alcohol\n        </h2>\n        <div style=\"display: grid; grid-template-columns: 1fr; gap: 1rem;\">\n          <div class=\"trap-card\" style=\"border-left: 4px solid #ef4444;\">\n            <strong style=\"color: #ef4444;\">1. The \"Morning After\" Commute DUI Trap</strong>\n            Going to sleep at 2:00 AM with a 0.20% BAC means waking up at 7:00 AM (5 hours later) with a 0.125% BAC—still far above the 0.08% statutory DUI threshold. Thousands of motorists are arrested for drunk driving on weekday mornings on their way to work while feeling completely \"sober.\"\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #f59e0b;\">\n            <strong style=\"color: #f59e0b;\">2. The \"Coffee, Cold Showers &amp; Sweating It Out\" Myth</strong>\n            Hepatic alcohol dehydrogenase (ADH) operates at a strictly fixed enzymatic velocity (zero-order elimination rate β ≈ 0.015% per hour). Only 2% to 5% of alcohol is excreted through sweat, urine, or breath. Coffee, energy drinks, and exercise do not speed up liver oxidation by even one minute.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #10b981;\">\n            <strong style=\"color: #10b981;\">3. Mouth Alcohol Breathalyzer False Positives</strong>\n            Breathalyzers assume breath sampled is deep lung alveolar air (2100:1 partition ratio). If you burp, suffer from acid reflux (GERD), or use breath sprays within 15 to 20 minutes before a chemical breath test, mouth alcohol residues can register an artificial 0.15% reading on someone with a true blood BAC of zero. Always demand the mandatory 20-minute observation period.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #3b82f6;\">\n            <strong style=\"color: #3b82f6;\">4. Gastric Pylorus Timing vs Retroactive Food Consumption</strong>\n            Eating greasy food *after* getting drunk does nothing to sober you up. Once alcohol exits the pyloric sphincter into the small intestine, it enters the portal vein in minutes. Food only slows down alcohol absorption if eaten *before* or *during* the first drink.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #8b5cf6;\">\n            <strong style=\"color: #8b5cf6;\">5. Craft Beer Volume &amp; ABV Multipliers</strong>\n            A 16 oz pint of 8.5% Double IPA contains approximately 32 grams of pure ethanol—equivalent to nearly 2.5 standard 12 oz American lagers. Consuming three high-gravity craft beers is physiologically identical to taking 7.5 straight shots of distilled vodka.\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <script>\n      function calcBAC() {\n        var sex = document.getElementById('bac-sex').value;\n        var weightLbs = parseFloat(document.getElementById('bac-weight').value) || 180;\n        var hours = parseFloat(document.getElementById('bac-hours').value) || 2.5;\n        var stomach = document.getElementById('bac-stomach').value;\n\n        var beerCount = parseFloat(document.getElementById('bac-drink-beer').value) || 0;\n        var craftCount = parseFloat(document.getElementById('bac-drink-craft').value) || 0;\n        var wineCount = parseFloat(document.getElementById('bac-drink-wine').value) || 0;\n        var shotCount = parseFloat(document.getElementById('bac-drink-shot').value) || 0;\n\n        // Alcohol in grams: Volume (oz) * 29.5735 ml/oz * ABV * 0.789 g/ml\n        var beerGrams = beerCount * (12 * 29.5735 * 0.050 * 0.789);\n        var craftGrams = craftCount * (12 * 29.5735 * 0.075 * 0.789);\n        var wineGrams = wineCount * (5 * 29.5735 * 0.125 * 0.789);\n        var shotGrams = shotCount * (1.5 * 29.5735 * 0.400 * 0.789);\n\n        var totalGrams = beerGrams + craftGrams + wineGrams + shotGrams;\n        var standardDrinks = totalGrams / 14.0; // 14g pure ethanol per standard US drink\n\n        // Body weight in grams\n        var weightGrams = weightLbs * 453.592;\n\n        // Gender distribution ratio r\n        var r = (sex === 'male') ? 0.68 : 0.55;\n\n        // Theoretical maximum peak BAC without metabolism\n        var theoreticalPeakBAC = (totalGrams / (weightGrams * r)) * 100;\n\n        // Food absorption delay adjustment\n        var peakHour = 0.5; // fasted\n        if (stomach === 'light') peakHour = 0.75;\n        else if (stomach === 'full') peakHour = 1.25;\n\n        // Hepatic elimination rate beta (0.015% / hr)\n        var beta = 0.015;\n\n        // Current BAC\n        var currentBAC = 0;\n        if (hours <= peakHour) {\n          currentBAC = theoreticalPeakBAC * (hours / peakHour);\n        } else {\n          var metabolicHours = hours - peakHour;\n          currentBAC = Math.max(0, theoreticalPeakBAC - (beta * metabolicHours));\n        }\n\n        // Time to 0.00%\n        var hoursToSober = currentBAC > 0 ? (currentBAC / beta) : 0;\n        var now = new Date();\n        var soberTime = new Date(now.getTime() + (hoursToSober * 3600 * 1000));\n        var soberTimeStr = soberTime.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' });\n\n        // Update KPIs\n        document.getElementById('bac-current-val').textContent = currentBAC.toFixed(3) + '%';\n        document.getElementById('bac-current-sub').textContent = (currentBAC * 10).toFixed(2) + ' g/L (Permille)';\n\n        var statusEl = document.getElementById('bac-driving-status');\n        var statusSub = document.getElementById('bac-driving-sub');\n        if (currentBAC === 0) {\n          statusEl.textContent = '0.00% Zero BAC (Sober)';\n          statusEl.style.color = '#10b981';\n          statusSub.textContent = 'Full cognitive & motor function';\n        } else if (currentBAC < 0.05) {\n          statusEl.textContent = 'Under 0.05% Limit';\n          statusEl.style.color = '#06b6d4';\n          statusSub.textContent = 'Mild impairment; driving discouraged';\n        } else if (currentBAC < 0.08) {\n          statusEl.textContent = '0.05% - 0.079% Warning';\n          statusEl.style.color = '#f59e0b';\n          statusSub.textContent = 'Illegal DUI in Utah / Europe / Australia';\n        } else {\n          statusEl.textContent = 'ILLEGAL DUI (≥0.08%)';\n          statusEl.style.color = '#ef4444';\n          statusSub.textContent = 'Gross motor & cognitive impairment';\n        }\n\n        document.getElementById('bac-sober-hours').textContent = hoursToSober.toFixed(1) + ' Hours';\n        document.getElementById('bac-sober-clock').textContent = hoursToSober > 0 ? 'Fully sober at ' + soberTimeStr : 'Currently sober';\n\n        document.getElementById('bac-pure-grams').textContent = totalGrams.toFixed(1) + ' g';\n        document.getElementById('bac-pure-drinks').textContent = standardDrinks.toFixed(1) + ' Standard US Drinks';\n\n        // Derivation Box\n        var dBox = document.getElementById('bac-derivation-box');\n        dBox.innerHTML = '<strong>1. Total Pure Ethanol Consumed (A):</strong> ' + totalGrams.toFixed(1) + ' grams across ' + standardDrinks.toFixed(1) + ' standard drinks.<br>' +\n          '<strong>2. Body Water Constant (r):</strong> ' + (sex === 'male' ? '0.68 (Male average)' : '0.55 (Female average)') + ' for ' + weightLbs + ' lbs (' + Math.round(weightGrams).toLocaleString() + ' grams).<br>' +\n          '<strong>3. Theoretical Peak BAC:</strong> (' + totalGrams.toFixed(1) + ' g / [' + Math.round(weightGrams).toLocaleString() + ' g × ' + r + ']) × 100 = <strong>' + theoreticalPeakBAC.toFixed(3) + '%</strong>.<br>' +\n          '<strong>4. Metabolic Elimination Rate (β):</strong> 0.015% per hour with ' + stomach + ' stomach (' + peakHour + ' hr peak delay).<br>' +\n          '<strong>5. Current Estimated BAC:</strong> <strong>' + currentBAC.toFixed(3) + '%</strong> (' + hoursToSober.toFixed(1) + ' hours until 0.00% zero BAC).';\n\n        // Render Curve SVG\n        renderBACCurveSvg(theoreticalPeakBAC, peakHour, beta, hours, currentBAC);\n      }\n\n      function renderBACCurveSvg(peakBAC, peakHour, beta, curHours, curBAC) {\n        var svg = document.getElementById('bac-curve-svg');\n        if (!svg) return;\n\n        var w = 800, h = 250;\n        var padL = 70, padR = 40, padT = 30, padB = 40;\n        var plotW = w - padL - padR;\n        var plotH = h - padT - padB;\n\n        var maxTime = Math.max(12, Math.ceil(peakHour + (peakBAC / beta) + 2));\n        var maxBAC = Math.max(0.16, peakBAC * 1.25);\n\n        function toX(t) { return padL + ((t / maxTime) * plotW); }\n        function toY(b) { return (padT + plotH) - ((b / maxBAC) * plotH); }\n\n        var svgHtml = '';\n\n        // Axes & Grid\n        svgHtml += '<line x1=\"' + padL + '\" y1=\"' + (padT + plotH) + '\" x2=\"' + (padL + plotW) + '\" y2=\"' + (padT + plotH) + '\" stroke=\"var(--border)\" stroke-width=\"2\" />';\n        svgHtml += '<line x1=\"' + padL + '\" y1=\"' + padT + '\" x2=\"' + padL + '\" y2=\"' + (padT + plotH) + '\" stroke=\"var(--border)\" stroke-width=\"2\" />';\n\n        // 0.08% Legal DUI Line\n        var y08 = toY(0.08);\n        if (y08 >= padT) {\n          svgHtml += '<line x1=\"' + padL + '\" y1=\"' + y08 + '\" x2=\"' + (padL + plotW) + '\" y2=\"' + y08 + '\" stroke=\"#ef4444\" stroke-width=\"2\" stroke-dasharray=\"5,4\" />';\n          svgHtml += '<text x=\"' + (padL + plotW) + '\" y=\"' + (y08 - 6) + '\" fill=\"#ef4444\" font-size=\"11\" font-weight=\"bold\" text-anchor=\"end\">0.08% Statutory DUI Limit</text>';\n        }\n\n        // Time ticks\n        for (var t = 0; t <= maxTime; t += 2) {\n          var tx = toX(t);\n          svgHtml += '<line x1=\"' + tx + '\" y1=\"' + (padT + plotH) + '\" x2=\"' + tx + '\" y2=\"' + (padT + plotH + 6) + '\" stroke=\"var(--border)\" stroke-width=\"1.5\" />';\n          svgHtml += '<text x=\"' + tx + '\" y=\"' + (padT + plotH + 20) + '\" fill=\"var(--text-muted)\" font-size=\"11\" text-anchor=\"middle\">' + t + 'h</text>';\n        }\n\n        // Curve Points\n        var pts = [];\n        pts.push(toX(0).toFixed(1) + ',' + toY(0).toFixed(1));\n        pts.push(toX(peakHour).toFixed(1) + ',' + toY(peakBAC).toFixed(1));\n\n        var zeroTime = peakHour + (peakBAC / beta);\n        if (zeroTime > peakHour) {\n          pts.push(toX(zeroTime).toFixed(1) + ',' + toY(0).toFixed(1));\n        }\n        pts.push(toX(maxTime).toFixed(1) + ',' + toY(0).toFixed(1));\n\n        var polyArea = 'M ' + toX(0) + ' ' + toY(0) + ' ' +\n          'L ' + toX(peakHour) + ' ' + toY(peakBAC) + ' ' +\n          'L ' + toX(zeroTime) + ' ' + toY(0) + ' Z';\n\n        svgHtml += '<path d=\"' + polyArea + '\" fill=\"rgba(245, 158, 11, 0.15)\" stroke=\"#f59e0b\" stroke-width=\"2.5\" />';\n\n        // Current Time marker\n        if (curHours <= maxTime) {\n          var cx = toX(curHours);\n          var cy = toY(curBAC);\n          svgHtml += '<line x1=\"' + cx + '\" y1=\"' + padT + '\" x2=\"' + cx + '\" y2=\"' + (padT + plotH) + '\" stroke=\"#3b82f6\" stroke-width=\"2\" stroke-dasharray=\"3,3\" />';\n          svgHtml += '<circle cx=\"' + cx + '\" cy=\"' + cy + '\" r=\"6\" fill=\"#3b82f6\" stroke=\"#fff\" stroke-width=\"2\" />';\n          svgHtml += '<text x=\"' + cx + '\" y=\"' + (cy - 12) + '\" fill=\"#3b82f6\" font-size=\"12\" font-weight=\"bold\" text-anchor=\"middle\">Now: ' + curBAC.toFixed(3) + '%</text>';\n        }\n\n        svg.innerHTML = svgHtml;\n      }\n\n      function copyBACReport(btn) {\n        var bac = document.getElementById('bac-current-val').textContent;\n        var status = document.getElementById('bac-driving-status').textContent;\n        var sober = document.getElementById('bac-sober-hours').textContent;\n        var clock = document.getElementById('bac-sober-clock').textContent;\n        var drinks = document.getElementById('bac-pure-drinks').textContent;\n\n        var text = '🍷 BLOOD ALCOHOL CONCENTRATION (BAC) REPORT\\n' +\n          '====================================================\\n' +\n          '• Current Estimated BAC: ' + bac + '\\n' +\n          '• Legal Driving Status: ' + status + '\\n' +\n          '• Time to 0.00% Sobriety: ' + sober + ' (' + clock + ')\\n' +\n          '• Total Ethanol Intake: ' + drinks + '\\n' +\n          '----------------------------------------------------\\n' +\n          'Toxicology Note: Hepatic elimination occurs at ~0.015%/hr.\\n' +\n          'Coffee and cold showers do NOT accelerate sobriety.\\n' +\n          'Calculated via Digital Tools Shed: https://digitaltoolsshed.com/health/blood-alcohol-calculator';\n\n        navigator.clipboard.writeText(text).then(function() {\n          if (btn) {\n            var orig = btn.innerHTML;\n            btn.innerHTML = '<span>✓</span> BAC Assessment Copied!';\n            btn.style.borderColor = '#10b981';\n            btn.style.color = '#10b981';\n            setTimeout(function() {\n              btn.innerHTML = orig;\n              btn.style.borderColor = 'var(--border)';\n              btn.style.color = 'var(--fg)';\n            }, 2000);\n          }\n        });\n      }\n\n      if (document.readyState === 'loading') {\n        document.addEventListener('DOMContentLoaded', calcBAC);\n      } else {\n        calcBAC();\n      }\n    </script>\n  "
},
    ...
    },
    {
      ...
      body: `
        ...
        <div class="article-container" style="max-width: 900px;">
          ...
          <div class="tool-box">
            ...
            <div id="adhdStepsList" style="margin-top: 1.5rem;"></div>
              ...
              <!-- Action Copy Button -->
              <button type="button" id="btnCopyAdhdSteps" onclick="copyAdhdSteps()" class="btn-sec" style="margin-top: 1.25rem; width: 100%; padding: 0.65rem 1rem; font-family: var(--mono); font-size: 0.82rem; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 0.5rem; background: var(--surface); border: 1px solid var(--border); border-radius: 6px; color: var(--fg); font-weight: 600;">
                <span>📋 Copy Micro-Task Execution Plan &amp; Checklist</span>
              </button>
            </div>
          </div>

          <!-- 5 Critical Executive Dysfunction Pitfalls & Neuro-Traps -->
          <div style="background: var(--surface); border: 1px solid var(--border); padding: 1.5rem; border-radius: 8px; margin: 2rem 0;">
            <h3 style="font-family: var(--serif); font-size: 1.35rem; margin-bottom: 1.25rem; color: var(--fg);">⚠️ 5 Fatal Traps &amp; Gotchas of ADHD Executive Dysfunction</h3>
            <div style="display: grid; gap: 1rem;">
              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #ef4444;">
                <h4 style="margin: 0 0 0.5rem 0; color: #ef4444; font-size: 1rem; font-family: var(--serif);">💥 1. Task-Initiation Paralysis &amp; Amygdala Threat Hijack</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  When an ADHD brain views a large, unstructured task (e.g., "Clean Garage" or "File Taxes"), the amygdala interprets cognitive ambiguity as physical threat, flooding the system with cortisol and triggering avoidance. Breaking tasks into micro-steps below the "threat threshold" (e.g., "Find one cardboard box") bypasses amygdala alarm networks and allows the prefrontal cortex to engage.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #f59e0b;">
                <h4 style="margin: 0 0 0.5rem 0; color: #f59e0b; font-size: 1rem; font-family: var(--serif);">🧗 2. The "All-or-Nothing" Dopamine Cliff (The Wall of Awful)</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Neurotypical brains rely on steady dopamine transmission to sustain routine tasks. ADHD brains operate in a binary "dopamine feast or famine" state. When dopamine plummets midway through a task, the individual experiences sudden acute exhaustion and abandons the project 90% complete. Mitigate this by scheduling artificial milestone rewards every 10–15 minutes.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #10b981;">
                <h4 style="margin: 0 0 0.5rem 0; color: #10b981; font-size: 1rem; font-family: var(--serif);">🧼 3. The "Productive Procrastination" &amp; Prep Stalling Loop</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Spending 2 hours downloading new project management apps, organizing highlighters, or researching productivity methodologies produces cheap anticipatory dopamine without executing the actual task. This "yak shaving" provides the illusion of progress while draining executive energy needed for actual work.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #3b82f6;">
                <h4 style="margin: 0 0 0.5rem 0; color: #3b82f6; font-size: 1rem; font-family: var(--serif);">💾 4. Working Memory RAM Overflow (Holding &gt;3 Steps Concurrently)</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  ADHD working memory capacity is biologically restricted. Trying to keep 4 or 5 sequential tasks in head causes immediate cognitive crash and disorientation. Every step must be externalized onto a persistent physical or digital checklist where completed items can be checked off without mental holding cost.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #8b5cf6;">
                <h4 style="margin: 0 0 0.5rem 0; color: #8b5cf6; font-size: 1rem; font-family: var(--serif);">🔄 5. Context-Switching Cognitive Friction &amp; Transition Fatigue</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Switching between disparate tasks imposes an enormous metabolic penalty on the ADHD prefrontal cortex. Leaving a half-finished email to answer a text message creates cognitive "attention residue," requiring 15–20 minutes to re-establish task flow. Single-tasking with full sensory isolation is mandatory.
                </p>
              </div>
            </div>
          </div>
        ...
        <script>
          ...
          window.copyAdhdSteps = function() {
            var items = document.querySelectorAll('#adhdStepsList input[type="checkbox"]');
            var title = document.getElementById('adhdTaskInput') ? document.getElementById('adhdTaskInput').value : 'ADHD Task Breakdown';
            var lines = ['📝 ADHD Execution Plan: ' + (title || 'Task Plan'), ''];
            
            items.forEach(function(item, idx) {
              var parent = item.closest('div');
              var text = parent ? parent.textContent.trim() : ('Step ' + (idx + 1));
              var status = item.checked ? '☑️ [DONE]' : '⬜ [TODO]';
              lines.push(status + ' Step ' + (idx + 1) + ': ' + text);
            });

            lines.push('');
            lines.push('Generated at digitaltoolsshed.com/health/adhd-task-breakdown');

            var fullText = lines.join('\n');
            navigator.clipboard.writeText(fullText).then(function() {
              var btn = document.getElementById('btnCopyAdhdSteps');
              if (btn) {
                var orig = btn.innerHTML;
                btn.innerHTML = '<span style="color:#10b981;">✓ Execution Plan Copied!</span>';
                btn.style.borderColor = '#10b981';
                setTimeout(function() {
                  btn.innerHTML = orig;
                  btn.style.borderColor = 'var(--border)';
      ...
      body: `
        ...
        <div class="article-container" style="max-width: 900px; text-align: center;">
          ...
          <div class="tool-box" style="text-align: center;">
            ...
            <!-- Copy Session Protocol Button -->
            <button type="button" id="btnCopyBreathing" onclick="copyBreathingLog()" class="btn-sec" style="margin-top: 1.25rem; width: 100%; max-width: 320px; padding: 0.65rem 1rem; font-family: var(--mono); font-size: 0.82rem; cursor: pointer; display: inline-flex; align-items: center; justify-content: center; gap: 0.5rem; background: var(--surface); border: 1px solid var(--border); border-radius: 6px; color: var(--fg); font-weight: 600;">
              <span>📋 Copy Vagal Pacing Session Protocol</span>
            </button>
          </div>

          <!-- 5 Critical Autonomic & Vagal Regulation Traps -->
          <div style="background: var(--surface); border: 1px solid var(--border); padding: 1.5rem; border-radius: 8px; margin: 2rem 0;">
            <h3 style="font-family: var(--serif); font-size: 1.35rem; margin-bottom: 1.25rem; color: var(--fg);">⚠️ 5 Fatal Traps in Vagus Nerve &amp; Breathwork Pacing</h3>
            <div style="display: grid; gap: 1rem;">
              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #ef4444;">
                <h4 style="margin: 0 0 0.5rem 0; color: #ef4444; font-size: 1rem; font-family: var(--serif);">💥 1. Hyperventilation Paradox &amp; Hypocapnic Cerebral Vasoconstriction</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Breathing too deeply or rapidly blows off too much carbon dioxide (hypocapnia). Through the Bohr effect, low arterial CO2 causes acute cerebral vasoconstriction—reducing oxygen delivery to brain tissue by up to 40%. This induces dizziness, tingling in fingers, and panic sensations, mistaken by practitioners as \"energy\" rather than acute cerebral hypoxia.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #f59e0b;">
                <h4 style="margin: 0 0 0.5rem 0; color: #f59e0b; font-size: 1rem; font-family: var(--serif);">🫀 2. Paradoxical Anxiety Rebound from Forced Somatic Stillness</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  For individuals experiencing acute fight-or-flight sympathetic arousal, forcing motionless breath control can paradoxically trigger panic spikes. The nervous system interprets forced immobilization while adrenaline is surging as entrapment. Gentle bilateral movement (walking or shaking) must precede static breathwork during acute trauma states.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #10b981;">
                <h4 style="margin: 0 0 0.5rem 0; color: #10b981; font-size: 1rem; font-family: var(--serif);">⚡ 3. The Closed-Glottis Valsalva Blood Pressure Spike Trap</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  During the \"Hold\" phases of box breathing (after inhale and after exhale), clamping the vocal cords tight (Valsalva maneuver) spikes intrathoracic pressure, impeding venous return to the heart and causing sudden blood pressure surges followed by reflex bradycardia. Holds must be soft, with an open airway and relaxed throat.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #3b82f6;">
                <h4 style="margin: 0 0 0.5rem 0; color: #3b82f6; font-size: 1rem; font-family: var(--serif);">🫁 4. Clavicular Chest Breathing vs. Lower Diaphragmatic Expansion</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Lifting the shoulders and puffing the upper chest engages accessory neck muscles (sternocleidomastoid, scalenes), which directly stimulates sympathetic ganglia, reinforcing the stress response. True vagal activation requires 360-degree lower lateral ribcage and abdominal expansion to mechanically stimulate the vagus nerve trunk passing through the diaphragm.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #8b5cf6;">
                <h4 style="margin: 0 0 0.5rem 0; color: #8b5cf6; font-size: 1rem; font-family: var(--serif);">⏱️ 5. Vagal Overtraining &amp; Orthostatic Hypotension Risks</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Excessive prolonged breath pacing (over 20 continuous minutes without adaptation) can overstimulate parasympathetic tone, causing sudden blood pressure drops (orthostatic hypotension), brain fog, and fainting upon standing. Practice 4 to 8 deliberate box breathing cycles (3–5 minutes) for optimal autonomic recalibration.
                </p>
              </div>
            </div>
          </div>
        ...
        <script>
          ...
          window.copyBreathingLog = function() {
            var mode = document.querySelector('.badge') ? document.querySelector('.badge').textContent : 'Box Breathing (4-4-4-4)';
            var text = '🫁 Vagus Nerve & Autonomic Pacing Protocol\n' +
              '• Breathing Modality: ' + mode + '\n' +
              '• Inhale Phase: 4 seconds (diaphragmatic expansion)\n' +
              '• Hold Inhale: 4 seconds (open glottis)\n' +
              '• Exhale Phase: 4 seconds (parasympathetic deceleration)\n' +
              '• Hold Exhale: 4 seconds (vagal brake stabilization)\n' +
              '• Biometric Impact: Enhances Heart Rate Variability (HRV) & downregulates sympathetic tone.\n\n' +
              'Practiced at digitaltoolsshed.com/health/box-breathing-pacer';

            navigator.clipboard.writeText(text).then(function() {
              var btn = document.getElementById('btnCopyBreathing');
              if (btn) {
                var orig = btn.innerHTML;
                btn.innerHTML = '<span style="color:#10b981;">✓ Protocol Copied!</span>';
                btn.style.borderColor = '#10b981';
                setTimeout(function() {
                  btn.innerHTML = orig;
                  btn.style.borderColor = 'var(--border)';
    ...
    },
    {
      ...
      body: `
        ...
        <div class="article-container" style="max-width: 900px;">
          ...
          <div class="tool-box">
            ...
            <div class="result-card" style="border-top: 4px solid #f59e0b;">
              ...
              <button type="button" id="btnCopyDeparture" onclick="copyDepartureSchedule()" class="btn-sec" style="margin-top: 1.25rem; width: 100%; padding: 0.65rem 1rem; font-family: var(--mono); font-size: 0.82rem; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 0.5rem; background: var(--surface); border: 1px solid var(--border); border-radius: 6px; color: var(--fg); font-weight: 600;">
                <span>📋 Copy Departure Countdown &amp; Transition Buffer Plan</span>
              </button>
            </div>
          </div>

          <!-- 5 Critical Time Blindness & Departure Traps -->
          <div style="background: var(--surface); border: 1px solid var(--border); padding: 1.5rem; border-radius: 8px; margin: 2rem 0;">
            <h3 style="font-family: var(--serif); font-size: 1.35rem; margin-bottom: 1.25rem; color: var(--fg);">⚠️ 5 Fatal Time Blindness &amp; Departure Traps</h3>
            <div style="display: grid; gap: 1rem;">
              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #ef4444;">
                <h4 style="margin: 0 0 0.5rem 0; color: #ef4444; font-size: 1rem; font-family: var(--serif);">💥 1. The "Now vs. Not Now" Chronological Blindness Trap</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  ADHD neurobiology perceives time as two distinct buckets: "Now" and "Not Now." An appointment at 3:00 PM feels completely abstract and non-urgent at 1:45 PM. Until the departure window collapses into the "Now" bucket at 2:50 PM, the brain produces zero anticipatory executive urgency—resulting in frantic panic and chronic lateness.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #f59e0b;">
                <h4 style="margin: 0 0 0.5rem 0; color: #f59e0b; font-size: 1rem; font-family: var(--serif);">🚀 2. The Zero-Friction Teleportation Fantasy</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  When asked "How long does it take to get to the airport?", ADHD adults instinctively answer with pure highway driving time: "25 minutes." This completely ignores micro-transitions: finding keys (5 min), putting on shoes (3 min), elevator transit (3 min), parking (7 min), and walking to the terminal (10 min). Total actual travel time is 53 minutes.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #10b981;">
                <h4 style="margin: 0 0 0.5rem 0; color: #10b981; font-size: 1rem; font-family: var(--serif);">⚡ 3. The "Just One Quick Task" Pre-Departure Dopamine Surge</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  With 12 minutes remaining before departure, the ADHD brain experiences an overwhelming impulse to "quickly empty the dishwasher" or "send just one email." Because transition avoidance triggers compensatory novelty-seeking, the individual loses awareness of clock time, invariably making them 20 minutes late.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #3b82f6;">
                <h4 style="margin: 0 0 0.5rem 0; color: #3b82f6; font-size: 1rem; font-family: var(--serif);">🚦 4. Transit Variability &amp; "Best-Case Scenario" Planning Bias</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Planning departures based on the single fastest commute time you ever achieved on a Sunday morning at 6:00 AM ensures failure. Real-world transit involves traffic lights, unexpected road construction, weather slowdowns, and transit delays. Always inject a mandatory 25% to 40% statistical buffer.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #8b5cf6;">
                <h4 style="margin: 0 0 0.5rem 0; color: #8b5cf6; font-size: 1rem; font-family: var(--serif);">🛋️ 5. "Waiting Mode" Paralysis &amp; Executive Energy Depletion</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  When an event is scheduled for 2:00 PM, an ADHD adult often spends 10:00 AM to 2:00 PM in "waiting mode"—unable to engage in meaningful work or leisure out of intense fear of missing the appointment. Externalizing timers and calendar alarms frees the prefrontal cortex from keeping watch.
                </p>
              </div>
            </div>
          </div>
        ...
        <script>
          ...
          window.copyDepartureSchedule = function() {
            var arrival = document.getElementById('targetArrival') ? document.getElementById('targetArrival').value : '';
            var travel = document.getElementById('travelMins') ? document.getElementById('travelMins').value : '';
            var prep = document.getElementById('prepMins') ? document.getElementById('prepMins').value : '';
            var buffer = document.getElementById('bufferMins') ? document.getElementById('bufferMins').value : '';
            var startTime = document.getElementById('tbStartTime') ? document.getElementById('tbStartTime').textContent : '';
            var breakdown = document.getElementById('tbBreakdown') ? document.getElementById('tbBreakdown').textContent : '';

            var text = '🚗 ADHD Departure & Transition Countdown Plan\n' +
              '• Target Arrival Time: ' + arrival + '\n' +
              '• YOU MUST START GETTING READY: ' + startTime + '\n' +
              '• Travel Time: ' + travel + ' mins | Prep Time: ' + prep + ' mins | ADHD Buffer: ' + buffer + ' mins\n' +
              '• Schedule Timeline: ' + breakdown.replace(/\s+/g, ' ').trim() + '\n\n' +
              'Calculated at digitaltoolsshed.com/health/adhd-time-blindness-calculator';

            navigator.clipboard.writeText(text).then(function() {
              var btn = document.getElementById('btnCopyDeparture');
              if (btn) {
                var orig = btn.innerHTML;
                btn.innerHTML = '<span style="color:#10b981;">✓ Departure Plan Copied!</span>';
                btn.style.borderColor = '#10b981';
                setTimeout(function() {
                  btn.innerHTML = orig;
                  btn.style.borderColor = 'var(--border)';
      ...
      body: `
        ...
        <div class="article-container" style="max-width: 900px;">
          ...
          <div class="tool-box">
            ...
            <!-- One-Click Diagnostic Copy -->
            <button type="button" id="btnCopyDopamineMenu" onclick="copyDopaminePlan()" class="btn-sec" style="margin-top: 1.5rem; width: 100%; padding: 0.65rem 1rem; font-family: var(--mono); font-size: 0.82rem; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 0.5rem; background: var(--surface); border: 1px solid var(--border); border-radius: 6px; color: var(--fg); font-weight: 600;">
              <span>📋 Copy Personalized Dopamine Menu Order &amp; Protocol</span>
            </button>
          </div>

          <!-- 5 Critical Dopamine & Neuro-Stimulation Traps -->
          <div style="background: var(--surface); border: 1px solid var(--border); padding: 1.5rem; border-radius: 8px; margin: 2rem 0;">
            <h3 style="font-family: var(--serif); font-size: 1.35rem; margin-bottom: 1.25rem; color: var(--fg);">⚠️ 5 Fatal Dopamine &amp; Neuro-Stimulation Traps</h3>
            <div style="display: grid; gap: 1rem;">
              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #ef4444;">
                <h4 style="margin: 0 0 0.5rem 0; color: #ef4444; font-size: 1rem; font-family: var(--serif);">💥 1. The "Cheap Dopamine" Receptor Downregulation Spiral</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Bingeing high-dopamine digital novelties (TikTok, Instagram Reels, mobile gaming) delivers supra-physiological dopamine spikes. In response, striatal neurons downregulate D2 receptor availability to prevent excitotoxicity. Baseline dopamine drops below zero, leaving everyday tasks feeling painfully boring and biologically intolerable.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #f59e0b;">
                <h4 style="margin: 0 0 0.5rem 0; color: #f59e0b; font-size: 1rem; font-family: var(--serif);">⏳ 2. The Dessert "Quick Check" 4-Hour Time Warp Trap</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  "I'll just watch one video while eating lunch." High-stimulation desserts lack natural stopping cues. The ADHD hyperfocus state disconnects interoceptive clock mechanisms, turning a intended 5-minute break into 4 hours of lost productive time accompanied by acute shame and guilt.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #10b981;">
                <h4 style="margin: 0 0 0.5rem 0; color: #10b981; font-size: 1rem; font-family: var(--serif);">🍲 3. Entree Initiation Friction &amp; Amygdala Task Avoidance</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Deep restorative flow activities (playing guitar, weightlifting, hiking) require an upfront cognitive activation energy payment before dopamine begins flowing. When under-stimulated, the ADHD brain instinctively rejects entrees in favor of instant zero-friction junk stimulation. Always pair entree initiation with an appetizing side dish (e.g., listening to music while gathering gym gear).
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #3b82f6;">
                <h4 style="margin: 0 0 0.5rem 0; color: #3b82f6; font-size: 1rem; font-family: var(--serif);">🥤 4. Stimulant Tolerance &amp; Pharmacological Rebound Exhaustion</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Over-relying on chemical stimulants (caffeine, energy drinks, or escalating medication doses) without replenishing nutritional neurochemical precursors (tyrosine, B-vitamins, sleep) depletes dopamine stores, triggering evening "rebound crashes" marked by emotional lability, dysphoria, and executive paralysis.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #8b5cf6;">
                <h4 style="margin: 0 0 0.5rem 0; color: #8b5cf6; font-size: 1rem; font-family: var(--serif);">🧘 5. Guilt-Ridden Resting &amp; Autonomic Nervous Exhaustion</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Resting while constantly ruminating about all the tasks you "should" be doing prevents your nervous system from shifting into parasympathetic recovery. This "fake rest" drains executive energy without restoring brain neurochemistry. True intentional resting requires conscious permission and complete detachment from productivity demands.
                </p>
              </div>
            </div>
          </div>
        ...
        <script>
          ...
          window.copyDopaminePlan = function() {
            var selected = document.getElementById('selectedStimulus') ? document.getElementById('selectedStimulus').textContent : '';
            var category = document.getElementById('stimulusCategory') ? document.getElementById('stimulusCategory').textContent : '';

            var text = '🍽️ ADHD Dopamine Menu Strategy\n' +
              '• Current Stimulus Order: ' + selected + '\n' +
              '• Menu Course: ' + category + '\n' +
              '• Dopamine Menu Framework: Based on Jessica McCabe\'s neurodivergent pacing model.\n' +
              '• Protocol: Appetizers (5-min resets), Entrees (deep flow projects), Sides (background sensory aids), Desserts (high-stimulation treats with timers).\n\n' +
              'Generated at digitaltoolsshed.com/health/adhd-dopamine-menu';

            navigator.clipboard.writeText(text).then(function() {
              var btn = document.getElementById('btnCopyDopamineMenu');
              if (btn) {
                var orig = btn.innerHTML;
                btn.innerHTML = '<span style="color:#10b981;">✓ Dopamine Order Copied!</span>';
                btn.style.borderColor = '#10b981';
                setTimeout(function() {
                  btn.innerHTML = orig;
                  btn.style.borderColor = 'var(--border)';
...
},
    {
      ...
      body: `
        ...
        <div class="article-container" style="max-width: 900px;">
          ...
          <div class="tool-box">
            ...
            <div id="cipsResultBox" style="display: none; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); padding: 1.5rem; margin-top: 1.5rem;">
              ...
              <!-- Copy Clance Imposter Report -->
              <button type="button" id="btnCopyCipsReport" onclick="copyCipsReport()" class="btn-sec" style="margin-top: 1.25rem; width: 100%; padding: 0.65rem 1rem; font-family: var(--mono); font-size: 0.82rem; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 0.5rem; background: var(--surface); border: 1px solid var(--border); border-radius: 6px; color: var(--fg); font-weight: 600;">
                <span>📋 Copy Clance Imposter Profile &amp; Clinical Analysis</span>
              </button>
            </div>
          </div>

          <!-- 5 Critical Imposter Phenomenon Traps -->
          <div style="background: var(--surface); border: 1px solid var(--border); padding: 1.5rem; border-radius: 8px; margin: 2rem 0;">
            <h3 style="font-family: var(--serif); font-size: 1.35rem; margin-bottom: 1.25rem; color: var(--fg);">⚠️ 5 Fatal Traps in Overcoming Imposter Phenomenon</h3>
            <div style="display: grid; gap: 1rem;">
              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #ef4444;">
                <h4 style="margin: 0 0 0.5rem 0; color: #ef4444; font-size: 1rem; font-family: var(--serif);">💥 1. The Over-Preparation Anxiety Loop (Dr. Pauline Clance Model)</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  When faced with an evaluation or high-stakes task, individuals with imposter syndrome experience intense anxiety and respond by frantically over-preparing or procrastinating. When success inevitably follows, they attribute it entirely to frantic overwork rather than baseline competence, cementing the belief that normal effort would lead to humiliating exposure.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #f59e0b;">
                <h4 style="margin: 0 0 0.5rem 0; color: #f59e0b; font-size: 1rem; font-family: var(--serif);">⚖️ 2. The Asymmetric Attribution Bias (Luck for Wins, Incompetence for Losses)</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Promotions, grants, publications, or client praise are dismissed as "luck," "fluke timing," or "they were just being nice." Conversely, any minor error, syntax bug, or constructive critique is seized upon as undeniable, conclusive proof of innate intellectual fraudulence.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #10b981;">
                <h4 style="margin: 0 0 0.5rem 0; color: #10b981; font-size: 1rem; font-family: var(--serif);">🎭 3. The "Charming Imposter" Deception Fallacy</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Many high-achieving professionals secretly believe their interpersonal warmth, humor, or conversational charisma has somehow "tricked" bosses and colleagues into overrating their technical ability. They live in dread of a technical challenge that will finally unmask their presumed lack of substance.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #3b82f6;">
                <h4 style="margin: 0 0 0.5rem 0; color: #3b82f6; font-size: 1rem; font-family: var(--serif);">🔍 4. The "Natural Genius" &amp; Instant Knowledge Fallacy</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Dr. Valerie Young identified the "Natural Genius" archetype: the internal rule that if you don't grasp a complex system on the first pass, or if you have to consult documentation, you aren't truly smart. Real mastery is the cumulative result of iterative confusion, reference lookups, and deliberate practice.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #8b5cf6;">
                <h4 style="margin: 0 0 0.5rem 0; color: #8b5cf6; font-size: 1rem; font-family: var(--serif);">🛡️ 5. Relational Isolation &amp; The Feedback Avoidance Paradox</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Fearing exposure, sufferers avoid asking questions, decline high-visibility leadership opportunities, or isolate themselves from peer review. This isolation denies them the normalizing reality that nearly all senior engineers, clinicians, and researchers experience identical doubts and knowledge limits.
                </p>
              </div>
            </div>
          </div>
        ...
        <script>
          ...
          window.copyCipsReport = function() {
            var score = document.getElementById('cipsScore') ? document.getElementById('cipsScore').textContent : '--';
            var verdict = document.getElementById('cipsVerdict') ? document.getElementById('cipsVerdict').textContent : '';
            var analysis = document.getElementById('cipsAnalysis') ? document.getElementById('cipsAnalysis').textContent : '';

            var text = '🎓 Clance Imposter Phenomenon Scale (CIPS) Clinical Assessment\n' +
              '• Total CIPS Score: ' + score + '/100\n' +
              '• Clinical Severity: ' + verdict.replace(/\s+/g, ' ').trim() + '\n' +
              '• Clinical Analysis: ' + analysis.replace(/\s+/g, ' ').trim() + '\n' +
              '• Diagnostic Reference: Clance, P. R. (1985). The Imposter Phenomenon: Overcoming the Fear That Haunts Your Success.\n\n' +
              'Evaluated at digitaltoolsshed.com/health/imposter-syndrome-test';

            navigator.clipboard.writeText(text).then(function() {
              var btn = document.getElementById('btnCopyCipsReport');
              if (btn) {
                var orig = btn.innerHTML;
                btn.innerHTML = '<span style="color:#10b981;">✓ Imposter Assessment Copied!</span>';
                btn.style.borderColor = '#10b981';
                setTimeout(function() {
                  btn.innerHTML = orig;
                  btn.style.borderColor = 'var(--border)';
...
},
    {
      ...
      body: `
        ...
        <div class="article-container" style="max-width: 900px;">
          ...
          <div class="tool-box">
            ...
            <div id="attResultBox" style="display: none; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); padding: 1.5rem; margin-top: 1.5rem;">
              ...
              <!-- Copy Adult Attachment Report -->
              <button type="button" id="btnCopyAttachmentProfile" onclick="copyAttachmentProfile()" class="btn-sec" style="margin-top: 1.25rem; width: 100%; padding: 0.65rem 1rem; font-family: var(--mono); font-size: 0.82rem; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 0.5rem; background: var(--surface); border: 1px solid var(--border); border-radius: 6px; color: var(--fg); font-weight: 600;">
                <span>📋 Copy Adult Attachment Profile &amp; Relational Analysis</span>
              </button>
            </div>
          </div>

          <!-- 5 Critical Adult Attachment Traps -->
          <div style="background: var(--surface); border: 1px solid var(--border); padding: 1.5rem; border-radius: 8px; margin: 2rem 0;">
            <h3 style="font-family: var(--serif); font-size: 1.35rem; margin-bottom: 1.25rem; color: var(--fg);">⚠️ 5 Fatal Traps in Adult Attachment &amp; Relationship Dynamics</h3>
            <div style="display: grid; gap: 1rem;">
              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #ef4444;">
                <h4 style="margin: 0 0 0.5rem 0; color: #ef4444; font-size: 1rem; font-family: var(--serif);">💥 1. The Anxious-Avoidant Trap (The Protest-Withdrawal Polarization Cycle)</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  When relational tension arises, an anxiously attached partner demands immediate reassurance or confrontation (protest behavior). This activates an avoidant partner's claustrophobia, causing them to physically or emotionally withdraw. The withdrawal magnifies the anxious partner's abandonment panic, escalating into explosive relational volatility.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #f59e0b;">
                <h4 style="margin: 0 0 0.5rem 0; color: #f59e0b; font-size: 1rem; font-family: var(--serif);">⚡ 2. Mistaking Anxious Activation for "Soulmate Passion" / Chemistry</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Individuals with insecure attachment frequently mistake visceral anxiety, emotional rollercoasters, and fear of rejection for profound romantic "spark" or "chemistry." Conversely, when they encounter a stable, emotionally available secure partner, they often misinterpret the absence of autonomic chaos as "lack of passion" or "boredom."
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #10b981;">
                <h4 style="margin: 0 0 0.5rem 0; color: #10b981; font-size: 1rem; font-family: var(--serif);">🛡️ 3. The "Phantom Ex" &amp; The Flaw-Hunting Defense Strategy</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Dismissive-avoidant individuals subconsciously maintain emotional distance by fixating on an unattainable idealized past partner (the "phantom ex") or by compulsively obsessing over minor, insignificant flaws in current partners (chewing sounds, clothing choices). This preemptive defect-seeking protects against deep intimacy.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #3b82f6;">
                <h4 style="margin: 0 0 0.5rem 0; color: #3b82f6; font-size: 1rem; font-family: var(--serif);">🔄 4. The Fixed Personality Fallacy (Ignoring "Earned Security")</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Attachment styles are not rigid genetic traits; they are behavioral adaptations to childhood or relational conditioning. Longitudinal developmental psychology proves that individuals can achieve "Earned Security" through long-term therapy, conscious emotional regulation, and consistent partnership with secure individuals.
                </p>
              </div>

              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #8b5cf6;">
                <h4 style="margin: 0 0 0.5rem 0; color: #8b5cf6; font-size: 1rem; font-family: var(--serif);">🗣️ 5. Pathologizing Interdependence as "Codependency"</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Popular culture often weaponizes the term "codependency" to stigmatize healthy relational needs. Human beings are biologically wired for social dependency (the "dependency paradox": being securely dependent on a responsive partner actually enhances autonomous exploration in the outside world).
                </p>
              </div>
            </div>
          </div>
        ...
        <script>
          ...
          window.copyAttachmentProfile = function() {
            var title = document.getElementById('attTitle') ? document.getElementById('attTitle').textContent : '--';
            var profile = document.getElementById('attProfile') ? document.getElementById('attProfile').textContent : '';

            var text = '❤️ Adult Attachment Style (ECR-R Dimension Assessment)\n' +
              '• Primary Adult Attachment Pattern: ' + title + '\n' +
              '• Clinical Relational Profile: ' + profile.replace(/\s+/g, ' ').trim() + '\n' +
              '• Theoretical Framework: Hazan & Shaver (1987) & Brennan, Clark, Shaver (ECR-R Scale).\n\n' +
              'Evaluated at digitaltoolsshed.com/health/attachment-style-test';

            navigator.clipboard.writeText(text).then(function() {
              var btn = document.getElementById('btnCopyAttachmentProfile');
              if (btn) {
                var orig = btn.innerHTML;
                btn.innerHTML = '<span style="color:#10b981;">✓ Attachment Profile Copied!</span>';
                btn.style.borderColor = '#10b981';
                setTimeout(function() {
                  btn.innerHTML = orig;
                  btn.style.borderColor = 'var(--border)';
