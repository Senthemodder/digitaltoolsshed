  ...
  const tools = [
{
  ...
  "metaDesc": "Calculate the speed of sound in air, water, seawater, and metals using thermodynamic ideal gas laws (c = √(γRT)). Features Mach number solver, flight regime classifier, and vector Mach cone shockwave diagram.",
  "category": "Physics & Acoustics",
  "faq": [
    {
      "q": "Does air pressure affect the speed of sound?",
      "a": "No. In an ideal gas, the speed of sound depends strictly on temperature (c = √(γRT)), NOT barometric air pressure. While increasing air pressure increases gas elasticity (which would speed sound up), it increases gas density by the exact same proportion, completely cancelling out any effect on sound speed."
    },
    {
      "q": "What is the speed of sound at standard sea level temperature?",
      "a": "At standard sea level temperature of 20°C (68°F) in dry air, the speed of sound is exactly 343.2 meters per second (1,126 feet per second, 767.3 miles per hour, or 1,235.5 km/h)."
    },
    {
      "q": "What is a Mach number and what are the flight speed regimes?",
      "a": "Mach number (M = v / c) is the dimensionless ratio of an aircraft’s true airspeed to the local speed of sound in the surrounding air. Flight regimes are categorized as: Subsonic (M < 0.8), Transonic (0.8 ≤ M < 1.2, where local airflow exceeds Mach 1), Supersonic (1.2 ≤ M < 5.0, producing conical shockwaves), and Hypersonic (M ≥ 5.0, where aerodynamic dissociation and ionization occur)."
    },
    {
      "q": "Why does sound travel faster in water and steel than in air?",
      "a": "The speed of sound in any medium is governed by the Newton-Laplace equation: c = √(K / ρ), where K is bulk elastic modulus (stiffness) and ρ is mass density. Even though steel and water are much denser than air, their molecular chemical bonds make them thousands of times stiffer and less compressible (bulk modulus of steel is ~160 GPa vs air’s ~142 kPa), allowing sound to travel at ~1,482 m/s in water and ~5,960 m/s in steel."
    },
    {
      "q": "How do you calculate distance to a lightning strike from thunder?",
      "a": "Because light travels almost instantaneously (300,000 km/s), the sound of thunder arrives delayed by the speed of sound (~343 m/s). In statute miles: count the seconds between the lightning flash and the thunder clap and divide by 5 (5 seconds ≈ 1 mile). In metric: count seconds and divide by 3 (3 seconds ≈ 1 kilometer)."
    }
  ],
  "body": "\n    <div class=\"article-container\" style=\"max-width: 1040px;\">\n      <nav style=\"font-family: var(--mono); font-size: 0.8rem; margin-bottom: 1.5rem; color: var(--text-muted);\">\n        <a href=\"/\">Home</a> &gt; <a href=\"/math/\">Physics &amp; Acoustics</a> &gt; Speed of Sound Calculator\n      </nav>\n\n      <header style=\"margin-bottom: 2rem;\">\n        <div style=\"display: flex; gap: 0.5rem; align-items: center; margin-bottom: 0.5rem; flex-wrap: wrap;\">\n          <span class=\"badge badge-purple\">Thermodynamics &amp; Aerodynamics</span>\n          <span class=\"badge badge-green\">Newton-Laplace Equation</span>\n          <span class=\"badge badge-blue\">Mach Shockwave Cone</span>\n        </div>\n        <h1 style=\"font-family: var(--serif); font-size: 2.3rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          Speed of Sound &amp; Mach Number Calculator\n        </h1>\n        <p style=\"color: var(--text-muted); font-size: 1.05rem; line-height: 1.6;\">\n          Compute sound velocity across gases, liquids, and solid metals using thermodynamic ideal gas formulas ($c = \\sqrt{\\gamma R T}$). Includes Mach number flight regime analysis, lightning distance solver, and vector Mach shockwave diagram.\n        </p>\n      </header>\n\n      <!-- MAIN INPUT BOX -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); padding: 1.75rem; border-radius: 8px; margin-bottom: 2rem;\">\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem; margin-bottom: 1.5rem;\">\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Propagation Medium:</label>\n            <select id=\"snd-medium\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.95rem;\" onchange=\"onSndMediumChange()\">\n              <option value=\"air\" selected>Air (Ideal Gas Temperature Model)</option>\n              <option value=\"water\">Freshwater (20°C — 1,482 m/s)</option>\n              <option value=\"seawater\">Seawater (Ocean 3.5% Salinity — 1,522 m/s)</option>\n              <option value=\"steel\">Structural Carbon Steel (5,960 m/s)</option>\n              <option value=\"aluminum\">Aluminum (6,420 m/s)</option>\n              <option value=\"copper\">Copper (4,600 m/s)</option>\n              <option value=\"glass\">Crown Glass (4,540 m/s)</option>\n              <option value=\"helium\">Helium Gas (0°C — 965 m/s)</option>\n            </select>\n          </div>\n\n          <div id=\"grp-snd-temp\">\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Air Temperature:</label>\n            <div style=\"display: flex; gap: 0.5rem;\">\n              <input type=\"number\" id=\"snd-temp\" value=\"20\" step=\"1\" style=\"width: 60%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcSound()\" />\n              <select id=\"snd-temp-unit\" style=\"width: 40%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.85rem;\" onchange=\"calcSound()\">\n                <option value=\"C\" selected>°C (Celsius)</option>\n                <option value=\"F\">°F (Fahrenheit)</option>\n                <option value=\"K\">K (Kelvin)</option>\n              </select>\n            </div>\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Aircraft / Object Speed:</label>\n            <div style=\"display: flex; gap: 0.5rem;\">\n              <input type=\"number\" id=\"snd-speed\" value=\"550\" min=\"0\" step=\"10\" style=\"width: 60%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcSound()\" />\n              <select id=\"snd-speed-unit\" style=\"width: 40%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.85rem;\" onchange=\"calcSound()\">\n                <option value=\"mph\" selected>mph</option>\n                <option value=\"knots\">Knots</option>\n                <option value=\"kmh\">km/h</option>\n                <option value=\"ms\">m/s</option>\n              </select>\n            </div>\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Flash-to-Thunder Delay (sec):</label>\n            <input type=\"number\" id=\"snd-thunder\" value=\"5\" min=\"0.1\" step=\"0.5\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcSound()\" />\n          </div>\n        </div>\n\n        <!-- MAIN KPI RESULT CARDS -->\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;\">\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #3b82f6;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Speed of Sound (c)</div>\n            <div id=\"snd-res-speed\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #3b82f6; margin-bottom: 0.2rem;\">343.2 m/s</div>\n            <div id=\"snd-res-speed-alt\" style=\"font-size: 0.85rem; color: var(--text-muted);\">767.8 mph | 1,126 ft/s</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #10b981;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Mach Number (M)</div>\n            <div id=\"snd-res-mach\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #10b981; margin-bottom: 0.2rem;\">Mach 0.72</div>\n            <div id=\"snd-res-regime\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Subsonic Commercial Flight</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #f59e0b;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Mach Shockwave Angle (μ)</div>\n            <div id=\"snd-res-mach-angle\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #f59e0b; margin-bottom: 0.2rem;\">No Shock</div>\n            <div id=\"snd-res-mach-sub\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Shockwaves form at M &gt; 1.0</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #6366f1;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Lightning Strike Distance</div>\n            <div id=\"snd-res-light-dist\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #6366f1; margin-bottom: 0.2rem;\">1.07 Miles</div>\n            <div id=\"snd-res-light-km\" style=\"font-size: 0.85rem; color: var(--text-muted);\">1.72 km (5.0s acoustic delay)</div>\n          </div>\n        </div>\n      </div>\n\n      <!-- INTERACTIVE MACH CONE SVG -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.35rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          ✈️ Interactive Mach Shockwave Cone &amp; Doppler Wavefronts\n        </h2>\n        <p style=\"font-size: 0.85rem; color: var(--text-muted); margin-bottom: 1.25rem;\">\n          Shows acoustic compression wavefronts. At subsonic speeds ($M < 1$), circular waves propagate ahead. At supersonic speeds ($M > 1$), wave energy coalesces into a conical sonic boom envelope (Mach cone).\n        </p>\n\n        <div style=\"overflow-x: auto;\">\n          <svg id=\"snd-mach-svg\" viewBox=\"0 0 800 240\" style=\"width: 100%; height: auto; min-width: 600px; font-family: var(--mono);\"></svg>\n        </div>\n      </div>\n\n      <!-- STEP-BY-STEP MATHEMATICAL DERIVATION -->\n      <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h3 style=\"font-family: var(--mono); font-size: 0.9rem; text-transform: uppercase; color: var(--text-muted); margin: 0 0 0.75rem 0;\">\n          📐 Step-by-Step Thermodynamic &amp; Mach Derivations\n        </h3>\n        <div id=\"snd-derivation-box\" style=\"font-family: var(--mono); font-size: 0.85rem; line-height: 1.7; color: var(--fg);\">\n          Computing acoustic kinematics...\n        </div>\n      </div>\n\n      <!-- ONE-CLICK COPY BUTTON -->\n      <div style=\"margin-bottom: 2.5rem;\">\n        <button type=\"button\" id=\"snd-copy-btn\" onclick=\"copySoundReport(this)\" class=\"btn btn-copy\" style=\"display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; font-size: 0.9rem; font-weight: 600; background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; cursor: pointer; color: var(--fg); transition: all 0.15s ease;\">\n          <span>📋</span> Copy Acoustic &amp; Mach Flight Analysis\n        </button>\n      </div>\n\n      <!-- 5 FATAL TRAPS -->\n      <div style=\"margin: 2.5rem 0;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.45rem; margin-bottom: 0.75rem; color: var(--fg);\">\n          ⚠️ 5 Fatal Traps &amp; Physics Misunderstandings in Acoustics &amp; Mach Speed\n        </h2>\n        <div style=\"display: grid; grid-template-columns: 1fr; gap: 1rem;\">\n          <div class=\"trap-card\" style=\"border-left: 4px solid #ef4444;\">\n            <strong style=\"color: #ef4444;\">1. The \"Air Pressure Changes Speed of Sound\" Myth</strong>\n            High school students and amateur pilots frequently believe that sound travels slower at high altitude because atmospheric air pressure drops. In an ideal gas, pressure and density drop by identical proportions, completely cancelling out. Sound speed depends strictly on absolute temperature: $c = \\sqrt{\\gamma R T}$. Sound is slower at 35,000 ft exclusively because high-altitude air is cold (-55°C), not because it is low pressure.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #f59e0b;\">\n            <strong style=\"color: #f59e0b;\">2. Conflating Imperial and Metric Lightning Rules</strong>\n            The popular \"flash-to-bang\" counting rule in the United States is: 5 seconds equals 1 statute mile. In metric countries, the rule is: 3 seconds equals 1 kilometer. Conflating these two rules (e.g. dividing by 5 and assuming kilometers) results in an immediate 60% error in storm proximity calculation, leading people to stay exposed to lightning strikes.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #10b981;\">\n            <strong style=\"color: #10b981;\">3. The Humidity Molecular Weight Paradox</strong>\n            Many intuitively assume that humid air is \"heavy\" and slows down sound. In reality, water vapor ($H_2O$, molar mass 18 g/mol) is significantly lighter than atmospheric diatomic nitrogen ($N_2$, 28 g/mol) and oxygen ($O_2$, 32 g/mol). Humid air is less dense than dry air at identical temperature and pressure, causing sound to travel slightly faster in humid air.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #3b82f6;\">\n            <strong style=\"color: #3b82f6;\">4. Overlooking Transonic Shockwave Wave Drag ($M = 0.8$ to $1.2$)</strong>\n            Aircraft do not need to fly at Mach 1.0 to experience supersonic shockwaves. Because air accelerates over the curved upper surface of an airplane wing, local airflow reaches supersonic speeds when the aircraft is flying at only Mach 0.82 (the Critical Mach Number, $M_{\\text{crit}}$). This creates localized shockwaves, airflow separation, and massive wave drag increases.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #8b5cf6;\">\n            <strong style=\"color: #8b5cf6;\">5. The \"Sonic Boom is a One-Time Pop\" Fallacy</strong>\n            Spectators on the ground often believe an aircraft creates a sonic boom only at the exact instant it crosses the Mach 1 barrier. In reality, a supersonic aircraft continuously drags an invisible conical Mach shockwave carpet across the earth below it for its entire supersonic flight path. Everyone along that corridor hears the double boom as the cone sweeps past them.\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <script>\n      var MEDIUM_SPEEDS = {\n        'water': 1482,\n        'seawater': 1522,\n        'steel': 5960,\n        'aluminum': 6420,\n        'copper': 4600,\n        'glass': 4540,\n        'helium': 965\n      };\n\n      function onSndMediumChange() {\n        var med = document.getElementById('snd-medium').value;\n        var grpTemp = document.getElementById('grp-snd-temp');\n        if (med === 'air') {\n          grpTemp.style.display = 'block';\n        } else {\n          grpTemp.style.display = 'none';\n        }\n        calcSound();\n      }\n\n      function calcSound() {\n        var med = document.getElementById('snd-medium').value;\n        var c_ms = 343.2; // m/s\n\n        if (med === 'air') {\n          var tVal = parseFloat(document.getElementById('snd-temp').value) || 20;\n          var tUnit = document.getElementById('snd-temp-unit').value;\n          var tKelvin = 293.15;\n          if (tUnit === 'C') tKelvin = tVal + 273.15;\n          else if (tUnit === 'F') tKelvin = (tVal - 32) * (5/9) + 273.15;\n          else if (tUnit === 'K') tKelvin = tVal;\n\n          if (tKelvin < 1) tKelvin = 1;\n\n          // c = sqrt(gamma * R * T)\n          // gamma = 1.400, R = 287.058 J/(kg*K)\n          c_ms = Math.sqrt(1.400 * 287.058 * tKelvin);\n        } else {\n          c_ms = MEDIUM_SPEEDS[med] || 1482;\n        }\n\n        // Aircraft speed\n        var vRaw = parseFloat(document.getElementById('snd-speed').value) || 0;\n        var vUnit = document.getElementById('snd-speed-unit').value;\n        var v_ms = vRaw;\n        if (vUnit === 'mph') v_ms = vRaw * 0.44704;\n        else if (vUnit === 'knots') v_ms = vRaw * 0.514444;\n        else if (vUnit === 'kmh') v_ms = vRaw / 3.6;\n\n        // Mach Number\n        var mach = c_ms > 0 ? (v_ms / c_ms) : 0;\n\n        // Regime\n        var regime = 'Subsonic Flight (M < 0.8)';\n        var regimeColor = '#10b981';\n        if (mach >= 5.0) {\n          regime = 'Hypersonic Flight (M ≥ 5.0 — Thermal Plasma)';\n          regimeColor = '#ef4444';\n        } else if (mach >= 1.2) {\n          regime = 'Supersonic Flight (1.2 ≤ M < 5.0)';\n          regimeColor = '#f59e0b';\n        } else if (mach >= 0.8) {\n          regime = 'Transonic Flight (0.8 ≤ M < 1.2)';\n          regimeColor = '#6366f1';\n        }\n\n        // Mach Angle: mu = arcsin(1 / M) for M >= 1\n        var machAngleDeg = 0;\n        var hasShock = mach >= 1.0;\n        if (hasShock) {\n          var angleRad = Math.asin(1 / mach);\n          machAngleDeg = angleRad * (180 / Math.PI);\n        }\n\n        // Lightning distance\n        var delaySec = parseFloat(document.getElementById('snd-thunder').value) || 5;\n        var distM = c_ms * delaySec;\n        var distMiles = distM / 1609.344;\n        var distKm = distM / 1000;\n\n        // Conversions\n        var c_mph = c_ms * 2.23694;\n        var c_fps = c_ms * 3.28084;\n        var c_kmh = c_ms * 3.6;\n\n        // Update KPIs\n        document.getElementById('snd-res-speed').textContent = c_ms.toFixed(1) + ' m/s';\n        document.getElementById('snd-res-speed-alt').textContent = c_mph.toFixed(1) + ' mph | ' + c_fps.toFixed(0) + ' ft/s (' + c_kmh.toFixed(1) + ' km/h)';\n\n        var machEl = document.getElementById('snd-res-mach');\n        machEl.textContent = 'Mach ' + mach.toFixed(2);\n        machEl.style.color = regimeColor;\n        document.getElementById('snd-res-regime').textContent = regime;\n\n        if (hasShock) {\n          document.getElementById('snd-res-mach-angle').textContent = 'μ = ' + machAngleDeg.toFixed(1) + '°';\n          document.getElementById('snd-res-mach-sub').textContent = 'Shockwave Cone Half-Angle';\n        } else {\n          document.getElementById('snd-res-mach-angle').textContent = 'No Shock';\n          document.getElementById('snd-res-mach-sub').textContent = 'Forms at Supersonic M ≥ 1.0';\n        }\n\n        document.getElementById('snd-res-light-dist').textContent = distMiles.toFixed(2) + ' Miles';\n        document.getElementById('snd-res-light-km').textContent = distKm.toFixed(2) + ' km (' + delaySec.toFixed(1) + 's acoustic delay)';\n\n        // Derivation Box\n        var dBox = document.getElementById('snd-derivation-box');\n        dBox.innerHTML = (med === 'air' ? '<strong>1. Ideal Gas Thermodynamic Equation:</strong> c = √(γ × R × T) = √(1.40 × 287.06 × ' + (parseFloat(document.getElementById('snd-temp').value) + 273.15).toFixed(1) + 'K) = <strong>' + c_ms.toFixed(2) + ' m/s</strong>.<br>' : '<strong>1. Newton-Laplace Solid/Liquid Speed:</strong> Constant acoustic velocity for ' + med + ' = <strong>' + c_ms.toFixed(1) + ' m/s</strong>.<br>') +\n          '<strong>2. True Airspeed:</strong> ' + vRaw + ' ' + vUnit + ' = <strong>' + v_ms.toFixed(1) + ' m/s</strong> (' + (v_ms * 2.23694).toFixed(1) + ' mph).<br>' +\n          '<strong>3. Dimensionless Mach Number:</strong> M = v / c = ' + v_ms.toFixed(1) + ' m/s ÷ ' + c_ms.toFixed(1) + ' m/s = <strong>Mach ' + mach.toFixed(2) + ' [' + regime + ']</strong>.<br>' +\n          (hasShock ? '<strong>4. Mach Cone Geometry:</strong> μ = arcsin(1 / ' + mach.toFixed(2) + ') = <strong>' + machAngleDeg.toFixed(1) + '° half-angle</strong>.<br>' : '<strong>4. Shockwave Status:</strong> Speed is subsonic (M < 1.0); acoustic wavefronts radiate outward without conical shock coalescence.<br>') +\n          '<strong>5. Acoustic Ranging (Flash-to-Bang):</strong> ' + c_ms.toFixed(1) + ' m/s × ' + delaySec + ' s = <strong>' + Math.round(distM).toLocaleString() + ' meters (' + distMiles.toFixed(2) + ' miles)</strong>.';\n\n        // Render Mach SVG\n        renderMachSvg(mach, machAngleDeg);\n      }\n\n      function renderMachSvg(mach, angleDeg) {\n        var svg = document.getElementById('snd-mach-svg');\n        if (!svg) return;\n\n        var w = 800, h = 240;\n        var midY = 120;\n        var objX = 550;\n\n        var svgHtml = '';\n\n        if (mach < 1.0) {\n          // Subsonic: Doppler circles compressed forward\n          var numCircles = 5;\n          for (var i = 1; i <= numCircles; i++) {\n            var r = i * 25;\n            var cx = objX - (i * 15 * mach);\n            svgHtml += '<circle cx=\"' + cx + '\" cy=\"' + midY + '\" r=\"' + r + '\" fill=\"none\" stroke=\"#3b82f6\" stroke-width=\"1.5\" opacity=\"' + (1 - i*0.15) + '\" />';\n          }\n          // Aircraft glyph\n          svgHtml += '<polygon points=\"' + (objX + 15) + ',' + midY + ' ' + (objX - 10) + ',' + (midY - 8) + ' ' + (objX - 5) + ',' + midY + ' ' + (objX - 10) + ',' + (midY + 8) + '\" fill=\"#10b981\" />';\n          svgHtml += '<text x=\"' + objX + '\" y=\"' + (midY - 20) + '\" fill=\"#10b981\" font-size=\"12\" font-weight=\"bold\" text-anchor=\"middle\">Subsonic (Mach ' + mach.toFixed(2) + ')</text>';\n        } else {\n          // Supersonic: Mach cone\n          var coneLen = 420;\n          var angleRad = (angleDeg * Math.PI) / 180;\n          var halfW = Math.tan(angleRad) * coneLen;\n\n          var conePath = 'M ' + objX + ' ' + midY + ' L ' + (objX - coneLen) + ' ' + (midY - halfW) + ' L ' + (objX - coneLen) + ' ' + (midY + halfW) + ' Z';\n          svgHtml += '<path d=\"' + conePath + '\" fill=\"rgba(245, 158, 11, 0.2)\" stroke=\"#f59e0b\" stroke-width=\"2.5\" />';\n\n          // Nested wavefront circles touching the cone edges\n          for (var k = 1; k <= 4; k++) {\n            var waveX = objX - (k * 80);\n            var waveR = k * 80 * (1 / mach);\n            svgHtml += '<circle cx=\"' + waveX + '\" cy=\"' + midY + '\" r=\"' + waveR + '\" fill=\"none\" stroke=\"#6366f1\" stroke-width=\"1\" stroke-dasharray=\"3,3\" />';\n          }\n\n          // Aircraft glyph\n          svgHtml += '<polygon points=\"' + (objX + 18) + ',' + midY + ' ' + (objX - 12) + ',' + (midY - 9) + ' ' + (objX - 6) + ',' + midY + ' ' + (objX - 12) + ',' + (midY + 9) + '\" fill=\"#ef4444\" />';\n          svgHtml += '<text x=\"' + objX + '\" y=\"' + (midY - 20) + '\" fill=\"#ef4444\" font-size=\"12\" font-weight=\"bold\" text-anchor=\"middle\">Supersonic (Mach ' + mach.toFixed(2) + ')</text>';\n          svgHtml += '<text x=\"' + (objX - 180) + '\" y=\"' + (midY + halfW/2 + 10) + '\" fill=\"#f59e0b\" font-size=\"11\" font-weight=\"bold\">Mach Cone Angle: ' + angleDeg.toFixed(1) + '°</text>';\n        }\n\n        svg.innerHTML = svgHtml;\n      }\n\n      function copySoundReport(btn) {\n        var c = document.getElementById('snd-res-speed').textContent;\n        var cAlt = document.getElementById('snd-res-speed-alt').textContent;\n        var mach = document.getElementById('snd-res-mach').textContent;\n        var reg = document.getElementById('snd-res-regime').textContent;\n        var dist = document.getElementById('snd-res-light-dist').textContent;\n        var distKm = document.getElementById('snd-res-light-km').textContent;\n\n        var text = '✈️ SPEED OF SOUND & MACH NUMBER REPORT\\n' +\n          '====================================================\\n' +\n          '• Local Speed of Sound: ' + c + ' (' + cAlt + ')\\n' +\n          '• Velocity: ' + mach + ' [' + reg + ']\\n' +\n          '• Lightning Ranging: ' + dist + ' (' + distKm + ')\\n' +\n          '----------------------------------------------------\\n' +\n          'Calculated via Digital Tools Shed: https://digitaltoolsshed.com/math/speed-of-sound-calculator';\n\n        navigator.clipboard.writeText(text).then(function() {\n          if (btn) {\n            var orig = btn.innerHTML;\n            btn.innerHTML = '<span>✓</span> Acoustic Report Copied!';\n            btn.style.borderColor = '#10b981';\n            btn.style.color = '#10b981';\n            setTimeout(function() {\n              btn.innerHTML = orig;\n              btn.style.borderColor = 'var(--border)';\n              btn.style.color = 'var(--fg)';\n            }, 2000);\n          }\n        });\n      }\n\n      if (document.readyState === 'loading') {\n        document.addEventListener('DOMContentLoaded', calcSound);\n      } else {\n        calcSound();\n      }\n    </script>\n  "
},

{
  "slug": "density-calculator",
  "title": "Density, Mass & Volume Calculator (ρ = m/V, Specific Gravity & Archimedes Buoyancy)",
  "metaDesc": "Calculate density (ρ), mass (m), and volume (V) with 40+ authentic material presets (gold, silver, titanium, woods, liquids). Features Archimedes’ buoyancy simulator, specific gravity, and vector flotation tank SVG.",
  "category": "Physics & Science",
  "faq": [
    {
      "q": "What is the formula for density, mass, and volume?",
      "a": "The core relationship is Density (ρ) = Mass (m) / Volume (V). Rearranging the formula gives: Mass = Density × Volume (m = ρV), and Volume = Mass / Density (V = m / ρ)."
    },
    {
      "q": "What is Specific Gravity (SG) and how is it related to density?",
      "a": "Specific Gravity is the dimensionless ratio of a substance’s density to the density of pure water at 4°C (1.000 g/cm³ or 1,000 kg/m³). An object with SG > 1.0 sinks in freshwater, while an object with SG < 1.0 floats."
    },
    {
      "q": "How does Archimedes’ Principle determine whether an object floats?",
      "a": "Archimedes’ Principle states that an immersed body experiences an upward buoyant force equal to the weight of the fluid it displaces: F_buoyant = ρ_fluid × V_submerged × g. If buoyant force exceeds the object’s gravitational weight, the object rises and floats until displaced fluid weight equals total body weight."
    },
    {
      "q": "Can density testing detect counterfeit gold bars filled with tungsten?",
      "a": "Tungsten has a density of 19.25 g/cm³, which is virtually identical to pure 24-karat gold’s density of 19.32 g/cm³ (differing by only 0.36%). A basic Archimedes water displacement test CANNOT distinguish tungsten from gold. Detecting tungsten-core fake gold requires ultrasonic speed-of-sound testing (sound travels at 3,240 m/s in gold vs 5,220 m/s in tungsten) or X-ray fluorescence (XRF)."
    },
    {
      "q": "Why does ice float on liquid water?",
      "a": "Unlike nearly all other substances that contract and increase in density when freezing, water exhibits an anomalous density inversion. Hydrogen bonds form a rigid crystalline hexagonal lattice that forces water molecules farther apart, decreasing ice density to 0.917 g/cm³ compared to liquid water’s 1.000 g/cm³ at 4°C."
    }
  ],
  "body": "\n    <div class=\"article-container\" style=\"max-width: 1040px;\">\n      <nav style=\"font-family: var(--mono); font-size: 0.8rem; margin-bottom: 1.5rem; color: var(--text-muted);\">\n        <a href=\"/\">Home</a> &gt; <a href=\"/math/\">Physics &amp; Science</a> &gt; Density Calculator\n      </nav>\n\n      <header style=\"margin-bottom: 2rem;\">\n        <div style=\"display: flex; gap: 0.5rem; align-items: center; margin-bottom: 0.5rem; flex-wrap: wrap;\">\n          <span class=\"badge badge-purple\">Classical Physics</span>\n          <span class=\"badge badge-green\">40+ Material Presets</span>\n          <span class=\"badge badge-blue\">Archimedes Buoyancy Tank</span>\n        </div>\n        <h1 style=\"font-family: var(--serif); font-size: 2.3rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          Density, Mass &amp; Volume Calculator\n        </h1>\n        <p style=\"color: var(--text-muted); font-size: 1.05rem; line-height: 1.6;\">\n          Solve for Density (ρ), Mass (m), or Volume (V) with 40+ authentic physical materials. Simulates Specific Gravity (SG), Archimedes’ buoyant force, apparent submerged weight, and percentage flotation in real time.\n        </p>\n      </header>\n\n      <!-- MAIN INPUT BOX -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); padding: 1.75rem; border-radius: 8px; margin-bottom: 2rem;\">\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem; margin-bottom: 1.5rem;\">\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Solve For:</label>\n            <select id=\"den-solve\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.95rem;\" onchange=\"onDenSolveChange()\">\n              <option value=\"D\" selected>Density (ρ = m / V)</option>\n              <option value=\"M\">Mass (m = ρ × V)</option>\n              <option value=\"V\">Volume (V = m / ρ)</option>\n            </select>\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Material Preset Library:</label>\n            <select id=\"den-preset\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.95rem;\" onchange=\"applyDenPreset(this.value)\">\n              <option value=\"custom\">-- Custom Density --</option>\n              <optgroup label=\"Precious & Heavy Metals\">\n                <option value=\"19.32\">Gold 24k (19.32 g/cm³)</option>\n                <option value=\"15.50\">Gold 18k (15.50 g/cm³)</option>\n                <option value=\"13.10\">Gold 14k (13.10 g/cm³)</option>\n                <option value=\"21.45\">Platinum (21.45 g/cm³)</option>\n                <option value=\"10.36\">Sterling Silver (10.36 g/cm³)</option>\n                <option value=\"19.25\">Tungsten (19.25 g/cm³)</option>\n                <option value=\"11.34\">Lead (11.34 g/cm³)</option>\n                <option value=\"22.59\">Osmium (22.59 g/cm³ — Densest)</option>\n              </optgroup>\n              <optgroup label=\"Industrial Metals & Alloys\">\n                <option value=\"8.96\">Copper (8.96 g/cm³)</option>\n                <option value=\"8.50\">Brass (8.50 g/cm³)</option>\n                <option value=\"7.87\" selected>Iron / Carbon Steel (7.87 g/cm³)</option>\n                <option value=\"4.51\">Titanium (4.51 g/cm³)</option>\n                <option value=\"2.70\">Aluminum (2.70 g/cm³)</option>\n                <option value=\"1.74\">Magnesium (1.74 g/cm³)</option>\n              </optgroup>\n              <optgroup label=\"Common Minerals & Woods\">\n                <option value=\"2.40\">Concrete (2.40 g/cm³)</option>\n                <option value=\"3.51\">Diamond (3.51 g/cm³)</option>\n                <option value=\"2.65\">Quartz / Granite (2.65 g/cm³)</option>\n                <option value=\"0.75\">Oak Wood (0.75 g/cm³ — Floats)</option>\n                <option value=\"0.50\">Pine Wood (0.50 g/cm³ — Floats)</option>\n                <option value=\"0.16\">Balsa Wood (0.16 g/cm³ — Floats)</option>\n                <option value=\"0.917\">Ice (0.917 g/cm³ — Floats)</option>\n              </optgroup>\n              <optgroup label=\"Liquids & Ultra-Light Solids\">\n                <option value=\"1.000\">Water (4°C) (1.000 g/cm³)</option>\n                <option value=\"1.025\">Sea Water (1.025 g/cm³)</option>\n                <option value=\"13.53\">Mercury (Liquid) (13.53 g/cm³)</option>\n                <option value=\"0.789\">Ethanol / Alcohol (0.789 g/cm³)</option>\n                <option value=\"0.918\">Olive Oil (0.918 g/cm³)</option>\n                <option value=\"0.740\">Gasoline (0.740 g/cm³)</option>\n                <option value=\"0.002\">Silica Aerogel (0.002 g/cm³)</option>\n              </optgroup>\n            </select>\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Immersion Fluid:</label>\n            <select id=\"den-fluid\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.95rem;\" onchange=\"calcDensity()\">\n              <option value=\"1.000\" selected>Fresh Water (1.000 g/cm³)</option>\n              <option value=\"1.025\">Sea Water / Ocean (1.025 g/cm³)</option>\n              <option value=\"1.260\">Glycerin (1.260 g/cm³)</option>\n              <option value=\"13.53\">Mercury (13.53 g/cm³ — Steel Floats!)</option>\n              <option value=\"0.789\">Ethanol (0.789 g/cm³)</option>\n            </select>\n          </div>\n        </div>\n\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem; border-top: 1px solid var(--border); padding-top: 1.25rem; margin-bottom: 1.5rem;\">\n          <div id=\"grp-den-d\">\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Density (ρ):</label>\n            <div style=\"display: flex; gap: 0.5rem;\">\n              <input type=\"number\" id=\"den-d\" value=\"7.87\" step=\"0.01\" style=\"width: 60%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcDensity()\" />\n              <select id=\"den-d-unit\" style=\"width: 40%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.85rem;\" onchange=\"calcDensity()\">\n                <option value=\"1\" selected>g/cm³</option>\n                <option value=\"0.001\">kg/m³</option>\n                <option value=\"0.0160185\">lbs/ft³</option>\n                <option value=\"27.6799\">lbs/in³</option>\n              </select>\n            </div>\n          </div>\n\n          <div id=\"grp-den-m\">\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Mass (m):</label>\n            <div style=\"display: flex; gap: 0.5rem;\">\n              <input type=\"number\" id=\"den-m\" value=\"1574\" step=\"10\" style=\"width: 60%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcDensity()\" />\n              <select id=\"den-m-unit\" style=\"width: 40%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.85rem;\" onchange=\"calcDensity()\">\n                <option value=\"1\" selected>Grams (g)</option>\n                <option value=\"1000\">Kilograms (kg)</option>\n                <option value=\"453.592\">Pounds (lbs)</option>\n                <option value=\"28.3495\">Ounces (oz)</option>\n              </select>\n            </div>\n          </div>\n\n          <div id=\"grp-den-v\">\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Volume (V):</label>\n            <div style=\"display: flex; gap: 0.5rem;\">\n              <input type=\"number\" id=\"den-v\" value=\"200\" step=\"5\" style=\"width: 60%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcDensity()\" />\n              <select id=\"den-v-unit\" style=\"width: 40%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.85rem;\" onchange=\"calcDensity()\">\n                <option value=\"1\" selected>cm³ (mL)</option>\n                <option value=\"1000\">Liters (L)</option>\n                <option value=\"1000000\">m³</option>\n                <option value=\"16.3871\">in³</option>\n                <option value=\"28316.8\">ft³</option>\n                <option value=\"3785.41\">Gallons (US)</option>\n              </select>\n            </div>\n          </div>\n        </div>\n\n        <!-- MAIN KPI RESULT CARDS -->\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;\">\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #3b82f6;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">True Density (ρ)</div>\n            <div id=\"den-res-d\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #3b82f6; margin-bottom: 0.2rem;\">7.87 g/cm³</div>\n            <div id=\"den-res-d-alt\" style=\"font-size: 0.85rem; color: var(--text-muted);\">7,870 kg/m³ | 491.3 lbs/ft³</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #10b981;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Specific Gravity (SG)</div>\n            <div id=\"den-res-sg\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #10b981; margin-bottom: 0.2rem;\">7.87</div>\n            <div id=\"den-res-sg-sub\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Relative to H2O @ 4°C (1.000)</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #6366f1;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Archimedes Flotation State</div>\n            <div id=\"den-res-buoy-state\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #ef4444; margin-bottom: 0.2rem;\">SINKS</div>\n            <div id=\"den-res-buoy-pct\" style=\"font-size: 0.85rem; color: var(--text-muted);\">100% Submerged in Fluid</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #f59e0b;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Apparent Submerged Weight</div>\n            <div id=\"den-res-apparent-wt\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #f59e0b; margin-bottom: 0.2rem;\">1,374 g</div>\n            <div id=\"den-res-buoy-force\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Buoyant Force: 1.96 Newtons</div>\n          </div>\n        </div>\n      </div>\n\n      <!-- INTERACTIVE ARCHIMEDES TANK SVG -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.35rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          🌊 Interactive Archimedes Buoyancy Tank\n        </h2>\n        <p style=\"font-size: 0.85rem; color: var(--text-muted); margin-bottom: 1.25rem;\">\n          Shows fluid displacement waterline, submerged volume equilibrium, and competing gravitational downward force vs upward fluid buoyancy vectors.\n        </p>\n\n        <div style=\"overflow-x: auto;\">\n          <svg id=\"den-tank-svg\" viewBox=\"0 0 800 240\" style=\"width: 100%; height: auto; min-width: 600px; font-family: var(--mono);\"></svg>\n        </div>\n      </div>\n\n      <!-- STEP-BY-STEP MATHEMATICAL DERIVATION -->\n      <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h3 style=\"font-family: var(--mono); font-size: 0.9rem; text-transform: uppercase; color: var(--text-muted); margin: 0 0 0.75rem 0;\">\n          📐 Step-by-Step Density &amp; Buoyancy Derivations\n        </h3>\n        <div id=\"den-derivation-box\" style=\"font-family: var(--mono); font-size: 0.85rem; line-height: 1.7; color: var(--fg);\">\n          Computing density and hydrodynamic equilibrium...\n        </div>\n      </div>\n\n      <!-- ONE-CLICK COPY BUTTON -->\n      <div style=\"margin-bottom: 2.5rem;\">\n        <button type=\"button\" id=\"den-copy-btn\" onclick=\"copyDensityReport(this)\" class=\"btn btn-copy\" style=\"display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; font-size: 0.9rem; font-weight: 600; background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; cursor: pointer; color: var(--fg); transition: all 0.15s ease;\">\n          <span>📋</span> Copy Density &amp; Buoyancy Material Report\n        </button>\n      </div>\n\n      <!-- 5 FATAL TRAPS -->\n      <div style=\"margin: 2.5rem 0;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.45rem; margin-bottom: 0.75rem; color: var(--fg);\">\n          ⚠️ 5 Fatal Traps &amp; Measurement Errors in Density &amp; Buoyancy\n        </h2>\n        <div style=\"display: grid; grid-template-columns: 1fr; gap: 1rem;\">\n          <div class=\"trap-card\" style=\"border-left: 4px solid #ef4444;\">\n            <strong style=\"color: #ef4444;\">1. The Counterfeit Gold &amp; Tungsten Density Spoofing Trap</strong>\n            Tungsten (W) possesses an atomic density of 19.25 g/cm³, closely matching pure 24k gold (19.32 g/cm³)—a difference of only 0.36%. Counterfeiters cast gold around tungsten rods. Simple water immersion testing cannot catch these sophisticated fakes because scale calibration tolerances exceed the density delta. Professional bullion authentication requires ultrasonic speed testing or magnetic susceptibility balances.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #f59e0b;\">\n            <strong style=\"color: #f59e0b;\">2. Bulk Density vs. Skeletal / True Density in Porous Solids</strong>\n            When measuring soil, concrete, gravel, or sponges, calculating mass divided by exterior geometric volume yields \"bulk density.\" However, porous materials contain substantial microscopic air void fractions. In civil engineering and geology, confusing bulk density with true skeletal mineral density causes catastrophic foundation load bearing calculation errors.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #10b981;\">\n            <strong style=\"color: #10b981;\">3. Fluid Temperature &amp; Specific Gravity Reference Standardization</strong>\n            The density of liquids varies significantly with temperature due to volumetric thermal expansion. Water reaches peak density at 3.98°C (1.000 g/cm³), but drops to 0.9982 g/cm³ at room temperature (20°C). In brewing (hydrometers) and petrochemicals (API gravity), failing to apply temperature compensation formulas leads to inaccurate alcohol by volume (ABV) or crude oil grading.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #3b82f6;\">\n            <strong style=\"color: #3b82f6;\">4. Overlooking Atmospheric Air Buoyancy in Lab Scales</strong>\n            Under Archimedes’ Principle, every object weighed on a scale in a room is buoyed upward by the mass of air it displaces (air density = 1.2 kg/m³ at sea level). For large, low-density items (like polystyrene or large volume plastic containers), ignoring air buoyancy causes true mass to be underestimated by several grams. High-precision analytical balances require vacuum mass corrections.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #8b5cf6;\">\n            <strong style=\"color: #8b5cf6;\">5. Surface Tension Pinning on Submerged Volume Meniscus</strong>\n            When measuring the volume of small objects via graduated cylinder water displacement, surface tension forces create an upward capillary meniscus against the object and the cylinder glass wall. This meniscus distorts visual volume readings by 5% to 15% unless a wetting surfactant (like a drop of liquid dish soap) is added to eliminate surface tension.\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <script>\n      function onDenSolveChange() {\n        var mode = document.getElementById('den-solve').value;\n        var grpD = document.getElementById('grp-den-d');\n        var grpM = document.getElementById('grp-den-m');\n        var grpV = document.getElementById('grp-den-v');\n\n        document.getElementById('den-d').disabled = (mode === 'D');\n        document.getElementById('den-m').disabled = (mode === 'M');\n        document.getElementById('den-v').disabled = (mode === 'V');\n\n        calcDensity();\n      }\n\n      function applyDenPreset(val) {\n        if (val !== 'custom') {\n          var dVal = parseFloat(val);\n          document.getElementById('den-d').value = dVal;\n          document.getElementById('den-d-unit').value = '1';\n          calcDensity();\n        }\n      }\n\n      function calcDensity() {\n        var mode = document.getElementById('den-solve').value;\n        var fluidDensity = parseFloat(document.getElementById('den-fluid').value) || 1.000;\n\n        var dRaw = parseFloat(document.getElementById('den-d').value);\n        var mRaw = parseFloat(document.getElementById('den-m').value);\n        var vRaw = parseFloat(document.getElementById('den-v').value);\n\n        var dUnit = parseFloat(document.getElementById('den-d-unit').value) || 1;\n        var mUnit = parseFloat(document.getElementById('den-m-unit').value) || 1;\n        var vUnit = parseFloat(document.getElementById('den-v-unit').value) || 1;\n\n        var D_base = !isNaN(dRaw) ? dRaw * dUnit : 7.87; // g/cm³\n        var M_base = !isNaN(mRaw) ? mRaw * mUnit : 1574; // grams\n        var V_base = !isNaN(vRaw) ? vRaw * vUnit : 200;  // cm³\n\n        if (mode === 'D') {\n          if (V_base > 0) D_base = M_base / V_base;\n          document.getElementById('den-d').value = (D_base / dUnit).toFixed(2);\n        } else if (mode === 'M') {\n          M_base = D_base * V_base;\n          document.getElementById('den-m').value = (M_base / mUnit).toFixed(1);\n        } else if (mode === 'V') {\n          if (D_base > 0) V_base = M_base / D_base;\n          document.getElementById('den-v').value = (V_base / vUnit).toFixed(1);\n        }\n\n        // Specific Gravity relative to 1.000 g/cm³ water\n        var sg = D_base / 1.000;\n\n        // Archimedes Buoyancy in selected fluid\n        var g = 9.80665; // m/s²\n        // Fluid displaced: if object sinks (D_base >= fluidDensity), displaced volume = V_base\n        // If object floats (D_base < fluidDensity), submerged fraction = D_base / fluidDensity\n        var isFloating = D_base < fluidDensity;\n        var subFrac = isFloating ? (D_base / fluidDensity) : 1.0;\n        var vSubCm3 = V_base * subFrac;\n\n        // Displaced mass in grams\n        var mDisplacedG = vSubCm3 * fluidDensity;\n        var fBuoyNewtons = (mDisplacedG / 1000) * g;\n        var weightInAirNewtons = (M_base / 1000) * g;\n\n        // Apparent submerged weight\n        var apparentWeightG = Math.max(0, M_base - mDisplacedG);\n\n        // Display Conversions\n        var dKgM3 = D_base * 1000;\n        var dLbsFt3 = D_base * 62.428;\n\n        // Update KPIs\n        document.getElementById('den-res-d').textContent = D_base.toFixed(2) + ' g/cm³';\n        document.getElementById('den-res-d-alt').textContent = Math.round(dKgM3).toLocaleString() + ' kg/m³ | ' + dLbsFt3.toFixed(1) + ' lbs/ft³';\n\n        document.getElementById('den-res-sg').textContent = sg.toFixed(2);\n        document.getElementById('den-res-sg-sub').textContent = 'Relative to H2O @ 4°C (' + (D_base / fluidDensity).toFixed(2) + ' in fluid)';\n\n        var buoyStateEl = document.getElementById('den-res-buoy-state');\n        var buoyPctEl = document.getElementById('den-res-buoy-pct');\n\n        if (isFloating) {\n          buoyStateEl.textContent = 'FLOATS';\n          buoyStateEl.style.color = '#10b981';\n          buoyPctEl.textContent = (subFrac * 100).toFixed(1) + '% Submerged (' + ((1 - subFrac) * 100).toFixed(1) + '% above waterline)';\n        } else if (Math.abs(D_base - fluidDensity) < 0.001) {\n          buoyStateEl.textContent = 'NEUTRAL';\n          buoyStateEl.style.color = '#3b82f6';\n          buoyPctEl.textContent = 'Suspended in Fluid Column (SG = 1.0)';\n        } else {\n          buoyStateEl.textContent = 'SINKS';\n          buoyStateEl.style.color = '#ef4444';\n          buoyPctEl.textContent = '100% Submerged (Rests on Tank Floor)';\n        }\n\n        document.getElementById('den-res-apparent-wt').textContent = Math.round(apparentWeightG).toLocaleString() + ' g';\n        document.getElementById('den-res-buoy-force').textContent = 'Buoyancy: ' + fBuoyNewtons.toFixed(2) + ' N (' + Math.round(mDisplacedG).toLocaleString() + 'g displaced)';\n\n        // Derivation Box\n        var dBox = document.getElementById('den-derivation-box');\n        dBox.innerHTML = '<strong>1. Core Density Relation:</strong> ρ = m / V = ' + M_base.toFixed(1) + ' g / ' + V_base.toFixed(1) + ' cm³ = <strong>' + D_base.toFixed(2) + ' g/cm³</strong> (' + Math.round(dKgM3).toLocaleString() + ' kg/m³).<br>' +\n          '<strong>2. Dimensionless Specific Gravity:</strong> SG = ρ_object / ρ_water = ' + D_base.toFixed(2) + ' / 1.000 = <strong>' + sg.toFixed(2) + '</strong>.<br>' +\n          '<strong>3. Hydrodynamic Buoyant Force:</strong> F_b = ρ_fluid × V_sub × g = ' + fluidDensity.toFixed(3) + ' g/cm³ × ' + vSubCm3.toFixed(1) + ' cm³ × 9.81 m/s² = <strong>' + fBuoyNewtons.toFixed(2) + ' Newtons</strong>.<br>' +\n          '<strong>4. Archimedes Submersion Equilibrium:</strong> Submerged Ratio = ρ_object / ρ_fluid = ' + D_base.toFixed(2) + ' / ' + fluidDensity.toFixed(2) + ' = <strong>' + (subFrac * 100).toFixed(1) + '%</strong>.<br>' +\n          '<strong>5. Net Submerged Apparent Weight:</strong> W_apparent = Total Mass (' + M_base.toFixed(0) + 'g) - Displaced Fluid (' + Math.round(mDisplacedG) + 'g) = <strong>' + Math.round(apparentWeightG).toLocaleString() + ' g</strong> (' + (weightInAirNewtons - fBuoyNewtons).toFixed(2) + ' N).';\n\n        // Render Tank SVG\n        renderDenTankSvg(subFrac, isFloating, D_base, fluidDensity);\n      }\n\n      function renderDenTankSvg(subFrac, isFloating, dObj, dFluid) {\n        var svg = document.getElementById('den-tank-svg');\n        if (!svg) return;\n\n        var w = 800, h = 240;\n        var tankX = 220, tankY = 30, tankW = 360, tankH = 180;\n        var waterY = tankY + 50;\n\n        var svgHtml = '';\n\n        // Tank Outer Shell\n        svgHtml += '<rect x=\"' + tankX + '\" y=\"' + tankY + '\" width=\"' + tankW + '\" height=\"' + tankH + '\" fill=\"var(--surface-alt)\" stroke=\"var(--border)\" stroke-width=\"3\" rx=\"4\" />';\n\n        // Fluid Level\n        svgHtml += '<rect x=\"' + tankX + '\" y=\"' + waterY + '\" width=\"' + tankW + '\" height=\"' + (tankH - 50) + '\" fill=\"rgba(59, 130, 246, 0.25)\" />';\n        svgHtml += '<line x1=\"' + tankX + '\" y1=\"' + waterY + '\" x2=\"' + (tankX + tankW) + '\" y2=\"' + waterY + '\" stroke=\"#3b82f6\" stroke-width=\"2\" stroke-dasharray=\"6,3\" />';\n        svgHtml += '<text x=\"' + (tankX + 15) + '\" y=\"' + (waterY - 8) + '\" fill=\"#3b82f6\" font-size=\"11\" font-weight=\"bold\">Fluid Surface (ρ = ' + dFluid.toFixed(2) + ')</text>';\n\n        // Object Block\n        var blockW = 100, blockH = 80;\n        var blockX = tankX + (tankW / 2) - (blockW / 2);\n        var blockY;\n\n        if (isFloating) {\n          // Resting at waterline: blockY is positioned such that (subFrac * blockH) is below waterY\n          blockY = waterY - ((1 - subFrac) * blockH);\n        } else {\n          // Sinks to bottom of tank\n          blockY = tankY + tankH - blockH;\n        }\n\n        // Color block by density\n        var blockColor = isFloating ? '#10b981' : '#f59e0b';\n        svgHtml += '<rect x=\"' + blockX + '\" y=\"' + blockY + '\" width=\"' + blockW + '\" height=\"' + blockH + '\" fill=\"' + blockColor + '\" stroke=\"#ffffff\" stroke-width=\"2\" rx=\"4\" />';\n        svgHtml += '<text x=\"' + (blockX + blockW/2) + '\" y=\"' + (blockY + blockH/2 + 4) + '\" fill=\"#ffffff\" font-size=\"12\" font-weight=\"bold\" text-anchor=\"middle\">ρ = ' + dObj.toFixed(2) + '</text>';\n\n        // Force Vectors (Gravity Down vs Buoyancy Up)\n        var arrX = blockX + blockW + 30;\n        var gravLen = Math.min(60, Math.max(20, dObj * 5));\n        var buoyLen = Math.min(60, Math.max(15, (isFloating ? dObj : dFluid) * 5));\n\n        // Downward Gravity Vector\n        svgHtml += '<line x1=\"' + arrX + '\" y1=\"' + (blockY + blockH/2) + '\" x2=\"' + arrX + '\" y2=\"' + (blockY + blockH/2 + gravLen) + '\" stroke=\"#ef4444\" stroke-width=\"2.5\" />';\n        svgHtml += '<polygon points=\"' + (arrX - 4) + ',' + (blockY + blockH/2 + gravLen - 6) + ' ' + (arrX + 4) + ',' + (blockY + blockH/2 + gravLen - 6) + ' ' + arrX + ',' + (blockY + blockH/2 + gravLen) + '\" fill=\"#ef4444\" />';\n        svgHtml += '<text x=\"' + (arrX + 8) + '\" y=\"' + (blockY + blockH/2 + gravLen) + '\" fill=\"#ef4444\" font-size=\"10\" font-weight=\"bold\">Gravity (Fg)</text>';\n\n        // Upward Buoyant Vector\n        svgHtml += '<line x1=\"' + arrX + '\" y1=\"' + (blockY + blockH/2) + '\" x2=\"' + arrX + '\" y2=\"' + (blockY + blockH/2 - buoyLen) + '\" stroke=\"#10b981\" stroke-width=\"2.5\" />';\n        svgHtml += '<polygon points=\"' + (arrX - 4) + ',' + (blockY + blockH/2 - buoyLen + 6) + ' ' + (arrX + 4) + ',' + (blockY + blockH/2 - buoyLen + 6) + ' ' + arrX + ',' + (blockY + blockH/2 - buoyLen) + '\" fill=\"#10b981\" />';\n        svgHtml += '<text x=\"' + (arrX + 8) + '\" y=\"' + (blockY + blockH/2 - buoyLen + 4) + '\" fill=\"#10b981\" font-size=\"10\" font-weight=\"bold\">Buoyancy (Fb)</text>';\n\n        svg.innerHTML = svgHtml;\n      }\n\n      function copyDensityReport(btn) {\n        var d = document.getElementById('den-res-d').textContent;\n        var dAlt = document.getElementById('den-res-d-alt').textContent;\n        var sg = document.getElementById('den-res-sg').textContent;\n        var state = document.getElementById('den-res-buoy-state').textContent;\n        var buoySub = document.getElementById('den-res-buoy-pct').textContent;\n        var appWt = document.getElementById('den-res-apparent-wt').textContent;\n\n        var text = '🌊 MATERIAL DENSITY & ARCHIMEDES BUOYANCY AUDIT\\n' +\n          '====================================================\\n' +\n          '• Calculated Density: ' + d + ' (' + dAlt + ')\\n' +\n          '• Specific Gravity (SG): ' + sg + '\\n' +\n          '• Archimedes Status: ' + state + ' (' + buoySub + ')\\n' +\n          '• Apparent Submerged Weight: ' + appWt + '\\n' +\n          '----------------------------------------------------\\n' +\n          'Calculated via Digital Tools Shed: https://digitaltoolsshed.com/math/density-calculator';\n\n        navigator.clipboard.writeText(text).then(function() {\n          if (btn) {\n            var orig = btn.innerHTML;\n            btn.innerHTML = '<span>✓</span> Density Report Copied!';\n            btn.style.borderColor = '#10b981';\n            btn.style.color = '#10b981';\n            setTimeout(function() {\n              btn.innerHTML = orig;\n              btn.style.borderColor = 'var(--border)';\n              btn.style.color = 'var(--fg)';\n            }, 2000);\n          }\n        });\n      }\n\n      if (document.readyState === 'loading') {\n        document.addEventListener('DOMContentLoaded', calcDensity);\n      } else {\n        calcDensity();\n      }\n    </script>\n  "
},
{
  "slug": "kinetic-energy-calculator",
  "title": "Kinetic & Potential Energy Calculator (Ek = ½mv², Ep = mgh & Energy Transfer SVG)",
  "metaDesc": "Calculate kinetic energy (Ek = ½mv²), gravitational potential energy (Ep = mgh), and spring elastic potential energy. Features vehicle braking distance solver, TNT equivalence converter, and interactive mechanical energy transfer simulator.",
  "category": "Physics & Mechanics",
  "faq": [
    {
      "q": "What is the formula for kinetic energy and how does speed affect it?",
      "a": "The formula for kinetic energy is Ek = ½ × m × v², where m is mass in kilograms and v is velocity in meters per second. Because velocity is squared, doubling your speed quadruples kinetic energy (2² = 4), and tripling your speed increases kinetic energy nine-fold (3² = 9)."
    },
    {
      "q": "How does gravitational potential energy convert into kinetic energy during free fall?",
      "a": "Under the Law of Conservation of Mechanical Energy (neglecting air resistance), total mechanical energy remains constant: E_total = Ek + Ep. As an object falls from height h, potential energy (Ep = mgh) converts entirely into kinetic energy (Ek = ½mv²). At the bottom, v = √(2gh), which is completely independent of the object’s mass."
    },
    {
      "q": "How does kinetic energy explain vehicle braking distance in car crashes?",
      "a": "According to the Work-Energy Theorem (W = F × d = ΔEk), the work performed by brake friction must dissipate all of the vehicle’s kinetic energy. Because Ek scales with the square of velocity (v²), a car traveling at 60 mph requires four times the stopping distance of a car traveling at 30 mph on identical pavement."
    },
    {
      "q": "How many Joules are equivalent to one gram of TNT explosive?",
      "a": "By international convention in physics and blast ballistics, one gram of TNT is defined as exactly 4,184 Joules (4.184 kJ). A 1-ton TNT equivalent equals 4.184 × 10⁹ Joules (4.184 GJ)."
    },
    {
      "q": "What is the difference between kinetic energy and linear momentum?",
      "a": "Linear momentum (p = mv) is a vector quantity proportional to velocity that is conserved in all collisions. Kinetic energy (Ek = ½mv² = p² / 2m) is a scalar quantity measuring total work capacity. In inelastic collisions (such as vehicle crashes), momentum is conserved, but kinetic energy is converted into heat, sound, and structural metal deformation."
    }
  ],
  "body": "\n    <div class=\"article-container\" style=\"max-width: 1040px;\">\n      <nav style=\"font-family: var(--mono); font-size: 0.8rem; margin-bottom: 1.5rem; color: var(--text-muted);\">\n        <a href=\"/\">Home</a> &gt; <a href=\"/math/\">Physics &amp; Mechanics</a> &gt; Kinetic Energy Calculator\n      </nav>\n\n      <header style=\"margin-bottom: 2rem;\">\n        <div style=\"display: flex; gap: 0.5rem; align-items: center; margin-bottom: 0.5rem; flex-wrap: wrap;\">\n          <span class=\"badge badge-purple\">Classical Mechanics</span>\n          <span class=\"badge badge-green\">Conservation of Energy</span>\n          <span class=\"badge badge-blue\">Work-Energy Theorem</span>\n        </div>\n        <h1 style=\"font-family: var(--serif); font-size: 2.3rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          Kinetic &amp; Potential Mechanical Energy Calculator\n        </h1>\n        <p style=\"color: var(--text-muted); font-size: 1.05rem; line-height: 1.6;\">\n          Compute kinetic energy ($E_k = \\frac{1}{2}mv^2$), gravitational potential energy ($E_p = mgh$), free-fall impact velocity, and vehicle stopping distance. Features dynamic interactive energy exchange bar simulation.\n        </p>\n      </header>\n\n      <!-- MAIN INPUT BOX -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); padding: 1.75rem; border-radius: 8px; margin-bottom: 2rem;\">\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem; margin-bottom: 1.5rem;\">\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Object Mass (m):</label>\n            <div style=\"display: flex; gap: 0.5rem;\">\n              <input type=\"number\" id=\"ke-mass\" value=\"1500\" min=\"0.001\" step=\"10\" style=\"width: 65%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcKE()\" />\n              <select id=\"ke-mass-unit\" style=\"width: 35%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.85rem;\" onchange=\"calcKE()\">\n                <option value=\"1\" selected>kg</option>\n                <option value=\"0.001\">Grams (g)</option>\n                <option value=\"0.453592\">Pounds (lbs)</option>\n                <option value=\"1000\">Metric Tons</option>\n              </select>\n            </div>\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Velocity / Speed (v):</label>\n            <div style=\"display: flex; gap: 0.5rem;\">\n              <input type=\"number\" id=\"ke-vel\" value=\"26.82\" min=\"0\" step=\"1\" style=\"width: 65%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcKE()\" />\n              <select id=\"ke-vel-unit\" style=\"width: 35%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.85rem;\" onchange=\"calcKE()\">\n                <option value=\"1\" selected>m/s</option>\n                <option value=\"0.44704\">mph (60mph=26.8m/s)</option>\n                <option value=\"0.277778\">km/h</option>\n                <option value=\"0.3048\">ft/s</option>\n              </select>\n            </div>\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Elevation / Drop Height (h):</label>\n            <div style=\"display: flex; gap: 0.5rem;\">\n              <input type=\"number\" id=\"ke-height\" value=\"36.7\" min=\"0\" step=\"1\" style=\"width: 65%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcKE()\" />\n              <select id=\"ke-height-unit\" style=\"width: 35%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.85rem;\" onchange=\"calcKE()\">\n                <option value=\"1\" selected>Meters (m)</option>\n                <option value=\"0.3048\">Feet (ft)</option>\n              </select>\n            </div>\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Pavement Braking Friction (µ):</label>\n            <select id=\"ke-friction\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.95rem;\" onchange=\"calcKE()\">\n              <option value=\"0.80\" selected>Dry Asphalt / Concrete (µ = 0.80)</option>\n              <option value=\"0.40\">Wet Pavement / Rain (µ = 0.40)</option>\n              <option value=\"0.15\">Packed Snow (µ = 0.15)</option>\n              <option value=\"0.08\">Black Ice (µ = 0.08)</option>\n            </select>\n          </div>\n        </div>\n\n        <!-- QUICK PRESET BUTTONS ROW -->\n        <div style=\"display: flex; gap: 0.5rem; flex-wrap: wrap; margin-bottom: 1.5rem; border-top: 1px solid var(--border); padding-top: 1rem;\">\n          <span style=\"font-size: 0.8rem; font-weight: bold; color: var(--text-muted); align-self: center; margin-right: 0.25rem;\">Real-World Benchmarks:</span>\n          <button type=\"button\" onclick=\"setKePreset(0.145, 42.5, 0)\" style=\"padding: 0.35rem 0.75rem; border: 1px solid var(--border); background: var(--surface-alt); color: var(--fg); border-radius: 6px; font-size: 0.8rem; cursor: pointer;\">⚾ 95mph Baseball (145g)</button>\n          <button type=\"button\" onclick=\"setKePreset(0.004, 850, 0)\" style=\"padding: 0.35rem 0.75rem; border: 1px solid var(--border); background: var(--surface-alt); color: var(--fg); border-radius: 6px; font-size: 0.8rem; cursor: pointer;\">🔫 5.56mm Rifle Bullet (4g)</button>\n          <button type=\"button\" onclick=\"setKePreset(1500, 26.82, 36.7)\" style=\"padding: 0.35rem 0.75rem; border: 1px solid var(--border); background: var(--surface-alt); color: var(--fg); border-radius: 6px; font-size: 0.8rem; cursor: pointer;\">🚗 Sedan at 60 mph (1,500kg)</button>\n          <button type=\"button\" onclick=\"setKePreset(36000, 29.0, 0)\" style=\"padding: 0.35rem 0.75rem; border: 1px solid var(--border); background: var(--surface-alt); color: var(--fg); border-radius: 6px; font-size: 0.8rem; cursor: pointer;\">🚛 80,000 lb Semi Truck (65mph)</button>\n          <button type=\"button\" onclick=\"setKePreset(400000, 250, 11000)\" style=\"padding: 0.35rem 0.75rem; border: 1px solid var(--border); background: var(--surface-alt); color: var(--fg); border-radius: 6px; font-size: 0.8rem; cursor: pointer;\">✈️ Boeing 747 Cruising</button>\n        </div>\n\n        <!-- MAIN KPI RESULT CARDS -->\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;\">\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #10b981;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Kinetic Energy (Ek)</div>\n            <div id=\"ke-res-joules\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #10b981; margin-bottom: 0.2rem;\">539.5 kJ</div>\n            <div id=\"ke-res-joules-alt\" style=\"font-size: 0.85rem; color: var(--text-muted);\">539,487 Joules | 129 kcal</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #3b82f6;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Potential Energy (Ep = mgh)</div>\n            <div id=\"ke-res-potential\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #3b82f6; margin-bottom: 0.2rem;\">539.5 kJ</div>\n            <div id=\"ke-res-potential-sub\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Height: 36.7 m (120.4 ft)</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #f59e0b;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Vehicle Braking Stopping Distance</div>\n            <div id=\"ke-res-stopping-dist\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #f59e0b; margin-bottom: 0.2rem;\">45.9 m</div>\n            <div id=\"ke-res-stopping-ft\" style=\"font-size: 0.85rem; color: var(--text-muted);\">150.6 Feet (µ = 0.80)</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #ef4444;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">TNT Explosive Equivalent</div>\n            <div id=\"ke-res-tnt\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #ef4444; margin-bottom: 0.2rem;\">128.9 g</div>\n            <div id=\"ke-res-tnt-sub\" style=\"font-size: 0.85rem; color: var(--text-muted);\">1g TNT = 4,184 Joules</div>\n          </div>\n        </div>\n      </div>\n\n      <!-- INTERACTIVE ENERGY TRANSFER BAR SVG -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.35rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          🎢 Mechanical Energy Exchange &amp; Conservation of Energy\n        </h2>\n        <p style=\"font-size: 0.85rem; color: var(--text-muted); margin-bottom: 1.25rem;\">\n          Shows the dynamic trade-off between Gravitational Potential Energy ($E_p$ in blue) and Kinetic Velocity ($E_k$ in emerald). Total mechanical energy $E_{\\text{total}} = E_k + E_p$ is 100% conserved in vacuum.\n        </p>\n\n        <div style=\"overflow-x: auto;\">\n          <svg id=\"ke-chart-svg\" viewBox=\"0 0 800 180\" style=\"width: 100%; height: auto; min-width: 600px; font-family: var(--mono);\"></svg>\n        </div>\n      </div>\n\n      <!-- STEP-BY-STEP MATHEMATICAL DERIVATION -->\n      <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h3 style=\"font-family: var(--mono); font-size: 0.9rem; text-transform: uppercase; color: var(--text-muted); margin: 0 0 0.75rem 0;\">\n          📐 Step-by-Step Mechanical Work &amp; Kinematic Derivations\n        </h3>\n        <div id=\"ke-derivation-box\" style=\"font-family: var(--mono); font-size: 0.85rem; line-height: 1.7; color: var(--fg);\">\n          Calculating mechanical energy metrics...\n        </div>\n      </div>\n\n      <!-- ONE-CLICK COPY BUTTON -->\n      <div style=\"margin-bottom: 2.5rem;\">\n        <button type=\"button\" id=\"ke-copy-btn\" onclick=\"copyKeReport(this)\" class=\"btn btn-copy\" style=\"display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; font-size: 0.9rem; font-weight: 600; background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; cursor: pointer; color: var(--fg); transition: all 0.15s ease;\">\n          <span>📋</span> Copy Kinetic Energy &amp; Stopping Distance Solution\n        </button>\n      </div>\n\n      <!-- 5 FATAL TRAPS -->\n      <div style=\"margin: 2.5rem 0;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.45rem; margin-bottom: 0.75rem; color: var(--fg);\">\n          ⚠️ 5 Fatal Traps &amp; Physics Misunderstandings in Kinetic Energy\n        </h2>\n        <div style=\"display: grid; grid-template-columns: 1fr; gap: 1rem;\">\n          <div class=\"trap-card\" style=\"border-left: 4px solid #ef4444;\">\n            <strong style=\"color: #ef4444;\">1. The Linear Speed vs. Quadratic Energy Fallacy ($v^2$)</strong>\n            Drivers intuitively assume that increasing highway speed by 25% (e.g., from 60 mph to 75 mph) increases crash severity by 25%. In reality, kinetic energy scales with the square of velocity: $(75 / 60)^2 = 1.5625$. That 15 mph speed increase imparts 56.25% MORE destructive kinetic energy into the vehicle chassis and requires 56% longer skid stopping distance.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #f59e0b;\">\n            <strong style=\"color: #f59e0b;\">2. Overlooking Rotational Kinetic Energy in Rolling Bodies ($E_{\text{rot}} = \frac{1}{2}Iomega^2$)</strong>\n            When a solid bowling ball, tire, or cylinder rolls down an incline, it does not convert 100% of its gravitational potential energy ($mgh$) into forward translational speed. A significant fraction (28.6% for a solid sphere, 50% for a hollow cylinder) is consumed by rotational kinetic energy of inertia. A frictionless sliding block will always outpace a rolling ball down a ramp.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #10b981;\">\n            <strong style=\"color: #10b981;\">3. Confusing Energy (Scalar) with Momentum (Vector) in Collisions</strong>\n            In vehicle crashes or ballistic impacts, linear momentum ($p = mv$) is strictly conserved, but kinetic energy is NOT conserved in inelastic collisions. The kinetic energy is violently converted into plastic metal deformation work, acoustic shockwaves, and extreme friction thermal heat. Assuming kinetic energy is conserved in a car crash yields absurdly inaccurate post-impact velocity estimates.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #3b82f6;\">\n            <strong style=\"color: #3b82f6;\">4. The Arbitrary Gravitational Datum Zero-Reference</strong>\n            Gravitational potential energy ($E_p = mgh$) has no absolute universal zero point. The height $h = 0$ is an arbitrary reference datum chosen for convenience (e.g., floor, sea level, or table top). Only the change in potential energy ($Delta E_p = mgDelta h$) has physical consequence. Forgetting to set a consistent datum leads to nonsensical negative energy bookkeeping.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #8b5cf6;\">\n            <strong style=\"color: #8b5cf6;\">5. Classical Physics Breakdown at Relativistic Speeds ($v > 0.1c$)</strong>\n            The classical formula $E_k = \frac{1}{2}mv^2$ is an approximation that assumes constant mass. As velocities exceed 10% the speed of light ($0.1c$, such as in particle accelerators or cosmic rays), Einstein’s special relativity dictates that kinetic energy must be computed via $E_k = (gamma - 1)mc^2$. At $0.9c$, classical physics underestimates kinetic energy by more than 55%.\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <script>\n      function setKePreset(mKg, vMs, hM) {\n        document.getElementById('ke-mass').value = mKg;\n        document.getElementById('ke-mass-unit').value = '1';\n        document.getElementById('ke-vel').value = vMs;\n        document.getElementById('ke-vel-unit').value = '1';\n        document.getElementById('ke-height').value = hM;\n        document.getElementById('ke-height-unit').value = '1';\n        calcKE();\n      }\n\n      function calcKE() {\n        var mRaw = parseFloat(document.getElementById('ke-mass').value) || 0;\n        var mUnit = parseFloat(document.getElementById('ke-mass-unit').value) || 1;\n        var vRaw = parseFloat(document.getElementById('ke-vel').value) || 0;\n        var vUnit = parseFloat(document.getElementById('ke-vel-unit').value) || 1;\n        var hRaw = parseFloat(document.getElementById('ke-height').value) || 0;\n        var hUnit = parseFloat(document.getElementById('ke-height-unit').value) || 1;\n        var mu = parseFloat(document.getElementById('ke-friction').value) || 0.80;\n\n        var m = mRaw * mUnit; // kg\n        var v = vRaw * vUnit; // m/s\n        var h = hRaw * hUnit; // meters\n        var g = 9.80665; // m/s²\n\n        // Kinetic Energy: 0.5 * m * v^2\n        var Ek = 0.5 * m * (v * v); // Joules\n        // Gravitational Potential Energy: m * g * h\n        var Ep = m * g * h; // Joules\n\n        // Braking stopping distance via Work-Energy Theorem: Ek = F_friction * d = (mu * m * g) * d\n        // d = Ek / (mu * m * g) = v^2 / (2 * mu * g)\n        var stoppingDistM = 0;\n        if (mu > 0 && g > 0) {\n          stoppingDistM = (v * v) / (2 * mu * g);\n        }\n        var stoppingDistFt = stoppingDistM * 3.28084;\n\n        // TNT Equivalent (1g TNT = 4,184 J)\n        var tntGrams = Ek / 4184;\n\n        // Energy formatting\n        var ekDisplay = Ek >= 1000000 ? (Ek / 1000000).toFixed(2) + ' MJ' : (Ek >= 1000 ? (Ek / 1000).toFixed(1) + ' kJ' : Math.round(Ek) + ' J');\n        var epDisplay = Ep >= 1000000 ? (Ep / 1000000).toFixed(2) + ' MJ' : (Ep >= 1000 ? (Ep / 1000).toFixed(1) + ' kJ' : Math.round(Ep) + ' J');\n\n        // Update KPIs\n        document.getElementById('ke-res-joules').textContent = ekDisplay;\n        document.getElementById('ke-res-joules-alt').textContent = Math.round(Ek).toLocaleString() + ' Joules | ' + (Ek / 4184).toFixed(1) + ' kcal';\n\n        document.getElementById('ke-res-potential').textContent = epDisplay;\n        document.getElementById('ke-res-potential-sub').textContent = 'Height: ' + h.toFixed(1) + ' m (' + (h * 3.28084).toFixed(1) + ' ft)';\n\n        document.getElementById('ke-res-stopping-dist').textContent = stoppingDistM.toFixed(1) + ' m';\n        document.getElementById('ke-res-stopping-ft').textContent = stoppingDistFt.toFixed(1) + ' Feet (µ = ' + mu.toFixed(2) + ')';\n\n        document.getElementById('ke-res-tnt').textContent = tntGrams >= 1000 ? (tntGrams / 1000).toFixed(2) + ' kg' : tntGrams.toFixed(1) + ' g';\n        document.getElementById('ke-res-tnt-sub').textContent = '1g TNT = 4,184 Joules (' + (Ek / 3600000).toFixed(4) + ' kWh)';\n\n        // Derivation Box\n        var dBox = document.getElementById('ke-derivation-box');\n        dBox.innerHTML = '<strong>1. Kinetic Energy Formula:</strong> Ek = ½ × m × v² = 0.5 × ' + m.toFixed(1) + ' kg × (' + v.toFixed(2) + ' m/s)² = <strong>' + Math.round(Ek).toLocaleString() + ' Joules</strong> (' + (Ek/1000).toFixed(2) + ' kJ).<br>' +\n          '<strong>2. Potential Energy Formula:</strong> Ep = m × g × h = ' + m.toFixed(1) + ' kg × 9.81 m/s² × ' + h.toFixed(1) + ' m = <strong>' + Math.round(Ep).toLocaleString() + ' Joules</strong> (' + (Ep/1000).toFixed(2) + ' kJ).<br>' +\n          '<strong>3. Equivalent Free-Fall Velocity:</strong> v_freefall = √(2gh) = √(2 × 9.81 × ' + h.toFixed(1) + ') = <strong>' + Math.sqrt(2 * g * h).toFixed(2) + ' m/s</strong> (' + (Math.sqrt(2 * g * h) * 2.23694).toFixed(1) + ' mph).<br>' +\n          '<strong>4. Work-Energy Braking Distance:</strong> d = v² / (2µg) = (' + v.toFixed(2) + ')² / (2 × ' + mu.toFixed(2) + ' × 9.81) = <strong>' + stoppingDistM.toFixed(1) + ' m</strong> (' + stoppingDistFt.toFixed(1) + ' ft).<br>' +\n          '<strong>5. Explosive Blast Equivalence:</strong> ' + Math.round(Ek).toLocaleString() + ' J / 4,184 J/g TNT = <strong>' + tntGrams.toFixed(2) + ' grams TNT</strong>.';\n\n        // Render Energy Bar SVG\n        renderKeSvg(Ek, Ep);\n      }\n\n      function renderKeSvg(Ek, Ep) {\n        var svg = document.getElementById('ke-chart-svg');\n        if (!svg) return;\n\n        var w = 800, h = 180;\n        var barX = 80, barY = 65, barW = 640, barH = 38;\n\n        var totalE = Ek + Ep;\n        if (totalE === 0) totalE = 1;\n\n        var ekW = (Ek / totalE) * barW;\n        var epW = barW - ekW;\n\n        var svgHtml = '';\n\n        // Potential Energy Bar (Blue)\n        svgHtml += '<rect x=\"' + barX + '\" y=\"' + barY + '\" width=\"' + barW + '\" height=\"' + barH + '\" fill=\"#3b82f6\" rx=\"6\"><title>Gravitational Potential Energy (Ep)</title></rect>';\n\n        // Kinetic Energy Bar (Green)\n        if (ekW > 0) {\n          svgHtml += '<rect x=\"' + barX + '\" y=\"' + barY + '\" width=\"' + ekW + '\" height=\"' + barH + '\" fill=\"#10b981\" rx=\"' + (ekW >= barW ? '6' : '6 0 0 6') + '\"><title>Kinetic Energy (Ek)</title></rect>';\n        }\n\n        // Text Labels on Bar\n        if (ekW >= 80) {\n          svgHtml += '<text x=\"' + (barX + ekW/2) + '\" y=\"' + (barY + 24) + '\" fill=\"#ffffff\" font-size=\"13\" font-weight=\"bold\" text-anchor=\"middle\">Ek: ' + ((Ek/totalE)*100).toFixed(0) + '%</text>';\n        }\n        if (epW >= 80) {\n          svgHtml += '<text x=\"' + (barX + ekW + epW/2) + '\" y=\"' + (barY + 24) + '\" fill=\"#ffffff\" font-size=\"13\" font-weight=\"bold\" text-anchor=\"middle\">Ep: ' + ((Ep/totalE)*100).toFixed(0) + '%</text>';\n        }\n\n        // Top Legend Callouts\n        svgHtml += '<circle cx=\"' + barX + '\" cy=\"30\" r=\"6\" fill=\"#10b981\" />';\n        svgHtml += '<text x=\"' + (barX + 15) + '\" y=\"34\" fill=\"var(--fg)\" font-size=\"12\" font-weight=\"bold\">Kinetic Energy (Ek) = ' + Math.round(Ek).toLocaleString() + ' J</text>';\n\n        svgHtml += '<circle cx=\"' + (barX + 340) + '\" cy=\"30\" r=\"6\" fill=\"#3b82f6\" />';\n        svgHtml += '<text x=\"' + (barX + 355) + '\" y=\"34\" fill=\"var(--fg)\" font-size=\"12\" font-weight=\"bold\">Potential Energy (Ep) = ' + Math.round(Ep).toLocaleString() + ' J</text>';\n\n        // Axis\n        svgHtml += '<text x=\"' + barX + '\" y=\"' + (barY + barH + 20) + '\" fill=\"var(--text-muted)\" font-size=\"11\">0% (Pure Potential)</text>';\n        svgHtml += '<text x=\"' + (barX + barW/2) + '\" y=\"' + (barY + barH + 20) + '\" fill=\"var(--text-muted)\" font-size=\"11\" text-anchor=\"middle\">50 / 50 Equipartition</text>';\n        svgHtml += '<text x=\"' + (barX + barW) + '\" y=\"' + (barY + barH + 20) + '\" fill=\"var(--text-muted)\" font-size=\"11\" text-anchor=\"end\">100% (Pure Kinetic)</text>';\n\n        svg.innerHTML = svgHtml;\n      }\n\n      function copyKeReport(btn) {\n        var ek = document.getElementById('ke-res-joules').textContent;\n        var ep = document.getElementById('ke-res-potential').textContent;\n        var stopM = document.getElementById('ke-res-stopping-dist').textContent;\n        var stopFt = document.getElementById('ke-res-stopping-ft').textContent;\n        var tnt = document.getElementById('ke-res-tnt').textContent;\n        var mass = document.getElementById('ke-mass').value;\n        var vel = document.getElementById('ke-vel').value;\n\n        var text = '🚀 KINETIC & POTENTIAL MECHANICAL ENERGY AUDIT\\n' +\n          '====================================================\\n' +\n          '• Mass: ' + mass + ' kg | Velocity: ' + vel + ' m/s\\n' +\n          '• Kinetic Energy (Ek): ' + ek + '\\n' +\n          '• Gravitational Potential Energy (Ep): ' + ep + '\\n' +\n          '• Skid Stopping Distance: ' + stopM + ' (' + stopFt + ')\\n' +\n          '• TNT Explosive Equivalence: ' + tnt + '\\n' +\n          '----------------------------------------------------\\n' +\n          'Calculated via Digital Tools Shed: https://digitaltoolsshed.com/math/kinetic-energy-calculator';\n\n        navigator.clipboard.writeText(text).then(function() {\n          if (btn) {\n            var orig = btn.innerHTML;\n            btn.innerHTML = '<span>✓</span> Energy Audit Copied!';\n            btn.style.borderColor = '#10b981';\n            btn.style.color = '#10b981';\n            setTimeout(function() {\n              btn.innerHTML = orig;\n              btn.style.borderColor = 'var(--border)';\n              btn.style.color = 'var(--fg)';\n            }, 2000);\n          }\n        });\n      }\n\n      if (document.readyState === 'loading') {\n        document.addEventListener('DOMContentLoaded', calcKE);\n      } else {\n        calcKE();\n      }\n    </script>\n  "
},

{
  "slug": "projectile-motion-calculator",
  "title": "Projectile Motion & Trajectory Calculator (Apex, Range, Flight Time & Flight Path SVG)",
  "metaDesc": "Calculate projectile trajectory, maximum apex height, total flight time, horizontal range, and impact velocity given launch speed, angle, and initial elevation. Includes gravity selector and interactive SVG flight path.",
  "category": "Math & Science",
  "faq": [
    {
      "q": "What angle gives the maximum horizontal range for a projectile?",
      "a": "When launching from flat ground to an equal landing elevation (initial height y0 = 0), an angle of exactly 45° maximizes horizontal range: Range = (v0² / g) × sin(2θ). However, when launching from an elevated cliff or platform (y0 > 0), the optimal launch angle is always strictly LESS than 45°."
    },
    {
      "q": "How is the maximum apex height of a projectile calculated?",
      "a": "Maximum height occurs when the vertical velocity component reaches zero (vy = 0). The apex height formula is: H_max = y0 + [(v0 × sin(θ))² / (2g)], where y0 is initial launch elevation, v0 is muzzle speed, θ is launch angle, and g is gravitational acceleration (9.807 m/s² on Earth)."
    },
    {
      "q": "Why does horizontal velocity remain constant in vacuum projectile motion?",
      "a": "In ideal kinematics without atmospheric air resistance, gravity acts exclusively in the downward vertical axis (ay = -g). Because there is zero net force acting along the horizontal x-axis (ax = 0), horizontal velocity vx = v0 × cos(θ) remains perfectly constant throughout the entire flight."
    },
    {
      "q": "How does planetary gravity affect projectile range on the Moon or Mars?",
      "a": "Because range is inversely proportional to gravity [R ∝ (1/g)], lowering gravitational acceleration dramatically extends both flight time and horizontal distance. On the Moon (g = 1.62 m/s², roughly 1/6th Earth gravity), the exact same golf ball or baseball drive will travel approximately 6.05 times farther than on Earth."
    },
    {
      "q": "What is the formula for projectile time of flight with initial elevation?",
      "a": "When initial height y0 > 0, total flight time t is solved via the quadratic kinematic equation -½gt² + (v0 × sin(θ))t + y0 = 0, giving: t = [v0 × sin(θ) + √((v0 × sin(θ))² + 2gy0)] / g."
    }
  ],
  "body": "\n    <div class=\"article-container\" style=\"max-width: 1020px;\">\n      <nav style=\"font-family: var(--mono); font-size: 0.8rem; margin-bottom: 1.5rem; color: var(--text-muted);\">\n        <a href=\"/\">Home</a> &gt; <a href=\"/math/\">Math &amp; Science</a> &gt; Projectile Motion Calculator\n      </nav>\n\n      <header style=\"margin-bottom: 2rem;\">\n        <div style=\"display: flex; gap: 0.5rem; align-items: center; margin-bottom: 0.5rem; flex-wrap: wrap;\">\n          <span class=\"badge badge-purple\">Classical Kinematics</span>\n          <span class=\"badge badge-green\">Zero Server Uploads</span>\n          <span class=\"badge badge-blue\">Interactive Ballistic SVG</span>\n        </div>\n        <h1 style=\"font-family: var(--serif); font-size: 2.3rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          Projectile Motion &amp; Ballistic Trajectory Calculator\n        </h1>\n        <p style=\"color: var(--text-muted); font-size: 1.05rem; line-height: 1.6;\">\n          Simulate 2D projectile kinematics with arbitrary initial height, launch speed, angle, and planetary gravity. Calculates apex elevation, total flight time, horizontal range, and impact velocity with scalable vector trajectory plotting.\n        </p>\n      </header>\n\n      <!-- INPUTS BOX -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); padding: 1.75rem; border-radius: 8px; margin-bottom: 2rem;\">\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.25rem; margin-bottom: 1.5rem;\">\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Initial Velocity (v0):</label>\n            <div style=\"display: flex; gap: 0.5rem;\">\n              <input type=\"number\" id=\"proj-v0\" value=\"25\" min=\"0.1\" step=\"1\" style=\"width: 65%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcProjectile()\" />\n              <select id=\"proj-v0-unit\" style=\"width: 35%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.85rem;\" onchange=\"calcProjectile()\">\n                <option value=\"ms\" selected>m/s</option>\n                <option value=\"kmh\">km/h</option>\n                <option value=\"fps\">ft/s</option>\n                <option value=\"mph\">mph</option>\n              </select>\n            </div>\n          </div>\n\n          <div>\n            <div style=\"display: flex; justify-content: space-between; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">\n              <span>Launch Angle (θ):</span>\n              <span id=\"proj-angle-badge\" style=\"color: #6366f1; font-family: var(--mono);\">45°</span>\n            </div>\n            <input type=\"range\" id=\"proj-angle\" min=\"0\" max=\"90\" value=\"45\" step=\"1\" style=\"width: 100%;\" oninput=\"syncAngleSlider(this.value)\" />\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Initial Launch Height (y0):</label>\n            <div style=\"display: flex; gap: 0.5rem;\">\n              <input type=\"number\" id=\"proj-y0\" value=\"0\" min=\"0\" step=\"0.5\" style=\"width: 65%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcProjectile()\" />\n              <select id=\"proj-y0-unit\" style=\"width: 35%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.85rem;\" onchange=\"calcProjectile()\">\n                <option value=\"m\" selected>Meters</option>\n                <option value=\"ft\">Feet</option>\n              </select>\n            </div>\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Planetary Gravity (g):</label>\n            <select id=\"proj-gravity\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.95rem;\" onchange=\"calcProjectile()\">\n              <option value=\"9.80665\" selected>Earth (9.81 m/s²)</option>\n              <option value=\"1.62\">Moon (1.62 m/s² — 1/6g)</option>\n              <option value=\"3.72\">Mars (3.72 m/s² — 0.38g)</option>\n              <option value=\"24.79\">Jupiter (24.79 m/s² — 2.5g)</option>\n            </select>\n          </div>\n        </div>\n\n        <!-- MAIN KPI RESULT CARDS -->\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;\">\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #6366f1;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Total Horizontal Range</div>\n            <div id=\"proj-res-range\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #6366f1; margin-bottom: 0.2rem;\">63.73 m</div>\n            <div id=\"proj-res-range-ft\" style=\"font-size: 0.85rem; color: var(--text-muted);\">209.1 Feet</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #10b981;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Maximum Apex Height</div>\n            <div id=\"proj-res-apex\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #10b981; margin-bottom: 0.2rem;\">15.93 m</div>\n            <div id=\"proj-res-apex-ft\" style=\"font-size: 0.85rem; color: var(--text-muted);\">52.3 Feet (Peak Elevation)</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #3b82f6;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Total Flight Time</div>\n            <div id=\"proj-res-time\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #3b82f6; margin-bottom: 0.2rem;\">3.60 s</div>\n            <div id=\"proj-res-time-apex\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Apex reached at 1.80 s</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #f59e0b;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Impact Velocity</div>\n            <div id=\"proj-res-impact-v\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #f59e0b; margin-bottom: 0.2rem;\">25.00 m/s</div>\n            <div id=\"proj-res-impact-angle\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Impact Angle: -45.0°</div>\n          </div>\n        </div>\n      </div>\n\n      <!-- INTERACTIVE TRAJECTORY SVG -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.35rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          📈 Ballistic Parabolic Trajectory Curve\n        </h2>\n        <p style=\"font-size: 0.85rem; color: var(--text-muted); margin-bottom: 1.25rem;\">\n          Vector schematic drawn to exact mathematical scale showing initial launch vector, trajectory apex peak, and landing range coordinate.\n        </p>\n\n        <div style=\"overflow-x: auto;\">\n          <svg id=\"proj-traj-svg\" viewBox=\"0 0 800 280\" style=\"width: 100%; height: auto; min-width: 600px; font-family: var(--mono);\"></svg>\n        </div>\n      </div>\n\n      <!-- STEP-BY-STEP WORKED DERIVATION -->\n      <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h3 style=\"font-family: var(--mono); font-size: 0.9rem; text-transform: uppercase; color: var(--text-muted); margin: 0 0 0.75rem 0;\">\n          📐 Step-by-Step Classical Kinematics Derivations\n        </h3>\n        <div id=\"proj-derivation-box\" style=\"font-family: var(--mono); font-size: 0.85rem; line-height: 1.7; color: var(--fg);\">\n          Solving kinematic motion equations...\n        </div>\n      </div>\n\n      <!-- ONE-CLICK COPY BUTTON -->\n      <div style=\"margin-bottom: 2.5rem;\">\n        <button type=\"button\" id=\"proj-copy-btn\" onclick=\"copyProjectileReport(this)\" class=\"btn btn-copy\" style=\"display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; font-size: 0.9rem; font-weight: 600; background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; cursor: pointer; color: var(--fg); transition: all 0.15s ease;\">\n          <span>📋</span> Copy Trajectory Solution &amp; Flight Parameters\n        </button>\n      </div>\n\n      <!-- 5 FATAL TRAPS -->\n      <div style=\"margin: 2.5rem 0;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.45rem; margin-bottom: 0.75rem; color: var(--fg);\">\n          ⚠️ 5 Fatal Traps &amp; Physics Misunderstandings in Ballistics\n        </h2>\n        <div style=\"display: grid; grid-template-columns: 1fr; gap: 1rem;\">\n          <div class=\"trap-card\" style=\"border-left: 4px solid #ef4444;\">\n            <strong style=\"color: #ef4444;\">1. The \"45 Degrees is Always Maximum Range\" Fallacy</strong>\n            High school physics students memorize that 45° produces maximum range. This is true ONLY when launch height equals landing height ($y_0 = 0$). When throwing from a cliff, standing height, or aircraft ($y_0 > 0$), the optimal angle is strictly less than 45°: $\\theta = \\arcsin(1 / \\sqrt{2 + 2gy_0/v_0^2})$. In shot put (release height 2.1m), optimal launch angle is roughly 37°–38°.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #f59e0b;\">\n            <strong style=\"color: #f59e0b;\">2. Neglecting Aerodynamic Drag in Real-World Athletics</strong>\n            In baseball, golf, or artillery, atmospheric drag forces ($F_d = \\frac{1}{2}\\rho v^2 C_d A$) alter trajectories radically. A 100 mph baseball hit in a vacuum travels over 700 feet; with air drag and Magnus spin backspin, it travels roughly 400 feet and exhibits an asymmetric trajectory with a steep, abrupt terminal drop.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #10b981;\">\n            <strong style=\"color: #10b981;\">3. JavaScript Radians vs. Degrees Calculation Bug</strong>\n            JavaScript math functions (<code>Math.sin()</code>, <code>Math.cos()</code>) strictly expect angles in radians. Passing raw degrees without converting $\theta_{\text{rad}} = \theta_{\text{deg}} \times (pi / 180)$ generates nonsensical negative flight times and negative ranges.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #3b82f6;\">\n            <strong style=\"color: #3b82f6;\">4. Overlooking Kinetic Energy Transformation at Apex</strong>\n            At the trajectory apex, vertical velocity reaches zero ($v_y = 0$), but kinetic energy is NOT zero. The projectile still retains 100% of its horizontal kinetic energy: $E_k = \\frac{1}{2}m v_x^2 = \\frac{1}{2}m (v_0 \\cos\\theta)^2$. Only in a purely vertical 90° launch does kinetic energy drop to absolute zero at peak.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #8b5cf6;\">\n            <strong style=\"color: #8b5cf6;\">5. Coriolis Acceleration in Long-Range Ballistics (>1,000m)</strong>\n            For extreme long-range rifle shooting and naval artillery, Earth rotates beneath the projectile during its multi-second flight. In the Northern Hemisphere, the Coriolis acceleration deflects trajectories to the right by several inches to feet depending on target latitude and azimuth.\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <script>\n      function syncAngleSlider(val) {\n        document.getElementById('proj-angle-badge').textContent = val + '°';\n        calcProjectile();\n      }\n\n      function calcProjectile() {\n        var v0Raw = parseFloat(document.getElementById('proj-v0').value) || 25;\n        var v0Unit = document.getElementById('proj-v0-unit').value;\n        var angleDeg = parseFloat(document.getElementById('proj-angle').value) || 45;\n        var y0Raw = parseFloat(document.getElementById('proj-y0').value) || 0;\n        var y0Unit = document.getElementById('proj-y0-unit').value;\n        var g = parseFloat(document.getElementById('proj-gravity').value) || 9.80665;\n\n        // Convert v0 to m/s\n        var v0 = v0Raw;\n        if (v0Unit === 'kmh') v0 = v0Raw / 3.6;\n        else if (v0Unit === 'fps') v0 = v0Raw * 0.3048;\n        else if (v0Unit === 'mph') v0 = v0Raw * 0.44704;\n\n        // Convert y0 to meters\n        var y0 = y0Raw;\n        if (y0Unit === 'ft') y0 = y0Raw * 0.3048;\n\n        var rad = angleDeg * (Math.PI / 180);\n        var vx = v0 * Math.cos(rad);\n        var vy0 = v0 * Math.sin(rad);\n\n        // Time to apex\n        var tApex = vy0 / g;\n        // Apex height\n        var hApex = y0 + ((vy0 * vy0) / (2 * g));\n\n        // Total flight time: solve -0.5*g*t^2 + vy0*t + y0 = 0\n        // t = (vy0 + sqrt(vy0^2 + 2*g*y0)) / g\n        var discriminant = Math.max(0, (vy0 * vy0) + (2 * g * y0));\n        var totalTime = (vy0 + Math.sqrt(discriminant)) / g;\n\n        // Horizontal range\n        var range = vx * totalTime;\n\n        // Impact velocity components\n        var vyImpact = vy0 - (g * totalTime);\n        var vImpact = Math.sqrt((vx * vx) + (vyImpact * vyImpact));\n        var angleImpactRad = Math.atan2(vyImpact, vx);\n        var angleImpactDeg = angleImpactRad * (180 / Math.PI);\n\n        // Unit conversions for display\n        var rangeFt = range * 3.28084;\n        var apexFt = hApex * 3.28084;\n\n        // Update KPIs\n        document.getElementById('proj-res-range').textContent = range.toFixed(2) + ' m';\n        document.getElementById('proj-res-range-ft').textContent = rangeFt.toFixed(1) + ' Feet (' + (range / 1000).toFixed(3) + ' km)';\n\n        document.getElementById('proj-res-apex').textContent = hApex.toFixed(2) + ' m';\n        document.getElementById('proj-res-apex-ft').textContent = apexFt.toFixed(1) + ' Feet (Peak Elevation)';\n\n        document.getElementById('proj-res-time').textContent = totalTime.toFixed(2) + ' s';\n        document.getElementById('proj-res-time-apex').textContent = 'Apex reached at ' + tApex.toFixed(2) + ' s';\n\n        document.getElementById('proj-res-impact-v').textContent = vImpact.toFixed(2) + ' m/s';\n        document.getElementById('proj-res-impact-angle').textContent = 'Impact Angle: ' + angleImpactDeg.toFixed(1) + '° (' + (vImpact * 2.23694).toFixed(1) + ' mph)';\n\n        // Derivation Box\n        var dBox = document.getElementById('proj-derivation-box');\n        dBox.innerHTML = '<strong>1. Velocity Components:</strong> vx = ' + v0.toFixed(2) + ' × cos(' + angleDeg + '°) = <strong>' + vx.toFixed(2) + ' m/s</strong>; vy0 = ' + v0.toFixed(2) + ' × sin(' + angleDeg + '°) = <strong>' + vy0.toFixed(2) + ' m/s</strong>.<br>' +\n          '<strong>2. Peak Apex Height:</strong> y0 (' + y0.toFixed(2) + ') + (vy0² / 2g) = ' + y0.toFixed(2) + ' + (' + (vy0 * vy0).toFixed(2) + ' / ' + (2 * g).toFixed(2) + ') = <strong>' + hApex.toFixed(2) + ' m</strong> (' + apexFt.toFixed(1) + ' ft).<br>' +\n          '<strong>3. Quadratic Flight Time:</strong> [vy0 + √(vy0² + 2gy0)] / g = [' + vy0.toFixed(2) + ' + √' + discriminant.toFixed(2) + '] / ' + g.toFixed(2) + ' = <strong>' + totalTime.toFixed(2) + ' seconds</strong>.<br>' +\n          '<strong>4. Horizontal Range (R):</strong> vx × Total Time = ' + vx.toFixed(2) + ' m/s × ' + totalTime.toFixed(2) + ' s = <strong>' + range.toFixed(2) + ' m</strong> (' + rangeFt.toFixed(1) + ' ft).<br>' +\n          '<strong>5. Terminal Impact:</strong> Speed = √(' + vx.toFixed(1) + '² + ' + vyImpact.toFixed(1) + '²) = <strong>' + vImpact.toFixed(2) + ' m/s</strong> at ' + angleImpactDeg.toFixed(1) + '°.';\n\n        // Render SVG Trajectory\n        renderTrajectorySvg(range, hApex, y0, totalTime, vx, vy0, g);\n      }\n\n      function renderTrajectorySvg(R, H, y0, totalT, vx, vy0, g) {\n        var svg = document.getElementById('proj-traj-svg');\n        if (!svg) return;\n\n        var w = 800, h = 280;\n        var padL = 70, padR = 40, padT = 30, padB = 40;\n        var plotW = w - padL - padR;\n        var plotH = h - padT - padB;\n\n        var maxRange = Math.max(10, R * 1.15);\n        var maxHeight = Math.max(5, H * 1.25);\n\n        function toX(x) { return padL + ((x / maxRange) * plotW); }\n        function toY(y) { return (padT + plotH) - ((y / maxHeight) * plotH); }\n\n        var svgHtml = '';\n\n        // Axes & Ground\n        svgHtml += '<line x1=\"' + padL + '\" y1=\"' + (padT + plotH) + '\" x2=\"' + (padL + plotW) + '\" y2=\"' + (padT + plotH) + '\" stroke=\"var(--border)\" stroke-width=\"2\" />';\n        svgHtml += '<line x1=\"' + padL + '\" y1=\"' + padT + '\" x2=\"' + padL + '\" y2=\"' + (padT + plotH) + '\" stroke=\"var(--border)\" stroke-width=\"2\" />';\n\n        // Parabolic Points\n        var pts = [];\n        var numSteps = 50;\n        for (var i = 0; i <= numSteps; i++) {\n          var t = (i / numSteps) * totalT;\n          var x = vx * t;\n          var y = y0 + (vy0 * t) - (0.5 * g * t * t);\n          pts.push(toX(x).toFixed(1) + ',' + toY(y).toFixed(1));\n        }\n\n        var pathD = 'M ' + pts.join(' L ');\n        var polyArea = pathD + ' L ' + toX(R) + ' ' + toY(0) + ' L ' + toX(0) + ' ' + toY(0) + ' Z';\n\n        svgHtml += '<path d=\"' + polyArea + '\" fill=\"rgba(99, 102, 241, 0.12)\" stroke=\"none\" />';\n        svgHtml += '<path d=\"' + pathD + '\" fill=\"none\" stroke=\"#6366f1\" stroke-width=\"3\" />';\n\n        // Cliff platform if y0 > 0\n        if (y0 > 0) {\n          svgHtml += '<rect x=\"' + (padL - 25) + '\" y=\"' + toY(y0) + '\" width=\"25\" height=\"' + (toY(0) - toY(y0)) + '\" fill=\"#64748b\" opacity=\"0.5\" />';\n          svgHtml += '<text x=\"' + (padL - 30) + '\" y=\"' + ((toY(y0) + toY(0))/2 + 4) + '\" fill=\"var(--text-muted)\" font-size=\"10\" text-anchor=\"end\">y0=' + y0.toFixed(1) + 'm</text>';\n        }\n\n        // Apex marker\n        var xApex = vx * (vy0 / g);\n        var ax = toX(xApex);\n        var ay = toY(H);\n        svgHtml += '<circle cx=\"' + ax + '\" cy=\"' + ay + '\" r=\"5\" fill=\"#10b981\" stroke=\"#ffffff\" stroke-width=\"1.5\" />';\n        svgHtml += '<text x=\"' + ax + '\" y=\"' + (ay - 10) + '\" fill=\"#10b981\" font-size=\"11\" font-weight=\"bold\" text-anchor=\"middle\">Apex: ' + H.toFixed(1) + 'm</text>';\n\n        // Landing Impact marker\n        var lx = toX(R);\n        var ly = toY(0);\n        svgHtml += '<circle cx=\"' + lx + '\" cy=\"' + ly + '\" r=\"6\" fill=\"#ef4444\" stroke=\"#ffffff\" stroke-width=\"2\" />';\n        svgHtml += '<text x=\"' + lx + '\" y=\"' + (ly + 22) + '\" fill=\"#ef4444\" font-size=\"11\" font-weight=\"bold\" text-anchor=\"middle\">R = ' + R.toFixed(1) + 'm</text>';\n\n        // Ticks\n        svgHtml += '<text x=\"' + padL + '\" y=\"' + (padT + plotH + 20) + '\" fill=\"var(--text-muted)\" font-size=\"11\" text-anchor=\"middle\">0m</text>';\n        svgHtml += '<text x=\"' + (padL + plotW) + '\" y=\"' + (padT + plotH + 20) + '\" fill=\"var(--text-muted)\" font-size=\"11\" text-anchor=\"end\">' + maxRange.toFixed(0) + 'm</text>';\n\n        svg.innerHTML = svgHtml;\n      }\n\n      function copyProjectileReport(btn) {\n        var r = document.getElementById('proj-res-range').textContent;\n        var rft = document.getElementById('proj-res-range-ft').textContent;\n        var apex = document.getElementById('proj-res-apex').textContent;\n        var time = document.getElementById('proj-res-time').textContent;\n        var v0 = document.getElementById('proj-v0').value;\n        var ang = document.getElementById('proj-angle').value;\n        var impact = document.getElementById('proj-res-impact-v').textContent;\n\n        var text = '🚀 PROJECTILE MOTION & TRAJECTORY SOLUTION\\n' +\n          '====================================================\\n' +\n          '• Launch Velocity: ' + v0 + ' m/s @ ' + ang + '° Elevation\\n' +\n          '• Maximum Range: ' + r + ' (' + rft + ')\\n' +\n          '• Apex Height: ' + apex + '\\n' +\n          '• Total Flight Time: ' + time + '\\n' +\n          '• Final Impact Velocity: ' + impact + '\\n' +\n          '----------------------------------------------------\\n' +\n          'Calculated via Digital Tools Shed: https://digitaltoolsshed.com/math/projectile-motion-calculator';\n\n        navigator.clipboard.writeText(text).then(function() {\n          if (btn) {\n            var orig = btn.innerHTML;\n            btn.innerHTML = '<span>✓</span> Trajectory Solution Copied!';\n            btn.style.borderColor = '#10b981';\n            btn.style.color = '#10b981';\n            setTimeout(function() {\n              btn.innerHTML = orig;\n              btn.style.borderColor = 'var(--border)';\n              btn.style.color = 'var(--fg)';\n            }, 2000);\n          }\n        });\n      }\n\n      if (document.readyState === 'loading') {\n        document.addEventListener('DOMContentLoaded', calcProjectile);\n      } else {\n        calcProjectile();\n      }\n    </script>\n  "
},

{
  "slug": "triangle-calculator",
  "title": "Triangle Calculator — Law of Sines, Cosines, Area & Solver (SSS, SAS, ASA, AAS, SSA)",
  "metaDesc": "Solve triangles with any 3 known sides or angles. Calculates all sides, angles, area (Heron's formula), perimeter, semiperimeter, inradius, circumradius, and heights with interactive SVG diagram.",
  "category": "Math & Geometry",
  "faq": [
    {
      "q": "What is the Triangle Inequality Theorem?",
      "a": "The Triangle Inequality Theorem states that for any valid geometric triangle, the sum of the lengths of any two sides must be strictly greater than the length of the third side: a + b > c, a + c > b, and b + c > a. If the sum of two sides equals the third (a + b = c), the points are collinear, forming a degenerate straight line segment with zero area."
    },
    {
      "q": "What is the ambiguous case (SSA) in trigonometry?",
      "a": "The SSA (Side-Side-Angle) condition occurs when given two sides and an angle opposite one of them. Depending on the altitude h = b × sin(A), there may be: 0 triangles (if a < h), exactly 1 right triangle (if a = h), 2 distinct valid triangles (if h < a < b, one acute and one obtuse), or 1 triangle (if a >= b)."
    },
    {
      "q": "How does Heron's formula calculate triangle area without knowing height?",
      "a": "Heron's formula computes area using only the three side lengths: Area = √[s(s - a)(s - b)(s - c)], where s is the semi-perimeter: s = (a + b + c) / 2. This eliminates the need to calculate perpendicular altitudes or interior angles."
    },
    {
      "q": "What is the difference between the Incircle and Circumcircle of a triangle?",
      "a": "The incircle is the largest circle that fits entirely inside the triangle, tangent to all three sides, with inradius r = Area / s. The circumcircle is the unique circle that passes through all three vertices of the triangle, with circumradius R = (a × b × c) / (4 × Area)."
    },
    {
      "q": "When should you use the Law of Cosines versus the Law of Sines?",
      "a": "Use the Law of Cosines [c² = a² + b² - 2ab × cos(C)] when you know all three sides (SSS) or two sides and the included angle (SAS). Use the Law of Sines [a/sin(A) = b/sin(B) = c/sin(C)] when you know two angles and any side (AAS or ASA), or in the ambiguous case (SSA)."
    }
  ],
  "body": "\n    <div class=\"article-container\" style=\"max-width: 1020px;\">\n      <nav style=\"font-family: var(--mono); font-size: 0.8rem; margin-bottom: 1.5rem; color: var(--text-muted);\">\n        <a href=\"/\">Home</a> &gt; <a href=\"/math/\">Math &amp; Geometry</a> &gt; Triangle Calculator\n      </nav>\n\n      <header style=\"margin-bottom: 2rem;\">\n        <div style=\"display: flex; gap: 0.5rem; align-items: center; margin-bottom: 0.5rem; flex-wrap: wrap;\">\n          <span class=\"badge badge-purple\">Geometry &amp; Trigonometry</span>\n          <span class=\"badge badge-green\">Law of Sines &amp; Cosines</span>\n          <span class=\"badge badge-blue\">Zero Server Uploads</span>\n        </div>\n        <h1 style=\"font-family: var(--serif); font-size: 2.3rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          Triangle Calculator &amp; Universal Trigonometric Solver\n        </h1>\n        <p style=\"color: var(--text-muted); font-size: 1.05rem; line-height: 1.6;\">\n          Solve any triangle with 3 known values (SSS, SAS, ASA, AAS, SSA). Computes all missing sides, interior angles, area (Heron's formula), perimeter, inradius, circumradius, and altitudes with an interactive scalable vector diagram.\n        </p>\n      </header>\n\n      <!-- SOLVER INPUT BOX -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); padding: 1.75rem; border-radius: 8px; margin-bottom: 2rem;\">\n        <div style=\"display: flex; gap: 0.5rem; margin-bottom: 1.5rem; flex-wrap: wrap;\">\n          <button type=\"button\" id=\"tri-tab-sss\" onclick=\"setTriMode('sss')\" style=\"padding: 0.55rem 1rem; border-radius: 6px; font-weight: 600; font-size: 0.85rem; cursor: pointer; background: #6366f1; color: #fff; border: 1px solid #6366f1;\">\n            1. SSS (3 Sides)\n          </button>\n          <button type=\"button\" id=\"tri-tab-sas\" onclick=\"setTriMode('sas')\" style=\"padding: 0.55rem 1rem; border-radius: 6px; font-weight: 600; font-size: 0.85rem; cursor: pointer; background: var(--surface-alt); color: var(--fg); border: 1px solid var(--border);\">\n            2. SAS (Side-Angle-Side)\n          </button>\n          <button type=\"button\" id=\"tri-tab-asa\" onclick=\"setTriMode('asa')\" style=\"padding: 0.55rem 1rem; border-radius: 6px; font-weight: 600; font-size: 0.85rem; cursor: pointer; background: var(--surface-alt); color: var(--fg); border: 1px solid var(--border);\">\n            3. ASA (Angle-Side-Angle)\n          </button>\n          <button type=\"button\" id=\"tri-tab-aas\" onclick=\"setTriMode('aas')\" style=\"padding: 0.55rem 1rem; border-radius: 6px; font-weight: 600; font-size: 0.85rem; cursor: pointer; background: var(--surface-alt); color: var(--fg); border: 1px solid var(--border);\">\n            4. AAS (Angle-Angle-Side)\n          </button>\n          <button type=\"button\" id=\"tri-tab-ssa\" onclick=\"setTriMode('ssa')\" style=\"padding: 0.55rem 1rem; border-radius: 6px; font-weight: 600; font-size: 0.85rem; cursor: pointer; background: var(--surface-alt); color: var(--fg); border: 1px solid var(--border);\">\n            5. SSA (Ambiguous Case)\n          </button>\n        </div>\n\n        <!-- INPUT FIELDS -->\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.25rem; margin-bottom: 1.5rem;\">\n          <div>\n            <label id=\"tri-lbl-1\" style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Side a:</label>\n            <input type=\"number\" id=\"tri-val-1\" value=\"7\" min=\"0.1\" step=\"0.5\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcTriangle()\" />\n          </div>\n\n          <div>\n            <label id=\"tri-lbl-2\" style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Side b:</label>\n            <input type=\"number\" id=\"tri-val-2\" value=\"9\" min=\"0.1\" step=\"0.5\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcTriangle()\" />\n          </div>\n\n          <div>\n            <label id=\"tri-lbl-3\" style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Side c:</label>\n            <input type=\"number\" id=\"tri-val-3\" value=\"12\" min=\"0.1\" step=\"0.5\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcTriangle()\" />\n          </div>\n        </div>\n\n        <!-- ERROR OR WARNING BANNER -->\n        <div id=\"tri-error-banner\" style=\"display: none; background: rgba(239, 68, 68, 0.1); border-left: 4px solid #ef4444; padding: 0.85rem 1rem; border-radius: 0 4px 4px 0; font-size: 0.85rem; color: #ef4444; margin-bottom: 1.25rem;\">\n          <!-- Populated by JS -->\n        </div>\n\n        <!-- KPI RESULT CARDS -->\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;\">\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #6366f1;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Triangle Area</div>\n            <div id=\"tri-res-area\" style=\"font-family: var(--mono); font-size: 2.1rem; font-weight: bold; color: #6366f1; margin-bottom: 0.2rem;\">31.30</div>\n            <div id=\"tri-res-heron\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Heron's Formula</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #10b981;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Perimeter (P)</div>\n            <div id=\"tri-res-perim\" style=\"font-family: var(--mono); font-size: 2.1rem; font-weight: bold; color: #10b981; margin-bottom: 0.2rem;\">28.00</div>\n            <div id=\"tri-res-semi\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Semi-perimeter s = 14.00</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #3b82f6;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Classification</div>\n            <div id=\"tri-res-type\" style=\"font-family: var(--mono); font-size: 1.4rem; font-weight: bold; color: #3b82f6; margin-bottom: 0.2rem;\">Scalene / Obtuse</div>\n            <div id=\"tri-res-angles-summary\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Angles sum to 180.0°</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #f59e0b;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Inradius (r) &amp; Circumradius (R)</div>\n            <div id=\"tri-res-radii\" style=\"font-family: var(--mono); font-size: 1.5rem; font-weight: bold; color: #f59e0b; margin-bottom: 0.2rem;\">r = 2.24 | R = 6.04</div>\n            <div style=\"font-size: 0.85rem; color: var(--text-muted);\">Inscribed &amp; Circumscribed circles</div>\n          </div>\n        </div>\n      </div>\n\n      <!-- INTERACTIVE SCALABLE SVG TRIANGLE DIAGRAM -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <div style=\"display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem; flex-wrap: wrap;\">\n          <h2 style=\"font-family: var(--serif); font-size: 1.35rem; margin: 0; color: var(--fg);\">\n            📐 Dynamic Scale Geometry Diagram\n          </h2>\n          <div style=\"display: flex; gap: 1rem; font-size: 0.85rem; color: var(--text-muted);\">\n            <label><input type=\"checkbox\" id=\"tri-chk-incircle\" onchange=\"calcTriangle()\" /> Show Incircle</label>\n            <label><input type=\"checkbox\" id=\"tri-chk-circumcircle\" onchange=\"calcTriangle()\" /> Show Circumcircle</label>\n            <label><input type=\"checkbox\" id=\"tri-chk-altitude\" onchange=\"calcTriangle()\" checked /> Show Altitude</label>\n          </div>\n        </div>\n        <p style=\"font-size: 0.85rem; color: var(--text-muted); margin-bottom: 1.25rem;\">\n          Vector schematic drawn to exact mathematical scale showing vertex angles, side lengths, and interior geometry.\n        </p>\n\n        <div style=\"overflow-x: auto; text-align: center;\">\n          <svg id=\"tri-diagram-svg\" viewBox=\"0 0 700 320\" style=\"max-width: 700px; width: 100%; height: auto; font-family: var(--mono);\"></svg>\n        </div>\n      </div>\n\n      <!-- FULL PROPERTIES TABLE -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h3 style=\"font-family: var(--serif); font-size: 1.25rem; margin-top: 0; margin-bottom: 1rem; color: var(--fg);\">\n          🔢 Complete Solved Triangle Metrics\n        </h3>\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem;\">\n          <div>\n            <h4 style=\"font-size: 0.9rem; margin: 0 0 0.5rem 0; color: var(--text-muted); text-transform: uppercase;\">Sides &amp; Angles</h4>\n            <div style=\"background: var(--bg); border: 1px solid var(--border); border-radius: 6px; padding: 0.75rem; font-family: var(--mono); font-size: 0.85rem; line-height: 1.8;\">\n              <div>Side a: <strong id=\"tri-side-a\">7.000</strong></div>\n              <div>Side b: <strong id=\"tri-side-b\">9.000</strong></div>\n              <div>Side c: <strong id=\"tri-side-c\">12.000</strong></div>\n              <div style=\"border-top: 1px solid var(--border); margin-top: 0.3rem; padding-top: 0.3rem;\">Angle A (α): <strong id=\"tri-ang-a\">35.43°</strong> (<span id=\"tri-rad-a\">0.618 rad</span>)</div>\n              <div>Angle B (β): <strong id=\"tri-ang-b\">48.19°</strong> (<span id=\"tri-rad-b\">0.841 rad</span>)</div>\n              <div>Angle C (γ): <strong id=\"tri-ang-c\">96.38°</strong> (<span id=\"tri-rad-c\">1.682 rad</span>)</div>\n            </div>\n          </div>\n\n          <div>\n            <h4 style=\"font-size: 0.9rem; margin: 0 0 0.5rem 0; color: var(--text-muted); text-transform: uppercase;\">Altitudes &amp; Medians</h4>\n            <div style=\"background: var(--bg); border: 1px solid var(--border); border-radius: 6px; padding: 0.75rem; font-family: var(--mono); font-size: 0.85rem; line-height: 1.8;\">\n              <div>Altitude h_a: <strong id=\"tri-alt-a\">8.94</strong></div>\n              <div>Altitude h_b: <strong id=\"tri-alt-b\">6.96</strong></div>\n              <div>Altitude h_c: <strong id=\"tri-alt-c\">5.22</strong></div>\n              <div style=\"border-top: 1px solid var(--border); margin-top: 0.3rem; padding-top: 0.3rem;\">Inradius (r): <strong id=\"tri-val-inradius\">2.24</strong></div>\n              <div>Circumradius (R): <strong id=\"tri-val-circumradius\">6.04</strong></div>\n              <div>Area / Perimeter Ratio: <strong id=\"tri-val-ratio\">1.12</strong></div>\n            </div>\n          </div>\n        </div>\n      </div>\n\n      <!-- WORKED DERIVATION BOX -->\n      <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h3 style=\"font-family: var(--mono); font-size: 0.9rem; text-transform: uppercase; color: var(--text-muted); margin: 0 0 0.75rem 0;\">\n          📐 Step-by-Step Trigonometric &amp; Heron's Derivations\n        </h3>\n        <div id=\"tri-derivation-box\" style=\"font-family: var(--mono); font-size: 0.85rem; line-height: 1.7; color: var(--fg);\">\n          Solving triangle equations...\n        </div>\n      </div>\n\n      <!-- ONE-CLICK COPY BUTTON -->\n      <div style=\"margin-bottom: 2.5rem;\">\n        <button type=\"button\" id=\"tri-copy-btn\" onclick=\"copyTriangleReport(this)\" class=\"btn btn-copy\" style=\"display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; font-size: 0.9rem; font-weight: 600; background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; cursor: pointer; color: var(--fg); transition: all 0.15s ease;\">\n          <span>📋</span> Copy Full Triangle Solution &amp; Properties\n        </button>\n      </div>\n\n      <!-- 5 FATAL TRAPS -->\n      <div style=\"margin: 2.5rem 0;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.45rem; margin-bottom: 0.75rem; color: var(--fg);\">\n          ⚠️ 5 Fatal Traps &amp; Geometric Ambiguity Pitfalls\n        </h2>\n        <div style=\"display: grid; grid-template-columns: 1fr; gap: 1rem;\">\n          <div class=\"trap-card\" style=\"border-left: 4px solid #ef4444;\">\n            <strong style=\"color: #ef4444;\">1. The SSA (Side-Side-Angle) Ambiguous Case Catastrophe</strong>\n            When given two sides and a non-included angle, blind calculators often return only a single solution. If the opposite side $a$ is shorter than adjacent side $b$ but longer than the perpendicular altitude ($b \\sin A < a < b$), TWO completely valid, geometrically distinct triangles exist—one acute and one obtuse. Ignoring the second solution leads to catastrophic engineering errors in surveying and truss design.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #f59e0b;\">\n            <strong style=\"color: #f59e0b;\">2. The Triangle Inequality Violation</strong>\n            Three positive numbers do not automatically make a triangle. By Euclid's Triangle Inequality Theorem, the sum of any two sides must strictly exceed the third ($a + b > c$). Attempting to construct a triangle with sides 4, 6, and 12 is mathematically impossible because the two shorter lengths cannot bridge the gap.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #10b981;\">\n            <strong style=\"color: #10b981;\">3. IEEE-754 Floating-Point Arccosine Domain Crash (NaN)</strong>\n            In digital computation, rounding inaccuracies in the Law of Cosines can calculate cos(C) as 1.0000000000000002 for near-collinear triangles. Because Math.acos() is mathematically defined strictly on the interval [-1, 1], an unclamped value instantly returns NaN and crashes client-side scripts. Clamping via Math.min(1, Math.max(-1, cosVal)) is mandatory.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #3b82f6;\">\n            <strong style=\"color: #3b82f6;\">4. Degree vs. Radian Conversion Mismatch</strong>\n            JavaScript native Math.sin(), Math.cos(), and Math.tan() functions accept angles solely in radians, while human users almost universally input degrees. Forgetting to multiply degrees by (π / 180) or forgetting to convert inverse trigonometric outputs back via (180 / π) produces completely chaotic geometric dimensions.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #8b5cf6;\">\n            <strong style=\"color: #8b5cf6;\">5. The Law of Sines Obtuse Angle Blindspot</strong>\n            The inverse sine function arcsin(x) only returns values between -90° and +90°. If a triangle possesses an obtuse angle (&gt; 90°), using the Law of Sines to solve for that largest angle will falsely return its acute supplement (180° - θ). The Law of Cosines must always be used to solve for the largest angle first because arccosine uniquely spans 0° to 180°.\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <script>\n      var curTriMode = 'sss';\n\n      function setTriMode(mode) {\n        curTriMode = mode;\n        var tabs = ['sss', 'sas', 'asa', 'aas', 'ssa'];\n        tabs.forEach(function(t) {\n          var btn = document.getElementById('tri-tab-' + t);\n          if (t === mode) {\n            btn.style.background = '#6366f1';\n            btn.style.color = '#fff';\n            btn.style.borderColor = '#6366f1';\n          } else {\n            btn.style.background = 'var(--surface-alt)';\n            btn.style.color = 'var(--fg)';\n            btn.style.borderColor = 'var(--border)';\n          }\n        });\n\n        var l1 = document.getElementById('tri-lbl-1');\n        var l2 = document.getElementById('tri-lbl-2');\n        var l3 = document.getElementById('tri-lbl-3');\n        var v1 = document.getElementById('tri-val-1');\n        var v2 = document.getElementById('tri-val-2');\n        var v3 = document.getElementById('tri-val-3');\n\n        if (mode === 'sss') {\n          l1.textContent = 'Side a:'; v1.value = 7;\n          l2.textContent = 'Side b:'; v2.value = 9;\n          l3.textContent = 'Side c:'; v3.value = 12;\n        } else if (mode === 'sas') {\n          l1.textContent = 'Side a:'; v1.value = 8;\n          l2.textContent = 'Included Angle C (°):'; v2.value = 65;\n          l3.textContent = 'Side b:'; v3.value = 11;\n        } else if (mode === 'asa') {\n          l1.textContent = 'Angle A (°):'; v1.value = 45;\n          l2.textContent = 'Included Side c:'; v2.value = 10;\n          l3.textContent = 'Angle B (°):'; v3.value = 60;\n        } else if (mode === 'aas') {\n          l1.textContent = 'Angle A (°):'; v1.value = 40;\n          l2.textContent = 'Angle B (°):'; v2.value = 75;\n          l3.textContent = 'Non-included Side a:'; v3.value = 8;\n        } else if (mode === 'ssa') {\n          l1.textContent = 'Side a:'; v1.value = 8;\n          l2.textContent = 'Side b:'; v2.value = 10;\n          l3.textContent = 'Opposite Angle A (°):'; v3.value = 42;\n        }\n\n        calcTriangle();\n      }\n\n      function toRad(deg) { return deg * (Math.PI / 180); }\n      function toDeg(rad) { return rad * (180 / Math.PI); }\n      function clamp(val, min, max) { return Math.min(max, Math.max(min, val)); }\n\n      function calcTriangle() {\n        var v1 = parseFloat(document.getElementById('tri-val-1').value) || 0;\n        var v2 = parseFloat(document.getElementById('tri-val-2').value) || 0;\n        var v3 = parseFloat(document.getElementById('tri-val-3').value) || 0;\n\n        var errBanner = document.getElementById('tri-error-banner');\n        errBanner.style.display = 'none';\n\n        var a = 0, b = 0, c = 0;\n        var A = 0, B = 0, C = 0; // Angles in degrees\n        var isValid = true;\n        var errorMsg = '';\n\n        if (curTriMode === 'sss') {\n          a = v1; b = v2; c = v3;\n          if (a <= 0 || b <= 0 || c <= 0) {\n            isValid = false;\n            errorMsg = 'All side lengths must be positive numbers greater than zero.';\n          } else if (a + b <= c || a + c <= b || b + c <= a) {\n            isValid = false;\n            errorMsg = 'Triangle Inequality Violation: The sum of any two sides must exceed the third side (' + a + ' + ' + b + ' vs ' + c + ').';\n          } else {\n            var cosA = clamp((b*b + c*c - a*a) / (2 * b * c), -1, 1);\n            var cosB = clamp((a*a + c*c - b*b) / (2 * a * c), -1, 1);\n            var cosC = clamp((a*a + b*b - c*c) / (2 * a * b), -1, 1);\n            A = toDeg(Math.acos(cosA));\n            B = toDeg(Math.acos(cosB));\n            C = toDeg(Math.acos(cosC));\n          }\n        } else if (curTriMode === 'sas') {\n          a = v1; C = v2; b = v3;\n          if (a <= 0 || b <= 0 || C <= 0 || C >= 180) {\n            isValid = false;\n            errorMsg = 'Sides must be > 0 and the included angle must be strictly between 0° and 180°.';\n          } else {\n            var cSq = a*a + b*b - 2*a*b*Math.cos(toRad(C));\n            c = Math.sqrt(Math.max(0.0001, cSq));\n            var cosA = clamp((b*b + c*c - a*a) / (2 * b * c), -1, 1);\n            A = toDeg(Math.acos(cosA));\n            B = 180 - A - C;\n          }\n        } else if (curTriMode === 'asa') {\n          A = v1; c = v2; B = v3;\n          if (c <= 0 || A <= 0 || B <= 0 || A + B >= 180) {\n            isValid = false;\n            errorMsg = 'Side must be > 0 and the sum of angles A + B must be strictly less than 180°.';\n          } else {\n            C = 180 - A - B;\n            a = c * (Math.sin(toRad(A)) / Math.sin(toRad(C)));\n            b = c * (Math.sin(toRad(B)) / Math.sin(toRad(C)));\n          }\n        } else if (curTriMode === 'aas') {\n          A = v1; B = v2; a = v3;\n          if (a <= 0 || A <= 0 || B <= 0 || A + B >= 180) {\n            isValid = false;\n            errorMsg = 'Side must be > 0 and the sum of angles A + B must be strictly less than 180°.';\n          } else {\n            C = 180 - A - B;\n            b = a * (Math.sin(toRad(B)) / Math.sin(toRad(A)));\n            c = a * (Math.sin(toRad(C)) / Math.sin(toRad(A)));\n          }\n        } else if (curTriMode === 'ssa') {\n          a = v1; b = v2; A = v3;\n          if (a <= 0 || b <= 0 || A <= 0 || A >= 180) {\n            isValid = false;\n            errorMsg = 'Sides must be > 0 and Angle A must be between 0° and 180°.';\n          } else {\n            var h = b * Math.sin(toRad(A));\n            if (a < h) {\n              isValid = false;\n              errorMsg = 'SSA No Triangle: Side a (' + a + ') is shorter than altitude h = b × sin(A) (' + h.toFixed(2) + '). The side cannot reach the base.';\n            } else {\n              var sinB = (b * Math.sin(toRad(A))) / a;\n              sinB = clamp(sinB, -1, 1);\n              B = toDeg(Math.asin(sinB));\n              C = 180 - A - B;\n              c = a * (Math.sin(toRad(C)) / Math.sin(toRad(A)));\n\n              if (h < a && a < b && A < 90) {\n                errorMsg = '⚡ Ambiguous Case Note: Two distinct triangles exist for these parameters. Displaying acute solution (B = ' + B.toFixed(1) + '°). Obtuse alternate has B = ' + (180 - B).toFixed(1) + '°.';\n                errBanner.style.background = 'rgba(245, 158, 11, 0.1)';\n                errBanner.style.borderColor = '#f59e0b';\n                errBanner.style.color = '#f59e0b';\n                errBanner.textContent = errorMsg;\n                errBanner.style.display = 'block';\n              }\n            }\n          }\n        }\n\n        if (!isValid) {\n          errBanner.style.background = 'rgba(239, 68, 68, 0.1)';\n          errBanner.style.borderColor = '#ef4444';\n          errBanner.style.color = '#ef4444';\n          errBanner.textContent = errorMsg;\n          errBanner.style.display = 'block';\n          return;\n        }\n\n        // Area & Perimeter\n        var perimeter = a + b + c;\n        var s = perimeter / 2;\n        var area = Math.sqrt(Math.max(0, s * (s - a) * (s - b) * (s - c)));\n\n        // Altitudes\n        var ha = a > 0 ? (2 * area) / a : 0;\n        var hb = b > 0 ? (2 * area) / b : 0;\n        var hc = c > 0 ? (2 * area) / c : 0;\n\n        // Inradius & Circumradius\n        var inradius = s > 0 ? (area / s) : 0;\n        var circumradius = area > 0 ? (a * b * c) / (4 * area) : 0;\n\n        // Classification\n        var sideType = 'Scalene';\n        if (Math.abs(a - b) < 0.001 && Math.abs(b - c) < 0.001) sideType = 'Equilateral';\n        else if (Math.abs(a - b) < 0.001 || Math.abs(b - c) < 0.001 || Math.abs(a - c) < 0.001) sideType = 'Isosceles';\n\n        var angleType = 'Acute';\n        var maxAng = Math.max(A, B, C);\n        if (Math.abs(maxAng - 90) < 0.05) angleType = 'Right';\n        else if (maxAng > 90.05) angleType = 'Obtuse';\n\n        // Update KPIs\n        document.getElementById('tri-res-area').textContent = area.toFixed(2);\n        document.getElementById('tri-res-perim').textContent = perimeter.toFixed(2);\n        document.getElementById('tri-res-semi').textContent = 'Semi-perimeter s = ' + s.toFixed(2);\n        document.getElementById('tri-res-type').textContent = sideType + ' / ' + angleType;\n        document.getElementById('tri-res-radii').textContent = 'r = ' + inradius.toFixed(2) + ' | R = ' + circumradius.toFixed(2);\n\n        // Update Table\n        document.getElementById('tri-side-a').textContent = a.toFixed(3);\n        document.getElementById('tri-side-b').textContent = b.toFixed(3);\n        document.getElementById('tri-side-c').textContent = c.toFixed(3);\n\n        document.getElementById('tri-ang-a').textContent = A.toFixed(2) + '°';\n        document.getElementById('tri-ang-b').textContent = B.toFixed(2) + '°';\n        document.getElementById('tri-ang-c').textContent = C.toFixed(2) + '°';\n\n        document.getElementById('tri-rad-a').textContent = toRad(A).toFixed(3) + ' rad';\n        document.getElementById('tri-rad-b').textContent = toRad(B).toFixed(3) + ' rad';\n        document.getElementById('tri-rad-c').textContent = toRad(C).toFixed(3) + ' rad';\n\n        document.getElementById('tri-alt-a').textContent = ha.toFixed(2);\n        document.getElementById('tri-alt-b').textContent = hb.toFixed(2);\n        document.getElementById('tri-alt-c').textContent = hc.toFixed(2);\n\n        document.getElementById('tri-val-inradius').textContent = inradius.toFixed(2);\n        document.getElementById('tri-val-circumradius').textContent = circumradius.toFixed(2);\n        document.getElementById('tri-val-ratio').textContent = (perimeter > 0 ? (area / perimeter).toFixed(2) : '0');\n\n        // Derivation Box\n        var dBox = document.getElementById('tri-derivation-box');\n        dBox.innerHTML = '<strong>1. Sides Evaluated:</strong> a = ' + a.toFixed(2) + ', b = ' + b.toFixed(2) + ', c = ' + c.toFixed(2) + '.<br>' +\n          '<strong>2. Perimeter & Semi-Perimeter:</strong> P = a + b + c = ' + perimeter.toFixed(2) + '; s = P / 2 = <strong>' + s.toFixed(2) + '</strong>.<br>' +\n          '<strong>3. Heron\\'s Area Formula:</strong> √[' + s.toFixed(1) + ' × (' + (s-a).toFixed(1) + ') × (' + (s-b).toFixed(1) + ') × (' + (s-c).toFixed(1) + ')] = <strong>' + area.toFixed(2) + '</strong>.<br>' +\n          '<strong>4. Interior Angles:</strong> ∠A = ' + A.toFixed(2) + '°, ∠B = ' + B.toFixed(2) + '°, ∠C = ' + C.toFixed(2) + '° (Sum = ' + (A+B+C).toFixed(1) + '°).<br>' +\n          '<strong>5. Inscribed & Circumscribed Radii:</strong> Inradius r = Area / s = ' + inradius.toFixed(2) + '; Circumradius R = abc / (4 × Area) = <strong>' + circumradius.toFixed(2) + '</strong>.';\n\n        // Render Scale Diagram\n        renderTriangleSvg(a, b, c, A, B, C, inradius, circumradius, ha);\n      }\n\n      function renderTriangleSvg(a, b, c, A, B, C, inr, cirR, ha) {\n        var svg = document.getElementById('tri-diagram-svg');\n        if (!svg) return;\n\n        var showIn = document.getElementById('tri-chk-incircle').checked;\n        var showCirc = document.getElementById('tri-chk-circumcircle').checked;\n        var showAlt = document.getElementById('tri-chk-altitude').checked;\n\n        var svgW = 700, svgH = 320;\n        var pad = 50;\n\n        // Place side c along the bottom\n        // Vertex A at (x1, y1), Vertex B at (x2, y2), Vertex C at (x3, y3)\n        // A is at origin (0, 0), B is at (c, 0)\n        // C is at (b * cos(A), b * sin(A))\n        var radA = toRad(A);\n        var pAx = 0, pAy = 0;\n        var pBx = c, pBy = 0;\n        var pCx = b * Math.cos(radA), pCy = b * Math.sin(radA);\n\n        var minX = Math.min(pAx, pBx, pCx);\n        var maxX = Math.max(pAx, pBx, pCx);\n        var minY = Math.min(pAy, pBy, pCy);\n        var maxY = Math.max(pAy, pBy, pCy);\n\n        var spanX = Math.max(0.1, maxX - minX);\n        var spanY = Math.max(0.1, maxY - minY);\n\n        var scale = Math.min((svgW - (pad * 2)) / spanX, (svgH - (pad * 2)) / spanY);\n\n        function mapX(x) { return pad + ((x - minX) * scale); }\n        function mapY(y) { return (svgH - pad) - ((y - minY) * scale); }\n\n        var Ax = mapX(pAx), Ay = mapY(pAy);\n        var Bx = mapX(pBx), By = mapY(pBy);\n        var Cx = mapX(pCx), Cy = mapY(pCy);\n\n        var svgHtml = '';\n\n        // Circumcircle\n        if (showCirc && cirR > 0) {\n          // Circumcenter in triangle coords\n          var D = 2 * (pAx * (pBy - pCy) + pBx * (pCy - pAy) + pCx * (pAy - pBy));\n          if (Math.abs(D) > 0.001) {\n            var ccX = ((pAx*pAx + pAy*pAy)*(pBy - pCy) + (pBx*pBx + pBy*pBy)*(pCy - pAy) + (pCx*pCx + pCy*pCy)*(pAy - pBy)) / D;\n            var ccY = ((pAx*pAx + pAy*pAy)*(pCx - pBx) + (pBx*pBx + pBy*pBy)*(pAx - pCx) + (pCx*pCx + pCy*pCy)*(pBx - pAx)) / D;\n            svgHtml += '<circle cx=\"' + mapX(ccX) + '\" cy=\"' + mapY(ccY) + '\" r=\"' + (cirR * scale) + '\" fill=\"none\" stroke=\"#3b82f6\" stroke-width=\"1.5\" stroke-dasharray=\"4,3\" opacity=\"0.6\"><title>Circumcircle R = ' + cirR.toFixed(2) + '</title></circle>';\n          }\n        }\n\n        // Incircle\n        if (showIn && inr > 0) {\n          var per = a + b + c;\n          var inX = (a * pAx + b * pBx + c * pCx) / per;\n          var inY = (a * pAy + b * pBy + c * pCy) / per;\n          svgHtml += '<circle cx=\"' + mapX(inX) + '\" cy=\"' + mapY(inY) + '\" r=\"' + (inr * scale) + '\" fill=\"none\" stroke=\"#10b981\" stroke-width=\"1.5\" stroke-dasharray=\"4,3\" opacity=\"0.7\"><title>Incircle r = ' + inr.toFixed(2) + '</title></circle>';\n        }\n\n        // Altitude from C to base AB\n        if (showAlt) {\n          var altFootX = mapX(pCx);\n          var altFootY = mapY(0);\n          svgHtml += '<line x1=\"' + Cx + '\" y1=\"' + Cy + '\" x2=\"' + altFootX + '\" y2=\"' + altFootY + '\" stroke=\"#ef4444\" stroke-width=\"1.5\" stroke-dasharray=\"3,3\" />';\n          svgHtml += '<text x=\"' + (altFootX + 8) + '\" y=\"' + ((Cy + altFootY)/2) + '\" fill=\"#ef4444\" font-size=\"11\">h = ' + ha.toFixed(1) + '</text>';\n        }\n\n        // Triangle Polygon\n        var poly = Ax + ',' + Ay + ' ' + Bx + ',' + By + ' ' + Cx + ',' + Cy;\n        svgHtml += '<polygon points=\"' + poly + '\" fill=\"rgba(99, 102, 241, 0.12)\" stroke=\"#6366f1\" stroke-width=\"3\" />';\n\n        // Vertices\n        [[Ax, Ay, 'A (' + A.toFixed(1) + '°)', -10, 16], [Bx, By, 'B (' + B.toFixed(1) + '°)', 10, 16], [Cx, Cy, 'C (' + C.toFixed(1) + '°)', 0, -12]].forEach(function(pt) {\n          svgHtml += '<circle cx=\"' + pt[0] + '\" cy=\"' + pt[1] + '\" r=\"5\" fill=\"#6366f1\" />';\n          svgHtml += '<text x=\"' + (pt[0] + pt[3]) + '\" y=\"' + (pt[1] + pt[4]) + '\" fill=\"var(--fg)\" font-size=\"12\" font-weight=\"bold\" text-anchor=\"middle\">' + pt[2] + '</text>';\n        });\n\n        // Side Labels\n        svgHtml += '<text x=\"' + ((Ax + Bx)/2) + '\" y=\"' + (Ay + 18) + '\" fill=\"var(--text-muted)\" font-size=\"12\" font-weight=\"bold\" text-anchor=\"middle\">c = ' + c.toFixed(1) + '</text>';\n        svgHtml += '<text x=\"' + ((Bx + Cx)/2 + 15) + '\" y=\"' + ((By + Cy)/2) + '\" fill=\"var(--text-muted)\" font-size=\"12\" font-weight=\"bold\" text-anchor=\"start\">a = ' + a.toFixed(1) + '</text>';\n        svgHtml += '<text x=\"' + ((Ax + Cx)/2 - 15) + '\" y=\"' + ((Ay + Cy)/2) + '\" fill=\"var(--text-muted)\" font-size=\"12\" font-weight=\"bold\" text-anchor=\"end\">b = ' + b.toFixed(1) + '</text>';\n\n        svg.innerHTML = svgHtml;\n      }\n\n      function copyTriangleReport(btn) {\n        var a = document.getElementById('tri-side-a').textContent;\n        var b = document.getElementById('tri-side-b').textContent;\n        var c = document.getElementById('tri-side-c').textContent;\n        var A = document.getElementById('tri-ang-a').textContent;\n        var B = document.getElementById('tri-ang-b').textContent;\n        var C = document.getElementById('tri-ang-c').textContent;\n        var area = document.getElementById('tri-res-area').textContent;\n        var perim = document.getElementById('tri-res-perim').textContent;\n        var type = document.getElementById('tri-res-type').textContent;\n        var radii = document.getElementById('tri-res-radii').textContent;\n\n        var text = '📐 TRIANGLE GEOMETRIC SOLUTION REPORT\\n' +\n          '====================================================\\n' +\n          '• Classification: ' + type + '\\n' +\n          '• Side Lengths: a = ' + a + ', b = ' + b + ', c = ' + c + '\\n' +\n          '• Interior Angles: A = ' + A + ', B = ' + B + ', C = ' + C + '\\n' +\n          '• Area: ' + area + ' | Perimeter: ' + perim + '\\n' +\n          '• ' + radii + '\\n' +\n          '----------------------------------------------------\\n' +\n          'Solved via Law of Sines, Law of Cosines & Heron\\'s Formula.\\n' +\n          'Calculated at Digital Tools Shed: https://digitaltoolsshed.com/math/triangle-calculator';\n\n        navigator.clipboard.writeText(text).then(function() {\n          if (btn) {\n            var orig = btn.innerHTML;\n            btn.innerHTML = '<span>✓</span> Triangle Solution Copied!';\n            btn.style.borderColor = '#10b981';\n            btn.style.color = '#10b981';\n            setTimeout(function() {\n              btn.innerHTML = orig;\n              btn.style.borderColor = 'var(--border)';\n              btn.style.color = 'var(--fg)';\n            }, 2000);\n          }\n        });\n      }\n\n      if (document.readyState === 'loading') {\n        document.addEventListener('DOMContentLoaded', calcTriangle);\n      } else {\n        calcTriangle();\n      }\n    </script>\n  "
},
...
},
    {
      ...
      body: `
        ...
        <div class="article-container" style="max-width: 900px;">
          ...
          <div style="margin: 2.5rem 0;">
            <h3 style="font-family: var(--serif); font-size: 1.4rem; margin-bottom: 1.25rem; color: var(--fg);">⚠️ 5 Critical Compounding Pitfalls &amp; Wealth Traps</h3>
            <div style="display: grid; gap: 1rem;">
              <div style="background: var(--surface); border: 1px solid var(--border); border-left: 4px solid #ef4444; padding: 1.25rem; border-radius: 8px;">
                <h4 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: #ef4444; font-family: var(--serif);">💥 1. The Devastating Drag of Expense Ratios &amp; Management Fees (Reverse Compounding)</h4>
                <p style="margin: 0; font-size: 0.88rem; color: var(--text-muted); line-height: 1.6;">A seemingly harmless 1.5% annual financial advisor or fund expense ratio doesn't take 1.5% of your gains—it compounds in reverse against your growing balance every single year. Over a 30-year investing horizon, a 1.5% fee consumes over <strong>33% of your total potential portfolio value</strong>. Lowering fees from 1.5% to a 0.04% broad index fund preserves hundreds of thousands of dollars.</p>
              </div>
              <div style="background: var(--surface); border: 1px solid var(--border); border-left: 4px solid #f59e0b; padding: 1.25rem; border-radius: 8px;">
                <h4 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: #f59e0b; font-family: var(--serif);">📉 2. The Inflation Erosion Trap (Nominal vs. Real Purchasing Power)</h4>
                <p style="margin: 0; font-size: 0.88rem; color: var(--text-muted); line-height: 1.6;">Nominal dollar returns do not equal real purchasing power. If your portfolio compounds at 7.5% nominal growth but consumer price inflation averages 3.0%, your real wealth accumulation rate is only ~4.37% via the Fisher Equation: <code>[(1 + 0.075) / (1 + 0.03) - 1]</code>. Failing to calculate inflation-adjusted retirement targets leads retirees to run out of purchasing power 10 to 15 years early.</p>
              </div>
              <div style="background: var(--surface); border: 1px solid var(--border); border-left: 4px solid #10b981; padding: 1.25rem; border-radius: 8px;">
                <h4 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: #10b981; font-family: var(--serif);">⏳ 3. The Interrupted Compounding &amp; Market Timing Fallacy</h4>
                <p style="margin: 0; font-size: 0.88rem; color: var(--text-muted); line-height: 1.6;">Charlie Munger's supreme rule of compounding was: <em>"The first rule of compounding is to never interrupt it unnecessarily."</em> Investors who pull money out during panic corrections miss the market's 10 best trading days per decade, which historically cuts cumulative 30-year compound returns by more than 50%. Compounding requires sustained, uninterrupted exposure across multiple full business cycles.</p>
              </div>
              <div style="background: var(--surface); border: 1px solid var(--border); border-left: 4px solid #3b82f6; padding: 1.25rem; border-radius: 8px;">
                <h4 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: #3b82f6; font-family: var(--serif);">🔄 4. The Compounding Frequency Myth (Daily vs. Monthly Delta)</h4>
                <p style="margin: 0; font-size: 0.88rem; color: var(--text-muted); line-height: 1.6;">Novice savers spend hours shopping for accounts offering daily rather than monthly compounding. In reality, shifting from monthly to continuous compounding on a $10,000 balance at 7% over 10 years yields only an extra ~$6 total! The overwhelming engine of compound wealth is <strong>time horizon and consistent monthly principal additions</strong>, not mathematical compounding frequency tricks.</p>
              </div>
              <div style="background: var(--surface); border: 1px solid var(--border); border-left: 4px solid #8b5cf6; padding: 1.25rem; border-radius: 8px;">
                <h4 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: #8b5cf6; font-family: var(--serif);">🏛️ 5. Tax Drag in Non-Sheltered Brokerage Accounts</h4>
                <p style="margin: 0; font-size: 0.88rem; color: var(--text-muted); line-height: 1.6;">In a taxable brokerage account, mandatory annual taxes on dividend distributions, fund turnover, and rebalancing cut effective annual compound rates by 1.5% to 2.5%. Over 35 years, this tax drag reduces terminal wealth by 40% to 50% compared to identical investments compounding tax-free inside a Roth IRA, Traditional 401(k), or Health Savings Account (HSA).</p>
              </div>
            </div>
          </div>
        </div>
        ...
        window.copyCompoundSummary = function() {
          var endBal = document.getElementById('ci-end-balance') ? document.getElementById('ci-end-balance').textContent : '';
          var princ = document.getElementById('ci-principal') ? document.getElementById('ci-principal').value : '';
          var rate = document.getElementById('ci-rate') ? document.getElementById('ci-rate').value : '';
          var years = document.getElementById('ci-years') ? document.getElementById('ci-years').value : '';
          var monthly = document.getElementById('ci-monthly') ? document.getElementById('ci-monthly').value : '0';
          var totalInt = document.getElementById('ci-total-interest') ? document.getElementById('ci-total-interest').textContent : '';

          var text = '📈 Compound Interest Projection Summary\n' +
            '• Initial Principal: $' + (parseFloat(princ) || 0).toLocaleString() + '\n' +
            '• Annual Return Rate: ' + rate + '%\n' +
            '• Investment Horizon: ' + years + ' Years\n' +
            '• Monthly Deposit: $' + (parseFloat(monthly) || 0).toLocaleString() + '\n' +
            '• Final Portfolio Balance: ' + endBal + '\n' +
            '• Total Accumulated Interest: ' + totalInt + '\n\n' +
            'Calculated at digitaltoolsshed.com/math/compound-interest';

          navigator.clipboard.writeText(text).then(function() {
            var btn = document.getElementById('btnCopyCI');
            if (btn) {
              var orig = btn.innerHTML;
              btn.innerHTML = '<span>✓ Copied Projection!</span>';
              setTimeout(function() { btn.innerHTML = orig; }, 2000);
            }
          });
        };
...
<div class="article-container" style="max-width:1050px;margin:0 auto;padding:1.5rem 1rem;">
  ...
  <div style="margin-bottom:2.5rem;">
    <h2 style="font-family:var(--serif);font-size:1.5rem;margin-bottom:1.25rem;letter-spacing:-0.01em;">⚠️ 5 Fatal Traps &amp; Gotchas in Restaurant Tipping &amp; Bill Splitting</h2>
    <div style="display:grid;gap:1rem;">
      <div style="background:var(--surface);border:1px solid var(--border);border-left:4px solid #ef4444;padding:1.25rem;border-radius:8px;">
        <h4 style="margin:0 0 0.5rem 0;font-size:1rem;color:#ef4444;font-family:var(--serif);">💥 1. The "Double Tipping on Sales Tax" Trap</h4>
        <p style="margin:0;font-size:0.88rem;color:var(--text-muted);line-height:1.6;">Many point-of-sale terminals (e.g., Toast, Clover, Square) automatically calculate suggested tip percentages on the post-tax balance rather than the pre-tax food subtotal. In metropolitan cities with high combined sales and restaurant meal taxes (such as Chicago at 10.75% or Seattle at 10.25%), tipping 20% on the tax amounts to paying gratuity to your server on money that goes directly to municipal government coffers.</p>
      </div>
      <div style="background:var(--surface);border:1px solid var(--border);border-left:4px solid #f59e0b;padding:1.25rem;border-radius:8px;">
        <h4 style="margin:0 0 0.5rem 0;font-size:1rem;color:#f59e0b;font-family:var(--serif);">⚖️ 2. Mandatory "Service Charge" vs. Voluntary Tip (IRS Revenue Ruling 2012-18)</h4>
        <p style="margin:0;font-size:0.88rem;color:var(--text-muted);line-height:1.6;">When an eatery automatically adds an "18% auto-gratuity for large parties" or a "4% kitchen wellness fee", this money legally belongs to the restaurant entity, not your server. Restaurants can legally use service charges to subsidize rent, back-of-house utility expenses, or manager bonuses. Unless explicitly stated in writing that 100% of the charge is transferred to your front-of-house server, your server may receive none of it.</p>
      </div>
      <div style="background:var(--surface);border:1px solid var(--border);border-left:4px solid #10b981;padding:1.25rem;border-radius:8px;">
        <h4 style="margin:0 0 0.5rem 0;font-size:1rem;color:#10b981;font-family:var(--serif);">☕ 3. The Counter-Service iPad Guilt-Trip Screen</h4>
        <p style="margin:0;font-size:0.88rem;color:var(--text-muted);line-height:1.6;">Self-ordering kiosks, coffee shops, and counter-service bakeries frequently swivel an iPad terminal displaying preset tip buttons starting at 20%, 25%, and 30%. Historically, gratuity compensates servers who provide ongoing table service (menu recommendations, drink refills, clearing courses). For over-the-counter retail transactions where you carry your own food to a table, a tip of 0% to 10% is customary.</p>
      </div>
      <div style="background:var(--surface);border:1px solid var(--border);border-left:4px solid #3b82f6;padding:1.25rem;border-radius:8px;">
        <h4 style="margin:0 0 0.5rem 0;font-size:1rem;color:#3b82f6;font-family:var(--serif);">💳 4. Credit Card Interchange Fee Tip Deductions</h4>
        <p style="margin:0;font-size:0.88rem;color:var(--text-muted);line-height:1.6;">Under federal FLSA regulations, restaurant operators are legally permitted to deduct the actual credit card processing fee (2.0% to 2.75%) from employee tips paid via credit card. For example, on a $20.00 credit card tip, the employer can withhold approximately $0.50 to cover the Visa/Mastercard interchange fee, paying the employee $19.50. Some states (such as California and Massachusetts) strictly prohibit this deduction, requiring the employer to absorb the full transaction fee.</p>
      </div>
      <div style="background:var(--surface);border:1px solid var(--border);border-left:4px solid #8b5cf6;padding:1.25rem;border-radius:8px;">
        <h4 style="margin:0 0 0.5rem 0;font-size:1rem;color:#8b5cf6;font-family:var(--serif);">🚗 5. Delivery App Service Fee &amp; Driver Tip Stacking</h4>
        <p style="margin:0;font-size:0.88rem;color:var(--text-muted);line-height:1.6;">Ordering via third-party delivery apps (DoorDash, UberEats, Grubhub) incurs stacked surcharges: higher menu prices (often 15-30% higher than in-store), delivery fees, service fees, regulatory response fees, and courier tips. Many customers mistakenly believe the "delivery fee" goes to the delivery driver; in reality, drivers rely almost entirely on the separate in-app tip to cover fuel, vehicle depreciation, and liveable compensation.</p>
      </div>
    </div>
  </div>
</div>
  ...
  },
    {
      ...
      body: `
        ...
        <div class="article-container" style="max-width: 900px;">
          ...
          <!-- 5 Historical Rules & Mathematical Traps -->
          <div style="background: var(--surface); border: 1px solid var(--border); padding: 1.5rem; border-radius: 8px; margin: 2rem 0;">
            <h3 style="font-family: var(--serif); font-size: 1.35rem; margin-bottom: 1.25rem; color: var(--fg);">⚠️ 5 Fascinating Historical Rules &amp; Computational Traps</h3>
            <div style="display: grid; gap: 1rem;">
              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #ef4444;">
                <h4 style="margin: 0 0 0.5rem 0; color: #ef4444; font-size: 1rem; font-family: var(--serif);">💥 1. The Subtractive Distance Fallacy (99 is XCIX, NEVER IC)</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  A widespread mathematical misconception is that 99 can be written as <em>IC</em> (100 - 1). In classical Latin syntax, subtractive notation is strictly restricted to powers of ten preceding the next two numerals within the exact same order of magnitude. <em>I</em> can only precede <em>V</em> or <em>X</em>; <em>X</em> can only precede <em>L</em> or <em>C</em>; <em>C</em> can only precede <em>D</em> or <em>M</em>. You can never subtract across two full decimal tiers. Therefore, 99 is decomposed as (90) + (9) = <strong>XCIX</strong>.
                </p>
              </div>
              ...
              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #f59e0b;">
                <h4 style="margin: 0 0 0.5rem 0; color: #f59e0b; font-size: 1rem; font-family: var(--serif);">🕒 2. The Watchmaker's "IIII" vs "IV" Tradition</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Nearly all luxury analog timepieces (Rolex, Cartier, Patek Philippe) print <strong>IIII</strong> instead of <strong>IV</strong>. Horologists preserve this for three enduring reasons: (1) <strong>Visual symmetry</strong> balancing the four-character <em>VIII</em> directly across the dial; (2) Ancient Roman religious taboo, as <em>IV</em> were the opening letters of the supreme deity <em>IVPPITER</em> (Jupiter); and (3) King Charles V of France famously decreed in 1364 that he did not wish to subtract from his royal hours.
                </p>
              </div>
              ...
              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #10b981;">
                <h4 style="margin: 0 0 0.5rem 0; color: #10b981; font-size: 1rem; font-family: var(--serif);">🚫 3. The "Triple Repetition Rule" &amp; The Modern 3,999 Standard Limit</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Standard Roman numeral conventions prohibit repeating any character more than three times consecutively (e.g., <em>III</em> is 3, but 4 is <em>IV</em>; <em>XXX</em> is 30, but 40 is <em>XL</em>). Because <em>M</em> (1,000) was historically the largest single letter without diacritics, writing 4,000 as <em>MMMM</em> violates standard syntax. Consequently, standard additive-subtractive Roman notation terminates at <strong>MMMCMXCIX (3,999)</strong>. Values beyond 3,999 require the Vinculum overline.
                </p>
              </div>
              ...
              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #3b82f6;">
                <h4 style="margin: 0 0 0.5rem 0; color: #3b82f6; font-size: 1rem; font-family: var(--serif);">⭕ 4. The Non-Existence of Zero (Nulla &amp; Abacus Logic)</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); margin: 0; line-height: 1.6;">
                  Roman numerals have no symbol for zero. Because their numbering evolved on physical tally sticks and merchant abacuses, there was no practical physical reason to carve a notch representing nothing. In medieval ledgers, scribes wrote the Latin word <em>nulla</em> ("none"). Positional zero as an operational placeholder only entered European mathematics following Leonardo Fibonacci's 1202 treatise <em>Liber Abaci</em>.
                </p>
              </div>
              ...
              <div style="padding: 1.25rem; background: var(--surface-alt); border-radius: 8px; border: 1px solid var(--border); border-left: 4px solid #8b5cf6;">
                <h4 style="margin: 0 0 0.5rem 0; color: #8b5cf6; font-size: 1rem; font-family: var(--serif);">🏛️ 5. The Vinculum &amp; Apostrophus Multiplier System (4,000 to 3,999,999)</h4>
                <p style="font-size: 0.88rem; color: var(--text-muted); line-height: 1.6;">
                  To record municipal budgets, census tallies, and imperial army payrolls exceeding 3,999, Roman magistrates developed two multiplier conventions: the <strong>Vinculum</strong> (a horizontal overbar indicating multiplication by 1,000, e.g., <em>I̅V̅</em> = 4,000; <em>V̅</em> = 5,000; <em>X̅</em> = 10,000; <em>M̅</em> = 1,000,000) and the <strong>Apostrophus</strong> (using curved enclosures like <code>(|)</code> for 1,000 and <code>((|))</code> for 10,000). Our converter supports full Unicode Vinculum up to 3,999,999.
                </p>
              </div>
            </div>
          </div>
...
<div class="article-container" style="max-width:1050px;margin:0 auto;padding:1.5rem 1rem;">
  ...
  <!-- Real-World Traps Section -->
  <div style="margin-bottom:2.5rem;">
    <h2 style="font-family:var(--serif);font-size:1.5rem;margin-bottom:1.25rem;letter-spacing:-0.01em;">⚠️ 5 Fatal Traps &amp; Gotchas in Age &amp; Date Calculation</h2>
    <div style="display:grid;gap:1rem;">
      <div style="background:var(--surface);border:1px solid var(--border);border-left:4px solid #ef4444;padding:1.25rem;border-radius:8px;">
        <h4 style="margin:0 0 0.5rem 0;font-size:1rem;color:#ef4444;font-family:var(--serif);">💥 1. The "Average 30.4375 Days Per Month" Mathematical Flaw</h4>
        <p style="margin:0;font-size:0.88rem;color:var(--text-muted);line-height:1.6;">Many amateur calculators divide elapsed days by 365.25 or 30.4375 to determine years and months. Because calendar months vary between 28, 29, 30, and 31 days, naive floating-point division produces errors of 1 to 3 days when computing age intervals. The only actuarially accurate method is calendar borrowing: tracking exact days elapsed within the specific Gregorian month cycle.</p>
      </div>
      <div style="background:var(--surface);border:1px solid var(--border);border-left:4px solid #f59e0b;padding:1.25rem;border-radius:8px;">
        <h4 style="margin:0 0 0.5rem 0;font-size:1rem;color:#f59e0b;font-family:var(--serif);">⚖️ 2. Leap Day Statutory Maturity (February 29 Birthdays)</h4>
        <p style="margin:0;font-size:0.88rem;color:var(--text-muted);line-height:1.6;">If you were born on Leap Day (February 29), your legal age increments on different dates depending on national laws. Under English common law and UK statute, a leap year baby does not legally turn 18 or 21 until March 1st. In contrast, under Taiwanese and New Zealand legislation, rights vest on February 28th. Airline booking systems frequently reject Feb 29 birthdates on non-leap departure years without automatic rollover logic.</p>
      </div>
      <div style="background:var(--surface);border:1px solid var(--border);border-left:4px solid #10b981;padding:1.25rem;border-radius:8px;">
        <h4 style="margin:0 0 0.5rem 0;font-size:1rem;color:#10b981;font-family:var(--serif);">🌏 3. South Korea's Historic 2023 Age Law Abolition</h4>
        <p style="margin:0;font-size:0.88rem;color:var(--text-muted);line-height:1.6;">Until June 28, 2023, South Korea operated three competing age systems: "Korean Age" (where you are 1 year old at birth and age up every New Year's Day), "Counting Age" (used for military conscription and alcohol purchase), and "International Age". The confusion resulted in severe administrative disputes regarding COVID-19 vaccine eligibility and insurance payouts until the National Assembly officially mandated the international chronological system.</p>
      </div>
      <div style="background:var(--surface);border:1px solid var(--border);border-left:4px solid #3b82f6;padding:1.25rem;border-radius:8px;">
        <h4 style="margin:0 0 0.5rem 0;font-size:1rem;color:#3b82f6;font-family:var(--serif);">📜 4. The 1752 Calendar Act (The Missing 11 Days Trap)</h4>
        <p style="margin:0;font-size:0.88rem;color:var(--text-muted);line-height:1.6;">When Great Britain and the American colonies transitioned from the Julian to the Gregorian calendar in September 1752, eleven calendar days were dropped entirely: Wednesday, September 2 was followed directly by Thursday, September 14! Historical figures born before 1752 (such as George Washington, originally born February 11, 1731/32) had their birthdays shifted to February 22, 1732.</p>
      </div>
      <div style="background:var(--surface);border:1px solid var(--border);border-left:4px solid #8b5cf6;padding:1.25rem;border-radius:8px;">
        <h4 style="margin:0 0 0.5rem 0;font-size:1rem;color:#8b5cf6;font-family:var(--serif);">⏰ 5. Daylight Saving Time &amp; Midnight Birth Boundary Errors</h4>
        <p style="margin:0;font-size:0.88rem;color:var(--text-muted);line-height:1.6;">Individuals born within one hour of midnight during the "Fall Back" or "Spring Forward" transitions of Daylight Saving Time can suffer statutory birthdate discrepancies. An infant born at 1:45 AM during the fallback hour might be registered after a twin born at 1:15 AM if clocks were set back to 1:00 AM between births, creating permanent legal identification and birth certificate timing anomalies.</p>
      </div>
    </div>
  </div>
</div>
