  ...
  <aside class="sidebar" id="siteSidebar">
    ...
    <div class="sidebar-search-box">
      ...
      <div class="search-tooltip">
        <span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;vertical-align:middle;margin-right:3px"><line x1="9" y1="18" x2="15" y2="18"/><line x1="10" y1="22" x2="14" y2="22"/><path d="M12 2a7 7 0 0 0-4 12.7V17h8v-2.3A7 7 0 0 0 12 2z"/></svg> Filter 258+ tools live</span>
    ...
    <nav class="sidebar-nav">
      ...
      <a href="/math/bayesian-updater.html" class="nav-link ${currentPath === '/math/bayesian-updater.html' ? 'active' : ''}">
        <div class="nav-link-content"><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;vertical-align:middle;margin-right:3px"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg> Bayesian Belief Updater</span></div>
      </a>
      <a href="/text/fallacy-scanner.html" class="nav-link ${currentPath === '/text/fallacy-scanner.html' ? 'active' : ''}">
        <div class="nav-link-content"><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;vertical-align:middle;margin-right:3px"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg> Fallacy & Evasion Scanner</span></div>
      </a>
      ...
      <a href="/learn/javascript/" class="nav-link ${currentPath === '/learn/javascript/' || currentPath === '/learn/javascript/index.html' ? 'active' : ''}">
        <div class="nav-link-content"><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;vertical-align:middle;margin-right:3px"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg> JavaScript Guides (30)</span></div>
      </a>
      ...
      <a href="/calc/stair-calculator.html" class="nav-link ${currentPath === '/calc/stair-calculator.html' ? 'active' : ''}">
        <div class="nav-link-content"><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;vertical-align:middle;margin-right:3px"><path d="M3 21l9-9L21 3"/><path d="M3 21h18"/><path d="M3 21V3"/></svg> Stair Stringer (IRC Code)</span></div>
      </a>
      ...
      <a href="/calc/mulch-calculator.html" class="nav-link ${currentPath === '/calc/mulch-calculator.html' ? 'active' : ''}">
        <div class="nav-link-content"><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;vertical-align:middle;margin-right:3px"><path d="M7 20.5c3-2 5.5-5 7-10.5"/><path d="M12 10c-1.5-4.5 0-8 5-9.5C18.5 5 16 9 12 10z"/></svg> Mulch, Topsoil & Gravel</span></div>
      </a>
    ...
    <div class="content-area">
      ...
      <div class="sponsor-grid">
        ...
        <div class="sponsor-cards">
            ...
            <a href="https://manyapostle.com/jzw75n7ccp?key=a4a5863b69fad31e603ca81022b5fd3a" class="sponsor-card" target="_blank" rel="noopener sponsored">
