  ...
  const financeTools = [
{
  ...
  "faq": [
    {
      "q": "How much time and interest does paying an extra $100 per month save on a mortgage?",
      "a": "On a standard $350,000 30-year fixed mortgage at 6.75% interest ($2,270/month principal and interest), contributing an extra $100 per month towards principal shaves approximately 3 years and 4 months off the loan term and saves over $58,000 in total interest charges."
    },
    {
      "q": "How does the bi-weekly mortgage payment accelerator strategy work?",
      "a": "A standard monthly schedule involves 12 payments per year. Under a true bi-weekly mortgage plan, you pay half of your monthly payment every two weeks. Because there are 52 weeks in a year, you make 26 half-payments, which equals 13 full monthly payments annually. That single extra monthly payment per year applied to principal typically shortens a 30-year loan to approximately 24 years."
    },
    {
      "q": "What is the \"suspense account\" trap when making extra mortgage payments?",
      "a": "Many mortgage servicers do not automatically apply partial or extra funds directly to your loan principal. Instead, automated servicing systems deposit extra funds into a non-interest-bearing \"suspense account\" until enough cash accumulates to cover a full future scheduled monthly payment. Homeowners must explicitly specify \"Apply to Principal Only\" on payment slips or digital portal toggles."
    },
    {
      "q": "Should I pay off a low-interest mortgage early or invest in index funds?",
      "a": "If your mortgage carries a 2.5% to 3.5% fixed interest rate from 2020-2021, prepaying it offers an effective guaranteed return of only 2.5% to 3.5%. By contrast, low-cost broad market index funds (such as the S&P 500) have historically averaged roughly 10% nominal annual returns, and high-yield savings accounts pay 4% to 5%. Prepaying a low-rate mortgage carries substantial opportunity cost."
    },
    {
      "q": "When in a mortgage amortization schedule do extra payments have the greatest impact?",
      "a": "Extra principal payments have the highest mathematical impact during the first 5 to 7 years of a 30-year mortgage. Early in the loan, over 70% to 80% of each scheduled payment goes towards interest. Every extra dollar paid directly to principal immediately extinguishes decades of compounding future interest on that dollar."
    }
  ],
  "body": "\n    <div class=\"article-container\" style=\"max-width: 1040px;\">\n      <nav style=\"font-family: var(--mono); font-size: 0.8rem; margin-bottom: 1.5rem; color: var(--text-muted);\">\n        <a href=\"/\">Home</a> &gt; <a href=\"/finance/\">Finance</a> &gt; Mortgage Payoff Calculator\n      </nav>\n\n      <header style=\"margin-bottom: 2rem;\">\n        <div style=\"display: flex; gap: 0.5rem; align-items: center; margin-bottom: 0.5rem; flex-wrap: wrap;\">\n          <span class=\"badge badge-purple\">Amortization Engine</span>\n          <span class=\"badge badge-green\">Principal Acceleration</span>\n          <span class=\"badge badge-blue\">Zero Server Uploads</span>\n        </div>\n        <h1 style=\"font-family: var(--serif); font-size: 2.3rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          Mortgage Payoff &amp; Early Amortization Calculator\n        </h1>\n        <p style=\"color: var(--text-muted); font-size: 1.05rem; line-height: 1.6;\">\n          Determine exactly how extra monthly payments, annual lump-sum bonuses, or bi-weekly payment schedules accelerate mortgage payoff. Calculates years shaved off the loan and total lifetime interest eliminated.\n        </p>\n      </header>\n\n      <!-- MAIN INPUT BOX -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); padding: 1.75rem; border-radius: 8px; margin-bottom: 2rem;\">\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem; margin-bottom: 1.5rem;\">\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Current Loan Balance ($):</label>\n            <input type=\"number\" id=\"pay-bal\" value=\"385000\" step=\"5000\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcMortgagePayoff()\" />\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Interest Rate (% APR):</label>\n            <input type=\"number\" id=\"pay-rate\" value=\"6.875\" step=\"0.125\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcMortgagePayoff()\" />\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Remaining Term (Years):</label>\n            <input type=\"number\" id=\"pay-term\" value=\"30\" min=\"1\" max=\"40\" step=\"1\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcMortgagePayoff()\" />\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Extra Monthly Principal ($):</label>\n            <input type=\"number\" id=\"pay-extra-mo\" value=\"250\" min=\"0\" step=\"25\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcMortgagePayoff()\" />\n          </div>\n        </div>\n\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem; border-top: 1px solid var(--border); padding-top: 1.25rem; margin-bottom: 1.5rem;\">\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Annual Lump Sum Bonus ($/yr):</label>\n            <input type=\"number\" id=\"pay-extra-yr\" value=\"1500\" min=\"0\" step=\"250\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcMortgagePayoff()\" />\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Accelerated Bi-Weekly Plan:</label>\n            <select id=\"pay-biweekly\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--sans); font-size: 0.95rem;\" onchange=\"calcMortgagePayoff()\">\n              <option value=\"no\" selected>No (Standard Monthly Schedule)</option>\n              <option value=\"yes\">Yes (26 Half-Payments = 13 Months/Year)</option>\n            </select>\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">One-Time Lump Sum ($):</label>\n            <input type=\"number\" id=\"pay-onetime\" value=\"0\" min=\"0\" step=\"1000\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcMortgagePayoff()\" />\n          </div>\n        </div>\n\n        <!-- MAIN KPI RESULT CARDS -->\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;\">\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #10b981;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Total Time Shaved Off</div>\n            <div id=\"pay-res-time-saved\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #10b981; margin-bottom: 0.2rem;\">6 Yrs, 8 Mos</div>\n            <div id=\"pay-res-new-term\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Paid off in 23.3 Years (vs 30.0 Yrs)</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #3b82f6;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Total Interest Saved</div>\n            <div id=\"pay-res-interest-saved\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #3b82f6; margin-bottom: 0.2rem;\">$134,280</div>\n            <div id=\"pay-res-interest-sub\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Interest reduced from $526k to $392k</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #6366f1;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Standard Monthly P&amp;I</div>\n            <div id=\"pay-res-monthly-pi\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #6366f1; margin-bottom: 0.2rem;\">$2,528 / mo</div>\n            <div id=\"pay-res-total-monthly\" style=\"font-size: 0.85rem; color: var(--text-muted);\">With Extra: $2,778 / mo</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #f59e0b;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Return on Prepayments (ROI)</div>\n            <div id=\"pay-res-roi\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #f59e0b; margin-bottom: 0.2rem;\">6.88%</div>\n            <div style=\"font-size: 0.85rem; color: var(--text-muted);\">Guaranteed Tax-Free Effective Return</div>\n          </div>\n        </div>\n      </div>\n\n      <!-- INTERACTIVE AMORTIZATION CURVE SVG -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.35rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          📉 Loan Balance Amortization Trajectory Comparison\n        </h2>\n        <p style=\"font-size: 0.85rem; color: var(--text-muted); margin-bottom: 1.25rem;\">\n          Shows remaining principal balance over time. The red dashed line illustrates standard 30-year amortization, while the solid green curve reveals early debt freedom with extra principal payments.\n        </p>\n\n        <div style=\"overflow-x: auto;\">\n          <svg id=\"pay-curve-svg\" viewBox=\"0 0 800 240\" style=\"width: 100%; height: auto; min-width: 600px; font-family: var(--mono);\"></svg>\n        </div>\n      </div>\n\n      <!-- STEP-BY-STEP MATHEMATICAL DERIVATION -->\n      <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h3 style=\"font-family: var(--mono); font-size: 0.9rem; text-transform: uppercase; color: var(--text-muted); margin: 0 0 0.75rem 0;\">\n          📐 Step-by-Step Amortization &amp; Payoff Derivations\n        </h3>\n        <div id=\"pay-derivation-box\" style=\"font-family: var(--mono); font-size: 0.85rem; line-height: 1.7; color: var(--fg);\">\n          Calculating loan amortization schedules...\n        </div>\n      </div>\n\n      <!-- ONE-CLICK COPY BUTTON -->\n      <div style=\"margin-bottom: 2.5rem;\">\n        <button type=\"button\" id=\"pay-copy-btn\" onclick=\"copyMortgagePayoffReport(this)\" class=\"btn btn-copy\" style=\"display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; font-size: 0.9rem; font-weight: 600; background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; cursor: pointer; color: var(--fg); transition: all 0.15s ease;\">\n          <span>📋</span> Copy Accelerated Payoff &amp; Interest Savings Report\n        </button>\n      </div>\n\n      <!-- 5 FATAL TRAPS -->\n      <div style=\"margin: 2.5rem 0;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.45rem; margin-bottom: 0.75rem; color: var(--fg);\">\n          ⚠️ 5 Fatal Traps of Early Mortgage Prepayments\n        </h2>\n        <div style=\"display: grid; grid-template-columns: 1fr; gap: 1rem;\">\n          <div class=\"trap-card\" style=\"border-left: 4px solid #ef4444;\">\n            <strong style=\"color: #ef4444;\">1. The Bank \"Suspense Account\" Unallocated Payment Trap</strong>\n            When sending extra cash to your mortgage servicer, automated accounting algorithms do not automatically apply funds to principal. Instead, lenders hold partial payments in a non-interest-earning \"suspense account\" until enough cash arrives to fund a future regular monthly payment. Homeowners must check the \"Principal Prepayment Only\" box on their portal to prevent this.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #f59e0b;\">\n            <strong style=\"color: #f59e0b;\">2. Paid Bi-Weekly Third-Party Processing Scams</strong>\n            Third-party marketing services mail official-looking letters offering to set up \"bi-weekly mortgage equity plans\" for a $395 setup fee plus $9/month administrative charges. You do NOT need a third party. Simply calculate 1/12th of your regular monthly payment and add it to your normal monthly payment directly with your lender for $0 in fees.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #10b981;\">\n            <strong style=\"color: #10b981;\">3. Sacrificing Liquid Emergency Cash Reserves</strong>\n            Putting every extra dollar of cash flow into home equity leaves you \"house-rich and cash-poor.\" Home equity cannot buy groceries, pay healthcare deductibles, or cover emergency repairs during unexpected job loss. Furthermore, banks will refuse to approve a Home Equity Line of Credit (HELOC) or cash-out refi precisely when you are unemployed.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #3b82f6;\">\n            <strong style=\"color: #3b82f6;\">4. Prepaying Ultra-Low Pandemic Rates (Sub-3.5% Mortgages)</strong>\n            Borrowers who locked in 2.5% to 3.25% fixed 30-year mortgages in 2020–2021 lose massive wealth by prepaying early. High-yield savings accounts and Treasury bills yield 4.5% to 5.0% risk-free, while the S&P 500 averages ~10% nominal. Investing extra cash in an index fund or CD creates an arbitrage spread that yields far more wealth than extinguishing cheap 3% debt.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #8b5cf6;\">\n            <strong style=\"color: #8b5cf6;\">5. Overlooking Prepayment Penalty Clauses in Non-QM Loans</strong>\n            While conforming Fannie Mae and Freddie Mac conventional loans are legally prohibited from carrying prepayment penalties under Dodd-Frank rules, certain non-qualified mortgages (Non-QM), commercial investment property loans, and private hard-money loans charge up to 6 months of unearned interest if more than 20% of the loan is retired early during the first 3 to 5 years.\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <script>\n      function calcMortgagePayoff() {\n        var bal = parseFloat(document.getElementById('pay-bal').value) || 385000;\n        var rate = parseFloat(document.getElementById('pay-rate').value) || 6.875;\n        var termYrs = parseFloat(document.getElementById('pay-term').value) || 30;\n        var extraMo = parseFloat(document.getElementById('pay-extra-mo').value) || 0;\n        var extraYr = parseFloat(document.getElementById('pay-extra-yr').value) || 0;\n        var isBiweekly = document.getElementById('pay-biweekly').value === 'yes';\n        var oneTime = parseFloat(document.getElementById('pay-onetime').value) || 0;\n\n        var monthlyRate = (rate / 100) / 12;\n        var totalScheduledMonths = Math.round(termYrs * 12);\n\n        // Standard scheduled P&I\n        var scheduledPI = 0;\n        if (monthlyRate > 0 && totalScheduledMonths > 0) {\n          scheduledPI = bal * (monthlyRate * Math.pow(1 + monthlyRate, totalScheduledMonths)) / (Math.pow(1 + monthlyRate, totalScheduledMonths) - 1);\n        }\n\n        // Bi-weekly equivalent monthly addition: (scheduledPI / 12)\n        var biweeklyExtraPerMonth = isBiweekly ? (scheduledPI / 12) : 0;\n\n        // Simulate Baseline Schedule\n        var stdBal = bal;\n        var stdInterestTotal = 0;\n        var stdCurve = [];\n        for (var m = 1; m <= totalScheduledMonths; m++) {\n          var intPmt = stdBal * monthlyRate;\n          var prinPmt = scheduledPI - intPmt;\n          stdInterestTotal += intPmt;\n          stdBal -= prinPmt;\n          if (stdBal < 0) stdBal = 0;\n          if (m % 12 === 0 || m === totalScheduledMonths) {\n            stdCurve.push({ month: m, bal: stdBal });\n          }\n        }\n\n        // Simulate Accelerated Schedule\n        var accBal = bal - oneTime;\n        var accInterestTotal = 0;\n        var accMonths = 0;\n        var accCurve = [{ month: 0, bal: accBal }];\n\n        while (accBal > 0.01 && accMonths < totalScheduledMonths * 2) {\n          accMonths++;\n          var mInt = accBal * monthlyRate;\n          var mExtra = extraMo + biweeklyExtraPerMonth + (accMonths % 12 === 0 ? extraYr : 0);\n          var mPrin = (scheduledPI - mInt) + mExtra;\n\n          if (accBal + mInt <= scheduledPI + mExtra) {\n            // Final payoff month\n            accInterestTotal += mInt;\n            accBal = 0;\n            accCurve.push({ month: accMonths, bal: 0 });\n            break;\n          }\n\n          accInterestTotal += mInt;\n          accBal -= mPrin;\n\n          if (accMonths % 12 === 0) {\n            accCurve.push({ month: accMonths, bal: accBal });\n          }\n        }\n\n        var monthsSaved = Math.max(0, totalScheduledMonths - accMonths);\n        var yearsSaved = Math.floor(monthsSaved / 12);\n        var remMonthsSaved = monthsSaved % 12;\n        var interestSaved = Math.max(0, stdInterestTotal - accInterestTotal);\n\n        var newTermYrs = (accMonths / 12).toFixed(1);\n\n        // Update KPIs\n        document.getElementById('pay-res-time-saved').textContent = yearsSaved + ' Yrs, ' + remMonthsSaved + ' Mos';\n        document.getElementById('pay-res-new-term').textContent = 'Paid off in ' + newTermYrs + ' Years (vs ' + termYrs + ' Yrs)';\n\n        document.getElementById('pay-res-interest-saved').textContent = '$' + Math.round(interestSaved).toLocaleString();\n        document.getElementById('pay-res-interest-sub').textContent = 'Interest reduced from $' + Math.round(stdInterestTotal).toLocaleString() + ' to $' + Math.round(accInterestTotal).toLocaleString();\n\n        document.getElementById('pay-res-monthly-pi').textContent = '$' + Math.round(scheduledPI).toLocaleString() + ' / mo';\n        document.getElementById('pay-res-total-monthly').textContent = 'With Extra: $' + Math.round(scheduledPI + extraMo + biweeklyExtraPerMonth).toLocaleString() + ' / mo';\n\n        document.getElementById('pay-res-roi').textContent = rate.toFixed(2) + '%';\n\n        // Derivation Box\n        var dBox = document.getElementById('pay-derivation-box');\n        dBox.innerHTML = '<strong>1. Standard Amortization:</strong> 30-Year P&amp;I = <strong>$' + Math.round(scheduledPI).toLocaleString() + ' / month</strong> over ' + totalScheduledMonths + ' months = $' + Math.round(stdInterestTotal).toLocaleString() + ' total interest.<br>' +\n          '<strong>2. Total Additional Principal:</strong> $' + extraMo.toLocaleString() + '/mo + $' + extraYr.toLocaleString() + '/yr bonus' + (isBiweekly ? ' + $' + Math.round(biweeklyExtraPerMonth).toLocaleString() + '/mo (Bi-weekly extra payment)' : '') + (oneTime > 0 ? ' + $' + oneTime.toLocaleString() + ' initial lump sum' : '') + '.<br>' +\n          '<strong>3. Accelerated Loan Retirement:</strong> Fully extinguished in <strong>' + accMonths + ' months (' + newTermYrs + ' years)</strong>, shaving off <strong>' + yearsSaved + ' years and ' + remMonthsSaved + ' months</strong>.<br>' +\n          '<strong>4. Total Wealth Protected:</strong> Elimination of <strong>$' + Math.round(interestSaved).toLocaleString() + ' in bank interest charges</strong>.<br>' +\n          '<strong>5. Risk-Free Yield:</strong> Prepaying 6.88% debt provides an immutable, tax-exempt guaranteed internal rate of return equal to the loan APR.';\n\n        // Render Curve SVG\n        renderPayoffCurveSvg(bal, totalScheduledMonths, accMonths);\n      }\n\n      function renderPayoffCurveSvg(initBal, stdMonths, accMonths) {\n        var svg = document.getElementById('pay-curve-svg');\n        if (!svg) return;\n\n        var w = 800, h = 240;\n        var padL = 70, padR = 40, padT = 30, padB = 40;\n        var plotW = w - padL - padR;\n        var plotH = h - padT - padB;\n\n        var svgHtml = '';\n\n        // Axes\n        svgHtml += '<line x1=\"' + padL + '\" y1=\"' + (padT + plotH) + '\" x2=\"' + (padL + plotW) + '\" y2=\"' + (padT + plotH) + '\" stroke=\"var(--border)\" stroke-width=\"2\" />';\n        svgHtml += '<line x1=\"' + padL + '\" y1=\"' + padT + '\" x2=\"' + padL + '\" y2=\"' + (padT + plotH) + '\" stroke=\"var(--border)\" stroke-width=\"2\" />';\n\n        // Standard curve (Red dashed)\n        var stdD = 'M ' + padL + ' ' + padT;\n        // Standard mortgage balance curve is concave downward early then drops steeply late\n        var stdPts = [];\n        for (var i = 0; i <= 20; i++) {\n          var frac = i / 20;\n          var xP = padL + frac * plotW;\n          // Typical 30-yr balance curve formula approximation\n          var balFrac = 1 - Math.pow(frac, 1.4);\n          var yP = padT + (1 - balFrac) * plotH;\n          stdPts.push(xP.toFixed(1) + ',' + yP.toFixed(1));\n        }\n        svgHtml += '<path d=\"M ' + stdPts.join(' L ') + '\" fill=\"none\" stroke=\"#ef4444\" stroke-width=\"2.5\" stroke-dasharray=\"6,4\" />';\n\n        // Accelerated curve (Green solid)\n        var accFrac = Math.min(1.0, accMonths / stdMonths);\n        var accXEnd = padL + (accFrac * plotW);\n        var accPts = [];\n        for (var j = 0; j <= 20; j++) {\n          var jFrac = j / 20;\n          var xP = padL + (jFrac * (accXEnd - padL));\n          var balFrac = 1 - Math.pow(jFrac, 1.25);\n          var yP = padT + (1 - balFrac) * plotH;\n          accPts.push(xP.toFixed(1) + ',' + yP.toFixed(1));\n        }\n        svgHtml += '<path d=\"M ' + accPts.join(' L ') + '\" fill=\"none\" stroke=\"#10b981\" stroke-width=\"3\" />';\n\n        // Shaded Interest Savings Area\n        var areaPath = 'M ' + accPts.join(' L ') + ' L ' + stdPts.slice().reverse().join(' L ') + ' Z';\n        svgHtml += '<path d=\"' + areaPath + '\" fill=\"rgba(16, 185, 129, 0.15)\" />';\n\n        // Callouts\n        svgHtml += '<text x=\"' + (padL + plotW) + '\" y=\"' + (padT + plotH - 10) + '\" fill=\"#ef4444\" font-size=\"11\" font-weight=\"bold\" text-anchor=\"end\">Standard 30 Years (0 Extra)</text>';\n        svgHtml += '<circle cx=\"' + accXEnd + '\" cy=\"' + (padT + plotH) + '\" r=\"5\" fill=\"#10b981\" />';\n        svgHtml += '<text x=\"' + accXEnd + '\" y=\"' + (padT + plotH - 12) + '\" fill=\"#10b981\" font-size=\"11\" font-weight=\"bold\" text-anchor=\"middle\">Accelerated Payoff (Year ' + (accMonths/12).toFixed(1) + ')</text>';\n\n        // Ticks\n        svgHtml += '<text x=\"' + padL + '\" y=\"' + (padT + plotH + 20) + '\" fill=\"var(--text-muted)\" font-size=\"11\" text-anchor=\"middle\">Year 0</text>';\n        svgHtml += '<text x=\"' + (padL + plotW/2) + '\" y=\"' + (padT + plotH + 20) + '\" fill=\"var(--text-muted)\" font-size=\"11\" text-anchor=\"middle\">Year 15</text>';\n        svgHtml += '<text x=\"' + (padL + plotW) + '\" y=\"' + (padT + plotH + 20) + '\" fill=\"var(--text-muted)\" font-size=\"11\" text-anchor=\"end\">Year 30</text>';\n\n        svg.innerHTML = svgHtml;\n      }\n\n      function copyMortgagePayoffReport(btn) {\n        var savedTime = document.getElementById('pay-res-time-saved').textContent;\n        var newTerm = document.getElementById('pay-res-new-term').textContent;\n        var interestSaved = document.getElementById('pay-res-interest-saved').textContent;\n        var pi = document.getElementById('pay-res-monthly-pi').textContent;\n        var bal = document.getElementById('pay-bal').value;\n        var extra = document.getElementById('pay-extra-mo').value;\n\n        var text = '🏡 ACCELERATED MORTGAGE PAYOFF AUDIT\\n' +\n          '====================================================\\n' +\n          '• Loan Balance: $' + parseFloat(bal).toLocaleString() + '\\n' +\n          '• Monthly P&I: ' + pi + ' (+ $' + extra + '/mo extra)\\n' +\n          '• Time Shaved Off: ' + savedTime + ' (' + newTerm + ')\\n' +\n          '• Total Interest Saved: ' + interestSaved + '\\n' +\n          '----------------------------------------------------\\n' +\n          'Calculated via Digital Tools Shed: https://digitaltoolsshed.com/finance/mortgage-payoff-calculator';\n\n        navigator.clipboard.writeText(text).then(function() {\n          if (btn) {\n            var orig = btn.innerHTML;\n            btn.innerHTML = '<span>✓</span> Payoff Audit Copied!';\n            btn.style.borderColor = '#10b981';\n            btn.style.color = '#10b981';\n            setTimeout(function() {\n              btn.innerHTML = orig;\n              btn.style.borderColor = 'var(--border)';\n              btn.style.color = 'var(--fg)';\n            }, 2000);\n          }\n        });\n      }\n\n      if (document.readyState === 'loading') {\n        document.addEventListener('DOMContentLoaded', calcMortgagePayoff);\n      } else {\n        calcMortgagePayoff();\n      }\n    </script>\n  "
},

{
  "slug": "down-payment-calculator",
  "title": "Down Payment Calculator — Minimum Down Payments, PMI Tiers & LTV Analysis",
  "metaDesc": "Calculate minimum down payment requirements across Conventional, FHA (3.5%), VA (0%), and Jumbo loans. Analyze Loan-to-Value (LTV), monthly PMI drop-off, closing costs, and lifetime interest savings.",
  "category": "Finance",
  "faq": [
    {
      "q": "What is the minimum down payment required to buy a house in 2025/2026?",
      "a": "Minimum down payment depends entirely on loan program: Conventional loans for first-time home buyers require as little as 3% down (5% for repeat buyers). FHA loans insured by the Federal Housing Administration require 3.5% down for credit scores 580+. VA loans (for eligible veterans and active service members) and USDA loans (for designated rural properties) require 0% down. Jumbo loans typically require 10% to 20% down."
    },
    {
      "q": "How does putting 20% down save money compared to putting 5% or 10% down?",
      "a": "Putting 20% down completely eliminates Private Mortgage Insurance (PMI), saving between $150 and $450 per month on an average $400,000 home. Additionally, borrowing less principal reduces total monthly interest charges, shortens amortization, and typically secures a 0.25% to 0.50% lower interest rate APR from lenders."
    },
    {
      "q": "What is the difference between Conventional PMI and FHA MIP?",
      "a": "Conventional PMI automatically cancels by federal law once your principal balance reaches 78% of original property value (or you can request cancellation at 80% equity). By contrast, FHA Mortgage Insurance Premiums (MIP) for down payments under 10% NEVER cancel—it remains for the entire 30-year life of the loan unless you refinance into a conventional mortgage."
    },
    {
      "q": "How much additional cash do I need for closing costs on top of the down payment?",
      "a": "Closing costs typically average between 2% and 5% of the total loan purchase price. On a $400,000 home, expect $8,000 to $20,000 in closing costs covering lender origination fees, appraisal, title insurance, attorney fees, municipal transfer taxes, and escrow reserves for property taxes and homeowners insurance."
    },
    {
      "q": "Can my down payment be paid with gift money from family?",
      "a": "Yes. Most conventional and FHA lenders allow down payment gift funds from immediate family members. However, lenders strictly require a signed Gift Letter certifying that the funds are a true gift with no expectation of repayment, along with 30 to 60 days of bank statement paper trails to satisfy anti-money laundering (AML) underwriting standards."
    }
  ],
  "body": "\n    <div class=\"article-container\" style=\"max-width: 1020px;\">\n      <nav style=\"font-family: var(--mono); font-size: 0.8rem; margin-bottom: 1.5rem; color: var(--text-muted);\">\n        <a href=\"/\">Home</a> &gt; <a href=\"/finance/\">Finance</a> &gt; Down Payment Calculator\n      </nav>\n\n      <header style=\"margin-bottom: 2rem;\">\n        <div style=\"display: flex; gap: 0.5rem; align-items: center; margin-bottom: 0.5rem; flex-wrap: wrap;\">\n          <span class=\"badge badge-purple\">Flagship Mortgage Engine</span>\n          <span class=\"badge badge-green\">Zero Server Uploads</span>\n          <span class=\"badge badge-blue\">LTV &amp; PMI Simulator</span>\n        </div>\n        <h1 style=\"font-family: var(--serif); font-size: 2.3rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          Down Payment Calculator — Minimums, PMI Tiers &amp; LTV Analysis\n        </h1>\n        <p style=\"color: var(--text-muted); font-size: 1.05rem; line-height: 1.6;\">\n          Determine your required down payment across Conventional (3%/5%), FHA (3.5%), and VA/USDA (0%) mortgages. Analyze Loan-to-Value (LTV), monthly PMI costs, estimated cash to close, and lifetime interest savings.\n        </p>\n      </header>\n\n      <!-- INPUT BOX -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); padding: 1.75rem; border-radius: 8px; margin-bottom: 2rem;\">\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem; margin-bottom: 1.5rem;\">\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Home Purchase Price ($):</label>\n            <input type=\"number\" id=\"dp-price\" value=\"425000\" step=\"5000\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcDownPayment()\" />\n          </div>\n\n          <div>\n            <div style=\"display: flex; justify-content: space-between; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">\n              <span>Down Payment Percentage:</span>\n              <span id=\"dp-pct-badge\" style=\"color: #6366f1; font-family: var(--mono);\">10%</span>\n            </div>\n            <div style=\"display: flex; gap: 0.5rem;\">\n              <input type=\"range\" id=\"dp-slider\" min=\"0\" max=\"40\" value=\"10\" step=\"0.5\" style=\"width: 100%; vertical-align: middle;\" oninput=\"syncDpSlider(this.value)\" />\n            </div>\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Down Payment Amount ($):</label>\n            <input type=\"number\" id=\"dp-amount\" value=\"42500\" step=\"2500\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"syncDpAmount(this.value)\" />\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.85rem; font-weight: bold; margin-bottom: 0.4rem;\">Interest Rate (% APR):</label>\n            <input type=\"number\" id=\"dp-rate\" value=\"6.75\" step=\"0.125\" style=\"width: 100%; padding: 0.6rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"calcDownPayment()\" />\n          </div>\n        </div>\n\n        <!-- QUICK PRESETS ROW -->\n        <div style=\"display: flex; gap: 0.5rem; flex-wrap: wrap; margin-bottom: 1.5rem; border-top: 1px solid var(--border); padding-top: 1.25rem;\">\n          <span style=\"font-size: 0.8rem; font-weight: bold; color: var(--text-muted); align-self: center; margin-right: 0.25rem;\">Program Presets:</span>\n          <button type=\"button\" class=\"preset-btn\" onclick=\"applyDpPreset(0)\" style=\"padding: 0.35rem 0.75rem; border: 1px solid var(--border); background: var(--surface-alt); color: var(--fg); border-radius: 6px; font-size: 0.8rem; cursor: pointer;\">0% VA / USDA</button>\n          <button type=\"button\" class=\"preset-btn\" onclick=\"applyDpPreset(3)\" style=\"padding: 0.35rem 0.75rem; border: 1px solid var(--border); background: var(--surface-alt); color: var(--fg); border-radius: 6px; font-size: 0.8rem; cursor: pointer;\">3% Conventional 1st-Time</button>\n          <button type=\"button\" class=\"preset-btn\" onclick=\"applyDpPreset(3.5)\" style=\"padding: 0.35rem 0.75rem; border: 1px solid var(--border); background: var(--surface-alt); color: var(--fg); border-radius: 6px; font-size: 0.8rem; cursor: pointer;\">3.5% FHA</button>\n          <button type=\"button\" class=\"preset-btn\" onclick=\"applyDpPreset(5)\" style=\"padding: 0.35rem 0.75rem; border: 1px solid var(--border); background: var(--surface-alt); color: var(--fg); border-radius: 6px; font-size: 0.8rem; cursor: pointer;\">5% Standard Conventional</button>\n          <button type=\"button\" class=\"preset-btn\" onclick=\"applyDpPreset(10)\" style=\"padding: 0.35rem 0.75rem; border: 1px solid var(--border); background: var(--surface-alt); color: var(--fg); border-radius: 6px; font-size: 0.8rem; cursor: pointer;\">10% Balanced</button>\n          <button type=\"button\" class=\"preset-btn\" onclick=\"applyDpPreset(20)\" style=\"padding: 0.35rem 0.75rem; border: 1px solid #10b981; background: rgba(16, 185, 129, 0.1); color: #10b981; font-weight: bold; border-radius: 6px; font-size: 0.8rem; cursor: pointer;\">20% Zero PMI Threshold</button>\n        </div>\n\n        <!-- MAIN KPI RESULT CARDS -->\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;\">\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #6366f1;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Loan-to-Value (LTV) Ratio</div>\n            <div id=\"dp-ltv-ratio\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #6366f1; margin-bottom: 0.2rem;\">90.0%</div>\n            <div id=\"dp-loan-amt\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Loan Amount: $382,500</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #ef4444;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Estimated Monthly PMI</div>\n            <div id=\"dp-pmi-val\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #ef4444; margin-bottom: 0.2rem;\">$239 / mo</div>\n            <div id=\"dp-pmi-dropoff\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Cancels at 80% LTV (Year 9)</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #10b981;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Total Cash Needed at Closing</div>\n            <div id=\"dp-cash-needed\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #10b981; margin-bottom: 0.2rem;\">$55,250</div>\n            <div id=\"dp-closing-costs-sub\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Down Payment + 3% Closing Costs ($12,750)</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #3b82f6;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Monthly Principal &amp; Interest</div>\n            <div id=\"dp-monthly-pi\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #3b82f6; margin-bottom: 0.2rem;\">$2,480 / mo</div>\n            <div id=\"dp-monthly-total\" style=\"font-size: 0.85rem; color: var(--text-muted);\">P&amp;I + PMI = $2,719 / mo</div>\n          </div>\n        </div>\n      </div>\n\n      <!-- INTERACTIVE SVG LTV & EQUITY VISUALIZER -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.35rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          📊 Equity Share &amp; PMI Elimination Threshold\n        </h2>\n        <p style=\"font-size: 0.85rem; color: var(--text-muted); margin-bottom: 1.25rem;\">\n          Shows the proportion of home equity vs financed bank debt. PMI is legally required until initial or accumulated equity reaches the 20% threshold (80% LTV).\n        </p>\n\n        <div style=\"overflow-x: auto;\">\n          <svg id=\"dp-chart-svg\" viewBox=\"0 0 800 180\" style=\"width: 100%; height: auto; min-width: 600px; font-family: var(--mono);\"></svg>\n        </div>\n      </div>\n\n      <!-- DOWN PAYMENT PROGRAM COMPARISON TABLE -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h3 style=\"font-family: var(--serif); font-size: 1.25rem; margin-top: 0; margin-bottom: 1rem; color: var(--fg);\">\n          🏠 Down Payment Comparison by Mortgage Loan Type\n        </h3>\n        <div style=\"overflow-x: auto;\">\n          <table style=\"width: 100%; border-collapse: collapse; font-size: 0.9rem; text-align: left;\">\n            <thead>\n              <tr style=\"border-bottom: 2px solid var(--border); color: var(--text-muted);\">\n                <th style=\"padding: 0.6rem 0.75rem;\">Loan Program</th>\n                <th style=\"padding: 0.6rem 0.75rem;\">Min. Down Payment</th>\n                <th style=\"padding: 0.6rem 0.75rem;\">Cash Required on $<span id=\"tbl-prop-price\">425k</span></th>\n                <th style=\"padding: 0.6rem 0.75rem;\">Mortgage Insurance Rules</th>\n                <th style=\"padding: 0.6rem 0.75rem;\">Credit Score Threshold</th>\n              </tr>\n            </thead>\n            <tbody id=\"dp-table-body\">\n              <!-- Populated by JS -->\n            </tbody>\n          </table>\n        </div>\n      </div>\n\n      <!-- STEP-BY-STEP DERIVATION -->\n      <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h3 style=\"font-family: var(--mono); font-size: 0.9rem; text-transform: uppercase; color: var(--text-muted); margin: 0 0 0.75rem 0;\">\n          📐 Step-by-Step Down Payment &amp; LTV Mathematical Derivations\n        </h3>\n        <div id=\"dp-derivation-box\" style=\"font-family: var(--mono); font-size: 0.85rem; line-height: 1.7; color: var(--fg);\">\n          Computing live financing metrics...\n        </div>\n      </div>\n\n      <!-- ONE-CLICK COPY BUTTON -->\n      <div style=\"margin-bottom: 2.5rem;\">\n        <button type=\"button\" id=\"dp-copy-btn\" onclick=\"copyDownPaymentReport(this)\" class=\"btn btn-copy\" style=\"display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; font-size: 0.9rem; font-weight: 600; background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; cursor: pointer; color: var(--fg); transition: all 0.15s ease;\">\n          <span>📋</span> Copy Down Payment &amp; LTV Financing Breakdown\n        </button>\n      </div>\n\n      <!-- 5 FATAL TRAPS -->\n      <div style=\"margin: 2.5rem 0;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.45rem; margin-bottom: 0.75rem; color: var(--fg);\">\n          ⚠️ 5 Fatal Traps of Down Payments &amp; Cash to Close\n        </h2>\n        <div style=\"display: grid; grid-template-columns: 1fr; gap: 1rem;\">\n          <div class=\"trap-card\" style=\"border-left: 4px solid #ef4444;\">\n            <strong style=\"color: #ef4444;\">1. The \"20% Down or Nothing\" Waiting Trap</strong>\n            Many buyers delay purchasing a home for 5 to 7 years to accumulate a full 20% down payment to avoid PMI. However, if home prices appreciate at a normal 4% per year, a $400,000 home becomes $512,000 over 6 years. The buyer pays an extra $112,000 in purchase price and higher interest just to avoid $12,000 in temporary PMI fees.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #f59e0b;\">\n            <strong style=\"color: #f59e0b;\">2. FHA Mortgage Insurance Premium (MIP) Lifetime Trap</strong>\n            Unlike conventional loans where private mortgage insurance automatically terminates once you reach 80% equity, FHA loans with less than 10% down require monthly Mortgage Insurance Premiums (MIP) for the ENTIRE 30-year life of the loan. Borrowers who do not refinance into a conventional mortgage end up paying tens of thousands of dollars in unnecessary insurance decades after gaining equity.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #10b981;\">\n            <strong style=\"color: #10b981;\">3. Draining 100% of Liquid Cash Reserves</strong>\n            Putting every available dollar into the down payment leaves the new homeowner \"house rich and cash poor.\" Within the first 12 months of homeownership, unexpected expenses (HVAC failure, roof leaks, plumbing issues, lawn equipment, property tax reassessment spikes) average $4,000 to $9,000. Lenders typically prefer seeing at least 2 to 3 months of emergency mortgage payments in reserve.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #3b82f6;\">\n            <strong style=\"color: #3b82f6;\">4. Overlooking Closing Costs &amp; Escrow Prepaids (2%–5%)</strong>\n            Amateur home buyers frequently confuse \"down payment\" with \"cash needed at closing.\" On a $450,000 home with a 5% down payment ($22,500), closing costs (lender origination fees, appraisal, title search, transfer taxes, prepaid homeowners insurance, and property tax escrow) require an ADDITIONAL $11,000 to $18,000 in cash at the closing table.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #8b5cf6;\">\n            <strong style=\"color: #8b5cf6;\">5. Unseasoned Gift Funds &amp; Mattress Cash Underwriting Red Flags</strong>\n            Depositing unverified cash or receiving down payment assistance from relatives without formal documentation can halt mortgage underwriting days before closing. Federal anti-money laundering (AML) guidelines require all non-payroll funds to be seasoned in bank accounts for at least 60 days, accompanied by signed gift letters certifying no repayment obligations.\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <script>\n      function syncDpSlider(val) {\n        var price = parseFloat(document.getElementById('dp-price').value) || 425000;\n        var pct = parseFloat(val) || 10;\n        document.getElementById('dp-pct-badge').textContent = pct + '%';\n        var amt = (price * (pct / 100));\n        document.getElementById('dp-amount').value = Math.round(amt);\n        calcDownPayment();\n      }\n\n      function syncDpAmount(val) {\n        var price = parseFloat(document.getElementById('dp-price').value) || 425000;\n        var amt = parseFloat(val) || 0;\n        var pct = price > 0 ? ((amt / price) * 100) : 0;\n        pct = Math.round(pct * 10) / 10;\n        document.getElementById('dp-slider').value = pct;\n        document.getElementById('dp-pct-badge').textContent = pct + '%';\n        calcDownPayment();\n      }\n\n      function applyDpPreset(pct) {\n        document.getElementById('dp-slider').value = pct;\n        syncDpSlider(pct);\n      }\n\n      function calcDownPayment() {\n        var price = parseFloat(document.getElementById('dp-price').value) || 425000;\n        var amt = parseFloat(document.getElementById('dp-amount').value) || 0;\n        var rate = parseFloat(document.getElementById('dp-rate').value) || 6.75;\n\n        var pct = price > 0 ? (amt / price) : 0;\n        var loanAmt = Math.max(0, price - amt);\n        var ltv = price > 0 ? ((loanAmt / price) * 100) : 0;\n\n        // PMI estimation\n        // Conventional PMI averages 0.5% to 1.0% per year for LTV > 80%\n        var monthlyPmi = 0;\n        var pmiRate = 0;\n        if (ltv > 95) pmiRate = 0.0095;\n        else if (ltv > 90) pmiRate = 0.0075;\n        else if (ltv > 85) pmiRate = 0.0055;\n        else if (ltv > 80) pmiRate = 0.0035;\n\n        if (ltv > 80 && loanAmt > 0) {\n          monthlyPmi = (loanAmt * pmiRate) / 12;\n        }\n\n        // P&I Payment (30-year fixed)\n        var monthlyRate = (rate / 100) / 12;\n        var totalMonths = 360;\n        var monthlyPI = 0;\n        if (monthlyRate > 0 && loanAmt > 0) {\n          monthlyPI = loanAmt * (monthlyRate * Math.pow(1 + monthlyRate, totalMonths)) / (Math.pow(1 + monthlyRate, totalMonths) - 1);\n        }\n\n        // Closing costs estimate (average 3.0% of purchase price)\n        var closingCosts = price * 0.03;\n        var totalCashNeeded = amt + closingCosts;\n\n        // Years to 80% LTV drop-off\n        var balance = loanAmt;\n        var target80Balance = price * 0.80;\n        var monthsTo80 = 0;\n        while (balance > target80Balance && monthsTo80 < totalMonths) {\n          monthsTo80++;\n          var interestPmt = balance * monthlyRate;\n          var principalPmt = monthlyPI - interestPmt;\n          balance -= principalPmt;\n        }\n        var yearsTo80 = (monthsTo80 / 12).toFixed(1);\n\n        // Update KPIs\n        document.getElementById('dp-ltv-ratio').textContent = ltv.toFixed(1) + '%';\n        document.getElementById('dp-loan-amt').textContent = 'Loan Amount: $' + Math.round(loanAmt).toLocaleString();\n\n        var pmiEl = document.getElementById('dp-pmi-val');\n        var pmiDropEl = document.getElementById('dp-pmi-dropoff');\n        if (monthlyPmi > 0) {\n          pmiEl.textContent = '$' + Math.round(monthlyPmi).toLocaleString() + ' / mo';\n          pmiDropEl.textContent = 'Cancels at 80% LTV (~Year ' + yearsTo80 + ')';\n          pmiEl.style.color = '#ef4444';\n        } else {\n          pmiEl.textContent = '$0 / mo';\n          pmiDropEl.textContent = 'Zero PMI Required (≥20% Equity)';\n          pmiEl.style.color = '#10b981';\n        }\n\n        document.getElementById('dp-cash-needed').textContent = '$' + Math.round(totalCashNeeded).toLocaleString();\n        document.getElementById('dp-closing-costs-sub').textContent = 'Down Payment ($' + Math.round(amt).toLocaleString() + ') + ~3% Closing Costs ($' + Math.round(closingCosts).toLocaleString() + ')';\n\n        document.getElementById('dp-monthly-pi').textContent = '$' + Math.round(monthlyPI).toLocaleString() + ' / mo';\n        document.getElementById('dp-monthly-total').textContent = 'P&I + PMI = $' + Math.round(monthlyPI + monthlyPmi).toLocaleString() + ' / mo';\n\n        var propSpan = document.getElementById('tbl-prop-price');\n        if (propSpan) propSpan.textContent = Math.round(price / 1000) + 'k';\n\n        // Populate Comparison Table\n        var programs = [\n          { name: 'Conventional (First-Time Buyer)', minPct: 3.0, pmi: 'PMI required until 80% LTV; cancels automatically at 78%', score: '620+' },\n          { name: 'Conventional (Standard)', minPct: 5.0, pmi: 'PMI required until 80% LTV; cancels automatically at 78%', score: '620+' },\n          { name: 'FHA Loan (Government Insured)', minPct: 3.5, pmi: 'MIP required for entire 30-year life of loan (under 10% down)', score: '580+' },\n          { name: 'VA Loan (Veterans & Active Duty)', minPct: 0.0, pmi: 'Zero monthly PMI required (one-time VA Funding Fee applies)', score: '580–620' },\n          { name: 'USDA Loan (Rural Development)', minPct: 0.0, pmi: '0.35% annual guarantee fee (much lower than standard PMI)', score: '640+' },\n          { name: 'Conventional (20% Clean Equity)', minPct: 20.0, pmi: 'Zero PMI required; lowest available APR interest rate', score: '660+' }\n        ];\n\n        var tHtml = '';\n        programs.forEach(function(prog) {\n          var progCash = price * (prog.minPct / 100);\n          tHtml += '<tr style=\"border-bottom: 1px solid var(--border);\">' +\n            '<td style=\"padding: 0.6rem 0.75rem; font-weight: 600;\">' + prog.name + '</td>' +\n            '<td style=\"padding: 0.6rem 0.75rem; font-family: var(--mono); color: #6366f1;\">' + prog.minPct + '%</td>' +\n            '<td style=\"padding: 0.6rem 0.75rem; font-family: var(--mono); font-weight: bold;\">$' + Math.round(progCash).toLocaleString() + '</td>' +\n            '<td style=\"padding: 0.6rem 0.75rem; font-size: 0.82rem; color: var(--text-muted);\">' + prog.pmi + '</td>' +\n            '<td style=\"padding: 0.6rem 0.75rem; font-family: var(--mono); font-size: 0.85rem;\">' + prog.score + '</td>' +\n          '</tr>';\n        });\n        document.getElementById('dp-table-body').innerHTML = tHtml;\n\n        // Derivation Box\n        var dBox = document.getElementById('dp-derivation-box');\n        dBox.innerHTML = '<strong>1. Down Payment Percentage:</strong> $' + Math.round(amt).toLocaleString() + ' / $' + Math.round(price).toLocaleString() + ' = <strong>' + (pct * 100).toFixed(1) + '%</strong>.<br>' +\n          '<strong>2. Loan Principal (P):</strong> Purchase Price - Down Payment = <strong>$' + Math.round(loanAmt).toLocaleString() + '</strong>.<br>' +\n          '<strong>3. Loan-to-Value (LTV):</strong> ($' + Math.round(loanAmt).toLocaleString() + ' / $' + Math.round(price).toLocaleString() + ') × 100 = <strong>' + ltv.toFixed(1) + '%</strong>.<br>' +\n          '<strong>4. Private Mortgage Insurance (PMI):</strong> ' + (monthlyPmi > 0 ? 'LTV (' + ltv.toFixed(1) + '%) > 80% requires ~' + (pmiRate * 100).toFixed(2) + '% annual PMI = <strong>$' + Math.round(monthlyPmi).toLocaleString() + ' / mo</strong>' : 'LTV (' + ltv.toFixed(1) + '%) ≤ 80% qualifies for <strong>$0 / mo PMI</strong>') + '.<br>' +\n          '<strong>5. Total Cash Needed at Settlement:</strong> Down Payment ($' + Math.round(amt).toLocaleString() + ') + 3% Estimated Closing Reserves ($' + Math.round(closingCosts).toLocaleString() + ') = <strong>$' + Math.round(totalCashNeeded).toLocaleString() + '</strong>.';\n\n        // Render Chart\n        renderDpChartSvg(pct, ltv);\n      }\n\n      function renderDpChartSvg(downPct, ltvPct) {\n        var svg = document.getElementById('dp-chart-svg');\n        if (!svg) return;\n\n        var w = 800, h = 180;\n        var barX = 60, barY = 70, barW = 680, barH = 36;\n\n        var equityW = (downPct / 100) * barW;\n        var debtW = barW - equityW;\n\n        var threshold20X = barX + (0.20 * barW);\n\n        var svgHtml = '';\n\n        // Financed Debt Bar (Purple/Blue)\n        svgHtml += '<rect x=\"' + barX + '\" y=\"' + barY + '\" width=\"' + barW + '\" height=\"' + barH + '\" fill=\"#ef4444\" opacity=\"0.8\" rx=\"6\"><title>Financed Loan Balance</title></rect>';\n\n        // Equity Bar (Green)\n        if (equityW > 0) {\n          svgHtml += '<rect x=\"' + (barX + barW - equityW) + '\" y=\"' + barY + '\" width=\"' + equityW + '\" height=\"' + barH + '\" fill=\"#10b981\" rx=\"0 6 6 0\"><title>Down Payment Equity</title></rect>';\n        }\n\n        // 20% PMI threshold line\n        svgHtml += '<line x1=\"' + (barX + barW - (0.20 * barW)) + '\" y1=\"30\" x2=\"' + (barX + barW - (0.20 * barW)) + '\" y2=\"' + (barY + barH + 20) + '\" stroke=\"#6366f1\" stroke-width=\"2.5\" stroke-dasharray=\"4,3\" />';\n        svgHtml += '<text x=\"' + (barX + barW - (0.20 * barW)) + '\" y=\"22\" fill=\"#6366f1\" font-size=\"11\" font-weight=\"bold\" text-anchor=\"middle\">20% Equity (Zero PMI Cutoff)</text>';\n\n        // Labels\n        svgHtml += '<text x=\"' + (barX + 15) + '\" y=\"' + (barY + 23) + '\" fill=\"#ffffff\" font-size=\"13\" font-weight=\"bold\">Bank Debt: ' + ltvPct.toFixed(1) + '%</text>';\n        if (downPct >= 8) {\n          svgHtml += '<text x=\"' + (barX + barW - 15) + '\" y=\"' + (barY + 23) + '\" fill=\"#ffffff\" font-size=\"13\" font-weight=\"bold\" text-anchor=\"end\">Equity: ' + downPct.toFixed(1) + '%</text>';\n        }\n\n        // Ticks\n        svgHtml += '<text x=\"' + barX + '\" y=\"' + (barY + barH + 20) + '\" fill=\"var(--text-muted)\" font-size=\"11\">0%</text>';\n        svgHtml += '<text x=\"' + (barX + barW/2) + '\" y=\"' + (barY + barH + 20) + '\" fill=\"var(--text-muted)\" font-size=\"11\" text-anchor=\"middle\">50%</text>';\n        svgHtml += '<text x=\"' + (barX + barW) + '\" y=\"' + (barY + barH + 20) + '\" fill=\"var(--text-muted)\" font-size=\"11\" text-anchor=\"end\">100%</text>';\n\n        svg.innerHTML = svgHtml;\n      }\n\n      function copyDownPaymentReport(btn) {\n        var price = document.getElementById('dp-price').value;\n        var amt = document.getElementById('dp-amount').value;\n        var ltv = document.getElementById('dp-ltv-ratio').textContent;\n        var pmi = document.getElementById('dp-pmi-val').textContent;\n        var cash = document.getElementById('dp-cash-needed').textContent;\n        var pi = document.getElementById('dp-monthly-pi').textContent;\n\n        var text = '🏡 DOWN PAYMENT & LTV FINANCING REPORT\\n' +\n          '====================================================\\n' +\n          '• Home Purchase Price: $' + parseFloat(price).toLocaleString() + '\\n' +\n          '• Down Payment: $' + parseFloat(amt).toLocaleString() + '\\n' +\n          '• Loan-to-Value (LTV): ' + ltv + '\\n' +\n          '• Monthly P&I Payment: ' + pi + '\\n' +\n          '• Private Mortgage Insurance (PMI): ' + pmi + '\\n' +\n          '• Total Estimated Cash to Close: ' + cash + '\\n' +\n          '----------------------------------------------------\\n' +\n          'Financing Note: Conventional PMI cancels at 80% LTV.\\n' +\n          'Calculated via Digital Tools Shed: https://digitaltoolsshed.com/finance/down-payment-calculator';\n\n        navigator.clipboard.writeText(text).then(function() {\n          if (btn) {\n            var orig = btn.innerHTML;\n            btn.innerHTML = '<span>✓</span> Financing Breakdown Copied!';\n            btn.style.borderColor = '#10b981';\n            btn.style.color = '#10b981';\n            setTimeout(function() {\n              btn.innerHTML = orig;\n              btn.style.borderColor = 'var(--border)';\n              btn.style.color = 'var(--fg)';\n            }, 2000);\n          }\n        });\n      }\n\n      if (document.readyState === 'loading') {\n        document.addEventListener('DOMContentLoaded', calcDownPayment);\n      } else {\n        calcDownPayment();\n      }\n    </script>\n  "
},
