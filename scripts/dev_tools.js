  ...
  const tools = [
{
  ...
  "title": "Resistor Color Code Calculator — 4-Band, 5-Band & 6-Band (Interactive SVG & Reverse Solver)",
  "metaDesc": "Calculate resistance values, tolerances, and temperature coefficients for 4-band, 5-band, and 6-band resistors (IEC 60062). Features interactive colored resistor SVG graphic and instant reverse resistance-to-bands solver.",
  "category": "Developer",
  "faq": [
    {
      "q": "How do you read a 4-band resistor color code?",
      "a": "For a standard 4-band resistor: Band 1 is the first significant digit, Band 2 is the second significant digit, Band 3 is the decimal multiplier (power of 10), and Band 4 is the manufacturing tolerance (typically Gold for ±5% or Silver for ±10%). For example: Yellow (4) - Violet (7) - Red (100) - Gold (±5%) equals 4,700Ω or 4.7kΩ ±5%."
    },
    {
      "q": "How do you determine which end of a resistor to read first?",
      "a": "Look for the tolerance band: Gold or Silver bands are almost always the tolerance and belong on the far right. Additionally, manufacturers leave a noticeably wider physical gap between the multiplier band and the tolerance band. On precision 5-band or 6-band resistors, the first band is typically printed closer to the lead edge."
    },
    {
      "q": "What is the 6th band on a 6-band resistor?",
      "a": "The sixth band indicates the Temperature Coefficient of Resistance (TCR), expressed in parts per million per Kelvin (ppm/K or ppm/°C). It specifies how much the resistance value will drift as operating temperature fluctuates. Common TCR colors include Brown (100 ppm/K), Red (50 ppm/K), Orange (15 ppm/K), and Yellow (25 ppm/K)."
    },
    {
      "q": "Why do resistors use standard E-series values instead of round numbers?",
      "a": "Resistors follow logarithmic standard decade series (E12, E24, E96) defined by IEC 60063 so that each value's tolerance range overlaps seamlessly with adjacent values without gaps or redundancies. In the 10% E12 series, values are spaced by roughly 1.21x (1.0, 1.2, 1.5, 1.8, 2.2, 2.7, 3.3, 3.9, 4.7, 5.6, 6.8, 8.2)."
    },
    {
      "q": "Do resistor color codes indicate the maximum power or wattage rating?",
      "a": "No. The color code indicates resistance, tolerance, and TCR only. Power ratings (e.g. 1/8W, 1/4W, 1/2W, 1W, 2W) are determined by the physical body size and material composition (carbon film, metal film, wirewound, or ceramic cement) of the component."
    }
  ],
  "body": "\n    <div class=\"article-container\" style=\"max-width: 1020px;\">\n      <nav style=\"font-family: var(--mono); font-size: 0.8rem; margin-bottom: 1.5rem; color: var(--text-muted);\">\n        <a href=\"/\">Home</a> &gt; <a href=\"/dev/\">Developer Tools</a> &gt; Resistor Color Code\n      </nav>\n\n      <header style=\"margin-bottom: 2rem;\">\n        <div style=\"display: flex; gap: 0.5rem; align-items: center; margin-bottom: 0.5rem; flex-wrap: wrap;\">\n          <span class=\"badge badge-purple\">IEC 60062 Standard</span>\n          <span class=\"badge badge-green\">Bidirectional Reverse Solver</span>\n          <span class=\"badge badge-blue\">Zero Server Uploads</span>\n        </div>\n        <h1 style=\"font-family: var(--serif); font-size: 2.3rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          Resistor Color Code Calculator &amp; Reverse Solver\n        </h1>\n        <p style=\"color: var(--text-muted); font-size: 1.05rem; line-height: 1.6;\">\n          Decode 4-band, 5-band, and 6-band axial resistors with real-time vector graphics. Features bidirectional reverse lookup: enter any resistance (e.g. 4.7kΩ) to instantly paint the exact color bands.\n        </p>\n      </header>\n\n      <!-- CALCULATOR BOX -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); padding: 1.75rem; border-radius: 8px; margin-bottom: 2rem;\">\n        <div style=\"display: flex; gap: 0.5rem; margin-bottom: 1.5rem; flex-wrap: wrap;\">\n          <button type=\"button\" id=\"res-tab-4\" onclick=\"setResBands(4)\" style=\"padding: 0.55rem 1.1rem; border-radius: 6px; font-weight: 600; font-size: 0.85rem; cursor: pointer; background: #6366f1; color: #fff; border: 1px solid #6366f1;\">\n            4-Band Resistor (Standard)\n          </button>\n          <button type=\"button\" id=\"res-tab-5\" onclick=\"setResBands(5)\" style=\"padding: 0.55rem 1.1rem; border-radius: 6px; font-weight: 600; font-size: 0.85rem; cursor: pointer; background: var(--surface-alt); color: var(--fg); border: 1px solid var(--border);\">\n            5-Band Resistor (Precision 1%)\n          </button>\n          <button type=\"button\" id=\"res-tab-6\" onclick=\"setResBands(6)\" style=\"padding: 0.55rem 1.1rem; border-radius: 6px; font-weight: 600; font-size: 0.85rem; cursor: pointer; background: var(--surface-alt); color: var(--fg); border: 1px solid var(--border);\">\n            6-Band Resistor (High Precision + TCR)\n          </button>\n        </div>\n\n        <!-- REVERSE SOLVER QUICK INPUT -->\n        <div style=\"background: var(--bg); border: 1px solid var(--border); border-radius: 6px; padding: 1rem; margin-bottom: 1.5rem;\">\n          <label style=\"display: block; font-size: 0.8rem; font-weight: bold; margin-bottom: 0.4rem; color: #6366f1;\">\n            ⚡ Instant Reverse Solver (Type Resistance to Paint Bands):\n          </label>\n          <div style=\"display: flex; gap: 0.75rem; flex-wrap: wrap;\">\n            <input type=\"text\" id=\"res-reverse-input\" placeholder=\"e.g. 4.7k, 220, 1M, 10R\" style=\"flex: 1; min-width: 180px; padding: 0.6rem; background: var(--surface); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-family: var(--mono); font-size: 1.1rem;\" oninput=\"solveReverseResistor(this.value)\" />\n            <button type=\"button\" onclick=\"applyQuickResistor(100)\" style=\"padding: 0.5rem 0.75rem; font-family: var(--mono); font-size: 0.85rem; background: var(--surface); border: 1px solid var(--border); border-radius: 4px; cursor: pointer; color: var(--fg);\">100Ω</button>\n            <button type=\"button\" onclick=\"applyQuickResistor(1000)\" style=\"padding: 0.5rem 0.75rem; font-family: var(--mono); font-size: 0.85rem; background: var(--surface); border: 1px solid var(--border); border-radius: 4px; cursor: pointer; color: var(--fg);\">1kΩ</button>\n            <button type=\"button\" onclick=\"applyQuickResistor(4700)\" style=\"padding: 0.5rem 0.75rem; font-family: var(--mono); font-size: 0.85rem; background: var(--surface); border: 1px solid var(--border); border-radius: 4px; cursor: pointer; color: var(--fg);\">4.7kΩ</button>\n            <button type=\"button\" onclick=\"applyQuickResistor(10000)\" style=\"padding: 0.5rem 0.75rem; font-family: var(--mono); font-size: 0.85rem; background: var(--surface); border: 1px solid var(--border); border-radius: 4px; cursor: pointer; color: var(--fg);\">10kΩ</button>\n            <button type=\"button\" onclick=\"applyQuickResistor(100000)\" style=\"padding: 0.5rem 0.75rem; font-family: var(--mono); font-size: 0.85rem; background: var(--surface); border: 1px solid var(--border); border-radius: 4px; cursor: pointer; color: var(--fg);\">100kΩ</button>\n          </div>\n        </div>\n\n        <!-- BAND SELECTORS GRID -->\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(135px, 1fr)); gap: 0.75rem; margin-bottom: 1.5rem;\">\n          <div>\n            <label style=\"display: block; font-size: 0.75rem; font-weight: bold; text-transform: uppercase; margin-bottom: 0.3rem;\">1st Band (Digit)</label>\n            <select id=\"band1\" style=\"width: 100%; padding: 0.55rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-size: 0.85rem;\" onchange=\"calcResistor()\"></select>\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.75rem; font-weight: bold; text-transform: uppercase; margin-bottom: 0.3rem;\">2nd Band (Digit)</label>\n            <select id=\"band2\" style=\"width: 100%; padding: 0.55rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-size: 0.85rem;\" onchange=\"calcResistor()\"></select>\n          </div>\n\n          <div id=\"grp-band3-digit\" style=\"display: none;\">\n            <label style=\"display: block; font-size: 0.75rem; font-weight: bold; text-transform: uppercase; margin-bottom: 0.3rem;\">3rd Band (Digit)</label>\n            <select id=\"band3\" style=\"width: 100%; padding: 0.55rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-size: 0.85rem;\" onchange=\"calcResistor()\"></select>\n          </div>\n\n          <div>\n            <label id=\"lbl-mult\" style=\"display: block; font-size: 0.75rem; font-weight: bold; text-transform: uppercase; margin-bottom: 0.3rem;\">3rd Band (Multiplier)</label>\n            <select id=\"bandMult\" style=\"width: 100%; padding: 0.55rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-size: 0.85rem;\" onchange=\"calcResistor()\"></select>\n          </div>\n\n          <div>\n            <label style=\"display: block; font-size: 0.75rem; font-weight: bold; text-transform: uppercase; margin-bottom: 0.3rem;\">Tolerance Band</label>\n            <select id=\"bandTol\" style=\"width: 100%; padding: 0.55rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-size: 0.85rem;\" onchange=\"calcResistor()\"></select>\n          </div>\n\n          <div id=\"grp-band-tcr\" style=\"display: none;\">\n            <label style=\"display: block; font-size: 0.75rem; font-weight: bold; text-transform: uppercase; margin-bottom: 0.3rem;\">6th Band (TCR)</label>\n            <select id=\"bandTcr\" style=\"width: 100%; padding: 0.55rem; background: var(--bg); color: var(--fg); border: 1px solid var(--border); border-radius: 4px; font-size: 0.85rem;\" onchange=\"calcResistor()\"></select>\n          </div>\n        </div>\n\n        <!-- MAIN RESULT KPI CARDS -->\n        <div style=\"display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.25rem;\">\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #6366f1;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Nominal Resistance</div>\n            <div id=\"res-val-primary\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #6366f1; margin-bottom: 0.2rem;\">4.7 kΩ</div>\n            <div id=\"res-val-ohms\" style=\"font-size: 0.85rem; color: var(--text-muted);\">4,700 Ohms (Ω)</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #10b981;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Tolerance &amp; Range</div>\n            <div id=\"res-val-tol\" style=\"font-family: var(--mono); font-size: 2.2rem; font-weight: bold; color: #10b981; margin-bottom: 0.2rem;\">±5%</div>\n            <div id=\"res-val-range\" style=\"font-size: 0.85rem; color: var(--text-muted);\">4,465 Ω to 4,935 Ω</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #3b82f6;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Standard EIA Decade Series</div>\n            <div id=\"res-val-eia\" style=\"font-family: var(--mono); font-size: 1.8rem; font-weight: bold; color: #3b82f6; margin-bottom: 0.2rem;\">E12 / E24 Standard</div>\n            <div style=\"font-size: 0.85rem; color: var(--text-muted);\">Commercial off-the-shelf value</div>\n          </div>\n\n          <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; padding: 1.25rem; text-align: center; border-top: 4px solid #f59e0b;\">\n            <div style=\"font-family: var(--mono); font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin-bottom: 0.3rem;\">Color Sequence</div>\n            <div id=\"res-val-sequence\" style=\"font-family: var(--mono); font-size: 1.1rem; font-weight: bold; color: #f59e0b; margin-bottom: 0.2rem;\">Yellow - Violet - Red - Gold</div>\n            <div id=\"res-val-tcr\" style=\"font-size: 0.85rem; color: var(--text-muted);\">Standard Temperature Coeff</div>\n          </div>\n        </div>\n      </div>\n\n      <!-- INTERACTIVE SVG RESISTOR RENDERING -->\n      <div style=\"background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem; text-align: center;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.35rem; margin-bottom: 0.5rem; color: var(--fg);\">\n          🎨 Real-Time Vector Resistor Component\n        </h2>\n        <p style=\"font-size: 0.85rem; color: var(--text-muted); margin-bottom: 1.25rem;\">\n          IEC 60062 compliant axial through-hole resistor with dynamic color bands rendered in browser memory.\n        </p>\n\n        <div style=\"overflow-x: auto;\">\n          <svg id=\"resistor-svg\" viewBox=\"0 0 740 180\" style=\"max-width: 740px; width: 100%; height: auto; font-family: var(--mono);\"></svg>\n        </div>\n      </div>\n\n      <!-- STEP-BY-STEP DERIVATION BOX -->\n      <div style=\"background: var(--surface-alt); border: 1px solid var(--border); border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem;\">\n        <h3 style=\"font-family: var(--mono); font-size: 0.9rem; text-transform: uppercase; color: var(--text-muted); margin: 0 0 0.75rem 0;\">\n          📐 Step-by-Step IEC 60062 Color Code Derivations\n        </h3>\n        <div id=\"res-derivation-box\" style=\"font-family: var(--mono); font-size: 0.85rem; line-height: 1.7; color: var(--fg);\">\n          Computing live color code metrics...\n        </div>\n      </div>\n\n      <!-- ONE-CLICK COPY BUTTON -->\n      <div style=\"margin-bottom: 2.5rem;\">\n        <button type=\"button\" id=\"res-copy-btn\" onclick=\"copyResistorReport(this)\" class=\"btn btn-copy\" style=\"display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; font-size: 0.9rem; font-weight: 600; background: var(--surface-alt); border: 1px solid var(--border); border-radius: 6px; cursor: pointer; color: var(--fg); transition: all 0.15s ease;\">\n          <span>📋</span> Copy Resistor Specifications &amp; Color Bands\n        </button>\n      </div>\n\n      <!-- 5 FATAL TRAPS -->\n      <div style=\"margin: 2.5rem 0;\">\n        <h2 style=\"font-family: var(--serif); font-size: 1.45rem; margin-bottom: 0.75rem; color: var(--fg);\">\n          ⚠️ 5 Fatal Traps of Resistor Color Codes &amp; Electronics Assembly\n        </h2>\n        <div style=\"display: grid; grid-template-columns: 1fr; gap: 1rem;\">\n          <div class=\"trap-card\" style=\"border-left: 4px solid #ef4444;\">\n            <strong style=\"color: #ef4444;\">1. Reading the Resistor from the Wrong Side</strong>\n            Reading an axial resistor backwards is the most frequent prototyping error. A 4.7kΩ 5% resistor (Yellow - Violet - Red - Gold) read in reverse appears as Gold - Red - Violet - Yellow (nonsensical) or Gold is mistaken for Brown (1.2kΩ). Always look for the Gold/Silver tolerance band or the wider space separation to anchor the right-hand end.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #f59e0b;\">\n            <strong style=\"color: #f59e0b;\">2. Gold and Silver Multiplier vs. Tolerance Confusion</strong>\n            Gold and Silver serve dual functions in IEC 60062: When placed in the 3rd or 4th band, Gold is a 0.1 multiplier and Silver is a 0.01 multiplier (e.g. Red - Red - Gold is 2.2Ω). When placed in the final band, Gold signifies ±5% tolerance and Silver signifies ±10%. Confusing multiplier position with tolerance produces 100x errors.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #10b981;\">\n            <strong style=\"color: #10b981;\">3. Power Dissipation (Wattage) Blindspot</strong>\n            Color bands specify resistance and tolerance, but NEVER physical wattage rating. Placing a standard 1/4-watt (0.25W) resistor into a 12V automotive circuit drawing 100mA results in $P = I^2 R = 1.2\\text{W}$ of heat dissipation. The resistor will scorch, emit toxic smoke, and desolder itself from the PCB.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #3b82f6;\">\n            <strong style=\"color: #3b82f6;\">4. SMD Numeric vs EIA-96 Code Mismatches</strong>\n            Surface mount (SMD) resistors do not use color bands. Instead, 3-digit SMD codes (e.g. 103) mean $10 \\times 10^3 = 10,000\\Omega = 10\\text{k}\\Omega$, NOT 103Ω. In precision 1% EIA-96 codes, '01Y' represents $100 \\times 0.01 = 1.0\\Omega$, where letters designate logarithmic multipliers.\n          </div>\n          <div class=\"trap-card\" style=\"border-left: 4px solid #8b5cf6;\">\n            <strong style=\"color: #8b5cf6;\">5. Thermal Resistance Drift in Audio &amp; Sensor Circuits</strong>\n            Cheap carbon composition resistors have severe Temperature Coefficients of Resistance (TCR > 500 ppm/K) and high voltage coefficients, causing resistance to drift by 5% to 10% during heavy operation. Precision instrumentation, analog synthesizers, and operational amplifier feedback loops require 1% or 0.1% metal film resistors with low TCR (< 50 ppm/K).\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <script>\n      var curResBands = 4;\n\n      var colorMap = [\n        { name: 'Black', digit: 0, mult: 1, tol: null, tcr: null, hex: '#1e293b', text: '#fff' },\n        { name: 'Brown', digit: 1, mult: 10, tol: 1, tcr: 100, hex: '#854d0e', text: '#fff' },\n        { name: 'Red', digit: 2, mult: 100, tol: 2, tcr: 50, hex: '#dc2626', text: '#fff' },\n        { name: 'Orange', digit: 3, mult: 1000, tol: 0.05, tcr: 15, hex: '#ea580c', text: '#fff' },\n        { name: 'Yellow', digit: 4, mult: 10000, tol: 0.02, tcr: 25, hex: '#eab308', text: '#000' },\n        { name: 'Green', digit: 5, mult: 100000, tol: 0.5, tcr: null, hex: '#16a34a', text: '#fff' },\n        { name: 'Blue', digit: 6, mult: 1000000, tol: 0.25, tcr: 10, hex: '#2563eb', text: '#fff' },\n        { name: 'Violet', digit: 7, mult: 10000000, tol: 0.1, tcr: 5, hex: '#9333ea', text: '#fff' },\n        { name: 'Gray', digit: 8, mult: 100000000, tol: 0.01, tcr: null, hex: '#64748b', text: '#fff' },\n        { name: 'White', digit: 9, mult: 1000000000, tol: null, tcr: 1, hex: '#f8fafc', text: '#000' },\n        { name: 'Gold', digit: null, mult: 0.1, tol: 5, tcr: null, hex: '#d97706', text: '#fff' },\n        { name: 'Silver', digit: null, mult: 0.01, tol: 10, tcr: null, hex: '#94a3b8', text: '#000' }\n      ];\n\n      function populateSelects() {\n        var b1 = document.getElementById('band1');\n        var b2 = document.getElementById('band2');\n        var b3 = document.getElementById('band3');\n        var bm = document.getElementById('bandMult');\n        var bt = document.getElementById('bandTol');\n        var btc = document.getElementById('bandTcr');\n\n        b1.innerHTML = '';\n        b2.innerHTML = '';\n        b3.innerHTML = '';\n        bm.innerHTML = '';\n        bt.innerHTML = '';\n        btc.innerHTML = '';\n\n        colorMap.forEach(function(c) {\n          if (c.digit !== null) {\n            b1.innerHTML += '<option value=\"' + c.name + '\">' + c.name + ' (' + c.digit + ')</option>';\n            b2.innerHTML += '<option value=\"' + c.name + '\">' + c.name + ' (' + c.digit + ')</option>';\n            b3.innerHTML += '<option value=\"' + c.name + '\">' + c.name + ' (' + c.digit + ')</option>';\n          }\n          if (c.mult !== null) {\n            var multLbl = c.mult >= 1000000 ? (c.mult/1000000) + 'M' : (c.mult >= 1000 ? (c.mult/1000) + 'k' : c.mult);\n            bm.innerHTML += '<option value=\"' + c.name + '\">' + c.name + ' (×' + multLbl + ')</option>';\n          }\n          if (c.tol !== null) {\n            bt.innerHTML += '<option value=\"' + c.name + '\">' + c.name + ' (±' + c.tol + '%)</option>';\n          }\n          if (c.tcr !== null) {\n            btc.innerHTML += '<option value=\"' + c.name + '\">' + c.name + ' (' + c.tcr + ' ppm/K)</option>';\n          }\n        });\n\n        // Set initial 4.7k 5%\n        b1.value = 'Yellow';\n        b2.value = 'Violet';\n        b3.value = 'Black';\n        bm.value = 'Red';\n        bt.value = 'Gold';\n        btc.value = 'Brown';\n      }\n\n      function setResBands(n) {\n        curResBands = n;\n        ['4', '5', '6'].forEach(function(b) {\n          var btn = document.getElementById('res-tab-' + b);\n          if (b === String(n)) {\n            btn.style.background = '#6366f1';\n            btn.style.color = '#fff';\n            btn.style.borderColor = '#6366f1';\n          } else {\n            btn.style.background = 'var(--surface-alt)';\n            btn.style.color = 'var(--fg)';\n            btn.style.borderColor = 'var(--border)';\n          }\n        });\n\n        var grpB3 = document.getElementById('grp-band3-digit');\n        var grpTcr = document.getElementById('grp-band-tcr');\n        var lblMult = document.getElementById('lbl-mult');\n\n        if (n === 4) {\n          grpB3.style.display = 'none';\n          grpTcr.style.display = 'none';\n          lblMult.textContent = '3rd Band (Multiplier)';\n        } else if (n === 5) {\n          grpB3.style.display = 'block';\n          grpTcr.style.display = 'none';\n          lblMult.textContent = '4th Band (Multiplier)';\n        } else if (n === 6) {\n          grpB3.style.display = 'block';\n          grpTcr.style.display = 'block';\n          lblMult.textContent = '4th Band (Multiplier)';\n        }\n\n        calcResistor();\n      }\n\n      function getColorObj(name) {\n        for (var i = 0; i < colorMap.length; i++) {\n          if (colorMap[i].name === name) return colorMap[i];\n        }\n        return colorMap[0];\n      }\n\n      function formatOhms(ohms) {\n        if (ohms >= 1e6) return (ohms / 1e6).toFixed(ohms % 1e6 === 0 ? 0 : 2) + ' MΩ';\n        if (ohms >= 1e3) return (ohms / 1e3).toFixed(ohms % 1e3 === 0 ? 0 : 2) + ' kΩ';\n        return ohms.toFixed(ohms % 1 === 0 ? 0 : 2) + ' Ω';\n      }\n\n      function calcResistor() {\n        var c1 = getColorObj(document.getElementById('band1').value);\n        var c2 = getColorObj(document.getElementById('band2').value);\n        var c3 = getColorObj(document.getElementById('band3').value);\n        var cm = getColorObj(document.getElementById('bandMult').value);\n        var ct = getColorObj(document.getElementById('bandTol').value);\n        var ctc = getColorObj(document.getElementById('bandTcr').value);\n\n        var digits = 0;\n        var seq = [];\n\n        if (curResBands === 4) {\n          digits = (c1.digit * 10) + c2.digit;\n          seq = [c1.name, c2.name, cm.name, ct.name];\n        } else if (curResBands === 5) {\n          digits = (c1.digit * 100) + (c2.digit * 10) + c3.digit;\n          seq = [c1.name, c2.name, c3.name, cm.name, ct.name];\n        } else if (curResBands === 6) {\n          digits = (c1.digit * 100) + (c2.digit * 10) + c3.digit;\n          seq = [c1.name, c2.name, c3.name, cm.name, ct.name, ctc.name];\n        }\n\n        var totalOhms = digits * cm.mult;\n        var tolPct = ct.tol || 5;\n        var delta = totalOhms * (tolPct / 100);\n        var minOhms = Math.max(0, totalOhms - delta);\n        var maxOhms = totalOhms + delta;\n\n        // Update KPIs\n        document.getElementById('res-val-primary').textContent = formatOhms(totalOhms);\n        document.getElementById('res-val-ohms').textContent = Math.round(totalOhms).toLocaleString() + ' Ohms (Ω)';\n        document.getElementById('res-val-tol').textContent = '±' + tolPct + '%';\n        document.getElementById('res-val-range').textContent = formatOhms(minOhms) + ' to ' + formatOhms(maxOhms);\n        document.getElementById('res-val-sequence').textContent = seq.join(' - ');\n\n        var tcrSub = document.getElementById('res-val-tcr');\n        if (curResBands === 6 && ctc.tcr) {\n          tcrSub.textContent = 'Temperature Coeff: ' + ctc.tcr + ' ppm/K';\n        } else {\n          tcrSub.textContent = 'Commercial Standard TCR';\n        }\n\n        // Derivation Box\n        var dBox = document.getElementById('res-derivation-box');\n        dBox.innerHTML = '<strong>1. Significant Digits:</strong> ' + (curResBands === 4 ? c1.name + ' (' + c1.digit + ') and ' + c2.name + ' (' + c2.digit + ') = <strong>' + digits + '</strong>' : c1.name + ' (' + c1.digit + '), ' + c2.name + ' (' + c2.digit + '), and ' + c3.name + ' (' + c3.digit + ') = <strong>' + digits + '</strong>') + '.<br>' +\n          '<strong>2. Multiplier Factor:</strong> ' + cm.name + ' (×' + cm.mult + ') → ' + digits + ' × ' + cm.mult + ' = <strong>' + formatOhms(totalOhms) + '</strong>.<br>' +\n          '<strong>3. Tolerance Margin:</strong> ' + ct.name + ' (±' + tolPct + '%) → Range: ' + formatOhms(minOhms) + ' to ' + formatOhms(maxOhms) + '.<br>' +\n          (curResBands === 6 ? '<strong>4. Thermal Drift (TCR):</strong> ' + ctc.name + ' = <strong>' + ctc.tcr + ' ppm/K</strong> drift per °C temperature variance.<br>' : '') +\n          '<strong>5. Complete IEC Color Sequence:</strong> <strong>' + seq.join(' → ') + '</strong>.';\n\n        // Render SVG\n        renderResistorSvg(seq);\n      }\n\n      function renderResistorSvg(bands) {\n        var svg = document.getElementById('resistor-svg');\n        if (!svg) return;\n\n        var w = 740, h = 180;\n        var bodyW = 380, bodyH = 80;\n        var bodyX = (w - bodyW) / 2;\n        var bodyY = (h - bodyH) / 2;\n\n        var svgHtml = '';\n\n        // Metallic Leads\n        svgHtml += '<rect x=\"30\" y=\"' + (h/2 - 5) + '\" width=\"' + (bodyX - 30 + 10) + '\" height=\"10\" fill=\"#cbd5e1\" stroke=\"#94a3b8\" stroke-width=\"1.5\" rx=\"2\" />';\n        svgHtml += '<rect x=\"' + (bodyX + bodyW - 10) + '\" y=\"' + (h/2 - 5) + '\" width=\"' + (w - 30 - (bodyX + bodyW - 10)) + '\" height=\"10\" fill=\"#cbd5e1\" stroke=\"#94a3b8\" stroke-width=\"1.5\" rx=\"2\" />';\n\n        // Resistor Ceramic Body (Beige / Light Cyan)\n        var bodyBg = curResBands === 4 ? '#fef3c7' : '#e0f2fe';\n        var bodyBorder = curResBands === 4 ? '#d97706' : '#0284c7';\n\n        // Bulbed Resistor Shape\n        var pathBody = 'M ' + bodyX + ' ' + (bodyY + 15) + ' ' +\n          'Q ' + (bodyX + 25) + ' ' + bodyY + ' ' + (bodyX + 50) + ' ' + (bodyY + 10) + ' ' +\n          'L ' + (bodyX + bodyW - 50) + ' ' + (bodyY + 10) + ' ' +\n          'Q ' + (bodyX + bodyW - 25) + ' ' + bodyY + ' ' + (bodyX + bodyW) + ' ' + (bodyY + 15) + ' ' +\n          'L ' + (bodyX + bodyW) + ' ' + (bodyY + bodyH - 15) + ' ' +\n          'Q ' + (bodyX + bodyW - 25) + ' ' + (bodyY + bodyH) + ' ' + (bodyX + bodyW - 50) + ' ' + (bodyY + bodyH - 10) + ' ' +\n          'L ' + (bodyX + 50) + ' ' + (bodyY + bodyH - 10) + ' ' +\n          'Q ' + (bodyX + 25) + ' ' + (bodyY + bodyH) + ' ' + bodyX + ' ' + (bodyY + bodyH - 15) + ' Z';\n\n        svgHtml += '<path d=\"' + pathBody + '\" fill=\"' + bodyBg + '\" stroke=\"' + bodyBorder + '\" stroke-width=\"2.5\" filter=\"drop-shadow(0 4px 8px rgba(0,0,0,0.15))\" />';\n\n        // Draw Color Bands\n        // Bands spaced across body\n        var bandCount = bands.length;\n        var startX = bodyX + 60;\n        var availableW = bodyW - 120;\n        var spacing = availableW / (bandCount - 0.5);\n\n        bands.forEach(function(bName, idx) {\n          var cObj = getColorObj(bName);\n          var bx = startX + (idx * spacing);\n          // Tolerance and TCR pushed slightly to right\n          if (idx >= bandCount - 2 && bandCount >= 5) {\n            bx += 15;\n          } else if (idx === bandCount - 1 && bandCount === 4) {\n            bx += 25;\n          }\n\n          svgHtml += '<rect x=\"' + bx + '\" y=\"' + (bodyY + 8) + '\" width=\"18\" height=\"' + (bodyH - 16) + '\" fill=\"' + cObj.hex + '\" stroke=\"#334155\" stroke-width=\"1\"><title>' + bName + '</title></rect>';\n          svgHtml += '<text x=\"' + (bx + 9) + '\" y=\"' + (bodyY + bodyH + 24) + '\" fill=\"var(--fg)\" font-size=\"11\" font-weight=\"bold\" text-anchor=\"middle\">' + bName + '</text>';\n        });\n\n        svg.innerHTML = svgHtml;\n      }\n\n      function solveReverseResistor(str) {\n        if (!str) return;\n        var clean = str.toLowerCase().replace(/ohms?|Ω/g, '').trim();\n        var val = 0;\n        if (clean.endsWith('k')) {\n          val = parseFloat(clean.replace('k', '')) * 1000;\n        } else if (clean.endsWith('m')) {\n          val = parseFloat(clean.replace('m', '')) * 1000000;\n        } else if (clean.endsWith('r')) {\n          val = parseFloat(clean.replace('r', ''));\n        } else {\n          val = parseFloat(clean);\n        }\n\n        if (isNaN(val) || val <= 0) return;\n        applyQuickResistor(val);\n      }\n\n      function applyQuickResistor(ohms) {\n        var str = ohms.toString();\n        // Convert ohms to mantissa and power\n        var exp = Math.floor(Math.log10(ohms));\n        var mantissa = ohms / Math.pow(10, exp);\n\n        if (curResBands === 4) {\n          var sig2 = Math.round(ohms / Math.pow(10, exp - 1));\n          var d1 = Math.floor(sig2 / 10);\n          var d2 = sig2 % 10;\n          var multExp = exp - 1;\n\n          var b1Obj = colorMap[d1] || colorMap[1];\n          var b2Obj = colorMap[d2] || colorMap[0];\n          var multVal = Math.pow(10, multExp);\n\n          var mObj = colorMap[0];\n          for (var i = 0; i < colorMap.length; i++) {\n            if (colorMap[i].mult === multVal) { mObj = colorMap[i]; break; }\n          }\n\n          document.getElementById('band1').value = b1Obj.name;\n          document.getElementById('band2').value = b2Obj.name;\n          document.getElementById('bandMult').value = mObj.name;\n        } else {\n          var sig3 = Math.round(ohms / Math.pow(10, exp - 2));\n          var d1 = Math.floor(sig3 / 100);\n          var d2 = Math.floor((sig3 % 100) / 10);\n          var d3 = sig3 % 10;\n          var multExp = exp - 2;\n\n          var b1Obj = colorMap[d1] || colorMap[1];\n          var b2Obj = colorMap[d2] || colorMap[0];\n          var b3Obj = colorMap[d3] || colorMap[0];\n          var multVal = Math.pow(10, multExp);\n\n          var mObj = colorMap[0];\n          for (var i = 0; i < colorMap.length; i++) {\n            if (colorMap[i].mult === multVal) { mObj = colorMap[i]; break; }\n          }\n\n          document.getElementById('band1').value = b1Obj.name;\n          document.getElementById('band2').value = b2Obj.name;\n          document.getElementById('band3').value = b3Obj.name;\n          document.getElementById('bandMult').value = mObj.name;\n        }\n\n        calcResistor();\n      }\n\n      function copyResistorReport(btn) {\n        var res = document.getElementById('res-val-primary').textContent;\n        var tol = document.getElementById('res-val-tol').textContent;\n        var range = document.getElementById('res-val-range').textContent;\n        var seq = document.getElementById('res-val-sequence').textContent;\n\n        var text = '⚡ RESISTOR COLOR CODE & SPECIFICATION REPORT\\n' +\n          '====================================================\\n' +\n          '• Nominal Resistance: ' + res + ' (' + tol + ')\\n' +\n          '• Resistance Range: ' + range + '\\n' +\n          '• Color Sequence: ' + seq + '\\n' +\n          '• Configuration: ' + curResBands + '-Band Axial Resistor (IEC 60062)\\n' +\n          '----------------------------------------------------\\n' +\n          'Calculated via Digital Tools Shed: https://digitaltoolsshed.com/dev/resistor-color-code-calculator';\n\n        navigator.clipboard.writeText(text).then(function() {\n          if (btn) {\n            var orig = btn.innerHTML;\n            btn.innerHTML = '<span>✓</span> Specifications Copied!';\n            btn.style.borderColor = '#10b981';\n            btn.style.color = '#10b981';\n            setTimeout(function() {\n              btn.innerHTML = orig;\n              btn.style.borderColor = 'var(--border)';\n              btn.style.color = 'var(--fg)';\n            }, 2000);\n          }\n        });\n      }\n\n      if (document.readyState === 'loading') {\n        document.addEventListener('DOMContentLoaded', function() {\n          populateSelects();\n          calcResistor();\n        });\n      } else {\n        populateSelects();\n        calcResistor();\n      }\n    </script>\n  "
},
