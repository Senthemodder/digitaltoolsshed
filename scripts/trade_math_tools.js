  ...
  return `
    <div class="article-container" style="max-width: 950px;">
        ...
        <div style="background: var(--surface-alt); border: 1px solid var(--border); padding: 1.5rem; border-radius: 8px; display: flex; flex-direction: column; justify-content: space-between;">
          ...
          <div>
            <div id="statusBadge" style="margin-top: 1.25rem; padding: 0.75rem; border-radius: 4px; font-family: var(--mono); font-size: 0.85rem; text-align: center; background: rgba(34, 197, 94, 0.1); color: #22c55e; border: 1px solid rgba(34, 197, 94, 0.2);">
              Code Verified (${t.codeRef})
            </div>
            <button type="button" id="btnCopyReport" onclick="copyTradeReport()" class="btn-sec" style="margin-top: 0.75rem; width: 100%; padding: 0.65rem 1rem; font-family: var(--mono); font-size: 0.8rem; cursor: pointer; background: var(--surface); border: 1px solid var(--border); border-radius: 4px; color: var(--fg); display: flex; align-items: center; justify-content: center; gap: 0.4rem; transition: all 0.2s;">
              📋 Copy Jobsite Inspection Report
            </button>
          </div>
        </div>
      </div>
      ...
      <div style="background: var(--surface); border: 1px solid var(--border); border-left: 3px solid #3b82f6; padding: 1.5rem; border-radius: 8px; margin-bottom: 2rem;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; flex-wrap: wrap; gap: 0.5rem;">
          <h3 style="font-family: var(--serif); font-size: 1.25rem; margin: 0; color: var(--fg);">📐 Step-by-Step Worked Calculation Example</h3>
          <span style="font-family: var(--mono); font-size: 0.72rem; color: #3b82f6; background: rgba(59, 130, 246, 0.1); padding: 0.2rem 0.5rem; border-radius: 4px;">Standard Jobsite Scenario</span>
        </div>
        ...
        <div style="display: grid; gap: 0.75rem; font-family: var(--mono); font-size: 0.85rem;">
          <div style="padding: 0.75rem; background: var(--surface-alt); border-radius: 4px; border: 1px solid var(--border);">
            <strong style="color: var(--fg);">Step 1: Benchmark Jobsite Parameters</strong>
            <div style="color: var(--text-muted); margin-top: 0.25rem;">
              ${t.inputs.map(i => `${i.label}: <strong>${i.value} ${i.unit || ''}</strong>`).join(' &bull; ')}
            </div>
          </div>
          <div style="padding: 0.75rem; background: var(--surface-alt); border-radius: 4px; border: 1px solid var(--border);">
            <strong style="color: var(--fg);">Step 2: Mathematical Engineering Formulation</strong>
            <div style="color: #3b82f6; margin-top: 0.25rem; word-break: break-all;">
              ${t.formula}
            </div>
          </div>
          <div style="padding: 0.75rem; background: var(--surface-alt); border-radius: 4px; border: 1px solid var(--border);">
            <strong style="color: var(--fg);">Step 3: Building Code & Safety Deductions (${t.codeRef})</strong>
            <div style="color: var(--text-muted); margin-top: 0.25rem;">
              Applying structural bearings, thickness offsets, and thermal/voltage safety thresholds required by ${t.codeRef}.
            </div>
          </div>
          <div style="padding: 0.75rem; background: var(--surface-alt); border-radius: 4px; border: 1px solid var(--border);">
            <strong style="color: var(--fg);">Step 4: Primary Specification Output</strong>
            <div style="color: #10b981; font-weight: 700; margin-top: 0.25rem;">
              Target Requirement: ${t.primaryOutput.label} (Verified in local browser engine with zero server latency)
            </div>
          </div>
        </div>
      </div>

      <!-- 5 Fatal Trade & Engineering Mistakes -->
      <div style="background: var(--surface); border: 1px solid var(--border); padding: 1.5rem; border-radius: 8px; margin-bottom: 2rem;">
        <h3 style="font-family: var(--serif); font-size: 1.25rem; margin-top: 0; margin-bottom: 0.75rem; color: var(--fg);">⚠️ 5 Fatal Trade & Structural Engineering Traps</h3>
        ...
        <div style="display: grid; gap: 1rem;">
          <div class="trap-card" style="border-left: 4px solid #ef4444; background: var(--surface-alt); border: 1px solid var(--border); border-left: 4px solid #ef4444; border-radius: 6px; padding: 1rem 1.25rem;">
            <strong style="color: var(--fg); font-size: 0.95rem; display: block; margin-bottom: 0.25rem;">1. Nominal vs. Actual Dimension Variances</strong>
          ...
          <div class="trap-card" style="border-left: 4px solid #f59e0b; background: var(--surface-alt); border: 1px solid var(--border); border-left: 4px solid #f59e0b; border-radius: 6px; padding: 1rem 1.25rem;">
            <strong style="color: var(--fg); font-size: 0.95rem; display: block; margin-bottom: 0.25rem;">2. The Net Quantity Fallacy (Zero Waste Allowance)</strong>
            <p style="margin: 0.35rem 0 0; font-size: 0.88rem; color: var(--text-muted); line-height: 1.5;">
          ...
          <div class="trap-card" style="border-left: 4px solid #10b981; background: var(--surface-alt); border: 1px solid var(--border); border-left: 4px solid #10b981; border-radius: 6px; padding: 1rem 1.25rem;">
            <strong style="color: var(--fg); font-size: 0.95rem; display: block; margin-bottom: 0.25rem;">3. Local AHJ Municipal Building Code Overrides</strong>
            <p style="margin: 0.35rem 0 0; font-size: 0.88rem; color: var(--text-muted); line-height: 1.5;">
              While this tool adheres strictly to standard national model codes (${t.codeRef}), regional Authorities Having Jurisdiction (AHJ) enforce local amendments. Frost line footing depths, high-wind hurricane strapping, seismic tie-down schedules, and local utility service entrance rules supersede national minimums. Always verify calculations against local municipal amendments.
            </p>
          </div>
          ...
          <div class="trap-card" style="border-left: 4px solid #3b82f6; background: var(--surface-alt); border: 1px solid var(--border); border-left: 4px solid #3b82f6; border-radius: 6px; padding: 1rem 1.25rem;">
            <strong style="color: var(--fg); font-size: 0.95rem; display: block; margin-bottom: 0.25rem;">4. Thermal Expansion & Seasonal Grain Shrinkage</strong>
            <p style="margin: 0.35rem 0 0; font-size: 0.88rem; color: var(--text-muted); line-height: 1.5;">
          ...
          <div class="trap-card" style="border-left: 4px solid #8b5cf6; background: var(--surface-alt); border: 1px solid var(--border); border-left: 4px solid #8b5cf6; border-radius: 6px; padding: 1rem 1.25rem;">
            <strong style="color: var(--fg); font-size: 0.95rem; display: block; margin-bottom: 0.25rem;">5. Fastener Withdrawal vs. Lateral Shear Load Mismatch</strong>
            <p style="margin: 0.35rem 0 0; font-size: 0.88rem; color: var(--text-muted); line-height: 1.5;">
    ...
    <script>
      ...
      function copyTradeReport() {
        var lines = [];
        lines.push('====================================================');
        lines.push('${t.name} — Jobsite Specification Report');
        lines.push('Governing Standard: ${t.codeRef} | Engine: Digital Tools Shed (2026)');
        lines.push('----------------------------------------------------');
        lines.push('INPUT PARAMETERS:');
        ${t.inputs.map(i => `lines.push('- ${i.label}: ' + (document.getElementById('${i.id}') ? document.getElementById('${i.id}').value : '${i.value}') + ' ${i.unit || ''}');`).join('\n        ')}
        lines.push('');
        lines.push('CALCULATED SPECIFICATIONS:');
        lines.push('- ${t.primaryOutput.label}: ' + (document.getElementById('${t.primaryOutput.id}') ? document.getElementById('${t.primaryOutput.id}').innerText : '-'));
        ${t.outputs.map(o => `lines.push('- ${o.label}: ' + (document.getElementById('${o.id}') ? document.getElementById('${o.id}').innerText : '-'));`).join('\n        ')}
        lines.push('----------------------------------------------------');
        lines.push('Direct Tool URL: ' + window.location.href);
        lines.push('Verified 100% Client-Side Engine (Zero Server Storage)');
        lines.push('====================================================');
        ...
        if (navigator.clipboard && navigator.clipboard.writeText) {
          navigator.clipboard.writeText(lines.join('\\n')).then(function() {
            ...
            if (btn) {
              ...
              btn.innerHTML = '✓ Copied Inspection Report!';
...
export function buildTradeMathTools({ DIST, DOMAIN, renderPage, writeFileSync, join, ensureDir }) {
  ...
  for (const tool of ALL_TRADE_TOOLS) {
    tool.faq = [
      ...(tool.faq || []),
      {
        q: `Is this ${tool.name} code-compliant with ${tool.codeRef}?`,
        a: `Yes. This calculation engine calculates tolerances, structural allowances, and material sizing in accordance with ${tool.codeRef} standards. Always cross-check against approved engineering plans and local municipal AHJ amendments.`
      },
      {
        q: `How does nominal sizing differ from actual dimensions in this trade calculation?`,
        a: `Commercial materials frequently carry nominal trade labels (e.g. 2x4 framing lumber is 1.5" × 3.5", Schedule 40 conduit reflects internal clearance). Our formulas account for true physical dimensions to prevent costly jobsite fabrication errors.`
      },
      {
        q: `What waste factor should I order for materials calculated here?`,
        a: `Professional trades and contractors recommend ordering a 10% to 15% allowance above net calculated requirements to accommodate off-cut pitch bevels, corner waste, end trimming, and freight handling damage.`
      }
    ];
    ...
    const howToSchema = {
      ...
      "@type": "HowTo",
      "name": `How to Calculate ${tool.name} [${tool.codeRef}]`,
      "description": tool.metaDesc,
      "step": [
        {
          "@type": "HowToStep",
          "position": 1,
          "name": "Input Project Dimensions",
          "text": `Measure and input baseline jobsite parameters: ${tool.inputs.map(i => i.label).join(', ')}.`
        },
        {
          "@type": "HowToStep",
          "position": 2,
          "name": "Apply Mathematical Formula",
          "text": `Execute the governing trade equation: ${tool.formula}.`
        },
        {
          "@type": "HowToStep",
          "position": 3,
          "name": "Verify Building Code Minimums",
          "text": `Compare primary output (${tool.primaryOutput.label}) against ${tool.codeRef} safety standards.`
        },
        {
          "@type": "HowToStep",
          "position": 4,
          "name": "Export Inspection Specifications",
          "text": "Copy the formatted inspection report to clipboard for subcontractors, framing crews, or permit inspectors."
        }
      ]
    };
