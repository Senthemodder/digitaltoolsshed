...
function buildToolBody(t) {
  ...
  return `
    <div class="article-container" style="max-width: 950px;">
      ...
      <!-- Critical Trade Pitfalls & Costly Jobsite Mistakes -->
      <div style="background: var(--surface-alt); border: 1px solid var(--border); border-left: 3px solid #f59e0b; padding: 1.5rem; border-radius: 8px; margin-bottom: 2rem;">
        <h3 style="font-family: var(--serif); font-size: 1.25rem; margin-top: 0; margin-bottom: 0.75rem; color: var(--fg);">⚠️ Critical Trade Pitfalls & Costly Jobsite Mistakes</h3>
        <ul style="color: var(--text-muted); font-size: 0.92rem; line-height: 1.6; padding-left: 1.25rem; margin: 0;">
          <li style="margin-bottom: 0.5rem;"><strong style="color: var(--fg);">Nominal vs Actual Dimension Variances:</strong> Commercial materials differ from trade names (e.g. 2x4 framing lumber is actually 1-1/2" × 3-1/2", conduit trade designations describe internal clearance). Always measure actual materials on site before making irreversible cuts.</li>
          <li style="margin-bottom: 0.5rem;"><strong style="color: var(--fg);">Failure to Include Material Waste Factors:</strong> Always factor an additional 10% to 15% allowance for off-cut pitch bevels, corner waste, end trimming, and transport damage. Ordering exact net estimates frequently results in expensive work stoppages.</li>
          <li style="margin-bottom: 0.5rem;"><strong style="color: var(--fg);">Local AHJ Code Amendments:</strong> While this calculator complies with ${t.codeRef}, local municipal building authorities (AHJ) frequently enforce regional amendments for frost lines, seismic ties, or wind loads. Always cross-check engineering calculations against local approved plans.</li>
        </ul>
      </div>
